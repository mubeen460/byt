...
{
    /// <summary>
    /// Interaction logic for OficioDePoder.xaml
    /// </summary>
    public partial class OficioDePoder : Page, IOficioDePoder
    {
        private PresentadorOficioDePoder _presentador;
        ...
        public OficioDePoder()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorOficioDePoder(this);
        }
