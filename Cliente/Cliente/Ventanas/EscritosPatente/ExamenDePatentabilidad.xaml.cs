...
namespace Trascend.Bolet.Cliente.Ventanas.EscritosPatente
{
    ...
    /// </summary>
    public partial class ExamenDePatentabilidad : Page, IExamenDePatentabilidad
    {
        private PresentadorExamenDePatentabilidad _presentador;
        private bool _cargada;

        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;

        #region IExamenDePatentabilidad
        ...
        public ExamenDePatentabilidad()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorExamenDePatentabilidad(this);
        }
