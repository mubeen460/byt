...
namespace Trascend.Bolet.Cliente.Ventanas.EscritosMarca
{
    ...
    /// </summary>
    public partial class NotificacionDeIngresoDePoder : Page, INotificacionDeIngresoDePoder
    {
        private PresentadorNotificacionDeIngresoDePoder _presentador;
        private bool _cargada;

        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;

        #region INotificacionDeIngresoDePoder
        ...
        public NotificacionDeIngresoDePoder()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorNotificacionDeIngresoDePoder(this);
        }
