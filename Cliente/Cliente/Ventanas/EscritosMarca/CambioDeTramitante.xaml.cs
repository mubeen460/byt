...
{
    /// <summary>
    /// Interaction logic for CambioDeTramitante.xaml
    /// </summary>
    public partial class CambioDeTramitante : Page, ICambioDeTramitante
    {
        private PresentadorCambioDeTramitante _presentador;
        ...
        public CambioDeTramitante()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorCambioDeTramitante(this);
        }
