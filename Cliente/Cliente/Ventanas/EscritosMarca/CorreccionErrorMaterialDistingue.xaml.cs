...
{
    /// <summary>
    /// Interaction logic for CorreccionErrorMaterialDistingue.xaml
    /// </summary>
    public partial class CorreccionErrorMaterialDistingue : Page, ICorreccionErrorMaterialDistingue
    {
        private PresentadorCorreccionErrorMaterialDistingue _presentador;
        private bool _cargada;

        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;

        #region ICorreccionErrorMaterialDistingue
        ...
        public CorreccionErrorMaterialDistingue()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorCorreccionErrorMaterialDistingue(this);
        }
