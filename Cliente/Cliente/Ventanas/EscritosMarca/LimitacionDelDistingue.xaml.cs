...
namespace Trascend.Bolet.Cliente.Ventanas.EscritosMarca
{
    ...
    /// </summary>
    public partial class LimitacionDelDistingue : Page, ILimitacionDelDistingue
    {
        private PresentadorLimitacionDelDistingue _presentador;
        private bool _cargada;

        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;

        #region ILimitacionDelDistingue
        ...
        public LimitacionDelDistingue()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorLimitacionDelDistingue(this);
        }
