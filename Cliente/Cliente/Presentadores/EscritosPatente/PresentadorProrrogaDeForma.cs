...
{
    class PresentadorProrrogaDeForma : PresentadorBase
    {

        private IProrrogaDeForma _ventana;
        ...
        public PresentadorProrrogaDeForma(IProrrogaDeForma ventana)
        {
            try
            {
        ...
        public void CargarPagina()
        {
            try
            {
                ...
                this.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.titleEscritoProrrogaDeForma,
                    "");
                CargarAgente();
                CargarPatente();
                CargaBoletines();
            ...
            try
            {
                ...
                if (ValidarEscrito())
                {
                    ...
                    this.EjecutarArchivoBAT(ConfigurationManager.AppSettings["RutaBatEscrito"].ToString()
                        + "\\" + ConfigurationManager.AppSettings["EscritoProrrogaDeForma"].ToString(),
