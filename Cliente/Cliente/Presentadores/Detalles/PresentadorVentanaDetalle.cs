...
namespace Trascend.Bolet.Cliente.Presentadores.Detalles
{
    class PresentadorVentanaDetalle : PresentadorBase
    {
        private IVentanaDetalle _ventana;
        private IUsuarioServicios _usuarioServicios;
        private static Logger logger = LogManager.GetCurrentClassLogger();

        public PresentadorVentanaDetalle(IVentanaDetalle ventana)
        {
            try
            {
