...
namespace Trascend.Bolet.Cliente.Ventanas.Reportes
{
    ...
    /// </summary>
    public partial class Carta16 : Page, ICarta16
    {
        private PresentadorCarta16 _presentador;
        ...
        public string Fecha
        {
            get { return this._dpkFechaAso.Text; }
            set { this._dpkFechaAso.Text = value; }
        }
        ...
        public Carta16()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorCarta16(this);
        }
