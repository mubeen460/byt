...
namespace Trascend.Bolet.Cliente.Ventanas.EscritosMarca
{
    ...
    /// </summary>
    public partial class RenunciaParcial : Page, IRenunciaParcial
    {
        private PresentadorRenunciaParcial _presentador;
        private bool _cargada;

        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;

        #region IRenunciaParcial
        ...
        public RenunciaParcial()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorRenunciaParcial(this);
        }
