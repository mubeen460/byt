...
{
    class PresentadorAgregarEstado : PresentadorBase
    {
        private IAgregarEstado _ventana;
        ...
        public PresentadorAgregarEstado(IAgregarEstado ventana)
        {
            try
            {
                ...
                this._ventana.Estado = new Estado();
            }
            catch (Exception ex)
            {
        ...
        public void CargarPagina()
        {
            ...
            try
            {
                ...
                this.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.titleAgregarEstado,
                    Recursos.Ids.AgregarEstado);
