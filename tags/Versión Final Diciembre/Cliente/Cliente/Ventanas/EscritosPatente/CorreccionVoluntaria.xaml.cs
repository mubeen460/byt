...
{
    /// <summary>
    /// Interaction logic for CorreccionVoluntaria.xaml
    /// </summary>
    public partial class CorreccionVoluntaria : Page, ICorreccionVoluntaria
    {
        private PresentadorCorreccionVoluntaria _presentador;
        private bool _cargada;

        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;

        #region ICorreccionVoluntaria
        ...
        public object TiposCorreccionVoluntaria
        {
            get { return this._cbxTipoCorreccionVoluntaria.DataContext; }
            set { this._cbxTipoCorreccionVoluntaria.DataContext = value; }
        }

        public object TipoCorreccionVoluntaria
        {
            get { return this._cbxTipoCorreccionVoluntaria.SelectedItem; }
            set { this._cbxTipoCorreccionVoluntaria.SelectedItem = value; }
        }
        ...
        public CorreccionVoluntaria()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorCorreccionVoluntaria(this);
        }
