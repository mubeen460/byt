...
{
    public class ComandoConsultarTodosCambioDeDomicilioPatente : ComandoBase<IList<CambioDeDomicilioPatente>>
    {
        ...
        public override void Ejecutar()
        {
            try
            {
                ...
                this.Receptor = new Receptor<IList<CambioDeDomicilioPatente>>(dao.ObtenerTodos());
