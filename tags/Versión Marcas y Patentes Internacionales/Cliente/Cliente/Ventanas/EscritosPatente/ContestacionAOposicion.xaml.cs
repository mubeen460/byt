...
namespace Trascend.Bolet.Cliente.Ventanas.EscritosPatente
{
    ...
    /// </summary>
    public partial class ContestacionAOposicion : Page, IContestacionAOposicion
    {
        private PresentadorContestacionAOposicion _presentador;
        private bool _cargada;

        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;

        #region IContestacionAOponente
        ...
        public ContestacionAOposicion()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorContestacionAOposicion(this);
        }
