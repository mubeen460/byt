...
{
    /// <summary>
    /// Interaction logic for OficioDeJuramento.xaml
    /// </summary>
    public partial class OficioDeJuramento : Page, IOficioDeJuramento
    {
        private PresentadorOficioDeJuramento _presentador;
        private bool _cargada;

        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;

        #region IOficioDeJuramento
        ...
        public OficioDeJuramento()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorOficioDeJuramento(this);
        }
