...
{
    /// <summary>
    /// Interaction logic for ConsignacionDePoder.xaml
    /// </summary>
    public partial class ConsignacionDePoder : Page, IConsignacionDePoder
    {
        private PresentadorConsignacionDePoder _presentador;
        private bool _cargada;

        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;

        #region IConsignacionDePoder
        ...
        public ConsignacionDePoder()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorConsignacionDePoder(this);
        }
