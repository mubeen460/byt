...
{
    class PresentadorConsultarTipoInfobol : PresentadorBase
    {
        private IConsultarTipoInfobol _ventana;
        ...
        /// <param name="nacional">TipoInfobol a mostrar</param>
        public PresentadorConsultarTipoInfobol(IConsultarTipoInfobol ventana, TipoInfobol nacional)
        {
            try
            {
                this._ventana = ventana;
                this._ventana.TipoInfobol = nacional;
        ...
        public void CargarPagina()
        {
            ...
            {
                //crear titulo
                this.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.titleConsultarTipoInfobol,
        ...
        public void Eliminar()
        {
            try
            {
                ...
                if (this._tipoInfobolServicios.Eliminar((TipoInfobol)this._ventana.TipoInfobol, UsuarioLogeado.Hash))
                {
                    _paginaPrincipal.MensajeUsuario = Recursos.MensajesConElUsuario.TipoInfobolEliminado;
