...
{
    public class ComandoEliminarMemoria : ComandoBase<bool>
    {
        ...
        public ComandoEliminarMemoria(Memoria memoria)
        {
        ...
        public override void Ejecutar()
        {
            try
            {
                ...
                IDaoMemoria dao = FabricaDaoBase.ObtenerFabricaDao().ObtenerDaoMemoria();
                 this.Receptor = new Receptor<bool>(dao.Eliminar(this._memoria));
