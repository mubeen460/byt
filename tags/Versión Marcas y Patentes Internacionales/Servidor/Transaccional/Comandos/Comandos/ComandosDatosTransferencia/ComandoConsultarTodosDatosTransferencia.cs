...
{
    class ComandoConsultarTodosDatosTransferencia : ComandoBase<IList<DatosTransferencia>>
    {
        ...
        public override void Ejecutar()
        {
            try
            {
                ...
                this.Receptor = new Receptor<IList<DatosTransferencia>>(dao.ObtenerTodos());
