...
namespace Trascend.Bolet.LogicaNegocio.Controladores
{
    public class ControladorInteresado : ControladorBase
    {
        ...
        public static bool InsertarOModificar(ref Interesado interesado, int hash)
        {
            bool exitoso = false;
        ...
        public static Interesado ConsultarInteresadosDeUnPoder(Poder poder)
        {
            Interesado retorno;
            ...
            try
            {
                ...
                ComandoBase<Interesado> comando = FabricaComandosInteresado.ObtenerComandoConsultarInteresadosDeUnPoder(poder);
                comando.Ejecutar();
                retorno = comando.Receptor.ObjetoAlmacenado;
