...
{
    public class ComandoConsultarTodosMarcaBaseTercero : ComandoBase<IList<MarcaBaseTercero>>
    {
        ...
        public override void Ejecutar()
        {
            try
            {
                ...
                this.Receptor = new Receptor<IList<MarcaBaseTercero>>(dao.ObtenerTodos());
