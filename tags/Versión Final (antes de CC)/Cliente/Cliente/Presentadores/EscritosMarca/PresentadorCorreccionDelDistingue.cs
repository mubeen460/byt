...
namespace Trascend.Bolet.Cliente.Presentadores.EscritosMarca
{
    class PresentadorCorreccionDelDistingue : PresentadorBase
    {
        ...
        public string GenerarString()
        {
            ...
            string StringLlleno = "";
            if ("" != this._ventana.Error)
                StringLlleno += this._ventana.Error + "  ";
            if ("" != this._ventana.Correccion)
                StringLlleno += this._ventana.Correccion + "  ";
        ...
        /// <summary>
        /// Método que ejecuta el .bat para generar el escrito
        /// </summary>
        public void Aceptar()
        {
            try
            {
                ...
                if (ValidarEscrito())
                {
                    ...
                    this.EjecutarArchivoBAT(ConfigurationManager.AppSettings["RutaBatEscrito"].ToString()
                        ...
                        this._ventana.Error+" "+this._ventana.Correccion+" "+((Agente)this._ventana.AgenteFiltrado).Id 
                        + " " + parametroMarcas);
                }
        ...
        /// <summary>
        /// Método que realiza las validaciones necesarias antes de generar el escrito
        /// </summary>
