...
{
    [Serializable]
    public class FacFacturaPendiente
    {
        #region "Atributos"
        ...
        public FacFacturaPendiente()
        {
        }
        /// <summary>
        /// Constructor que inicializa el Id de la FacFacturaPendiente
        /// </summary>
        /// <param name="id">Id de FacFacturaPendiente</param>
        public FacFacturaPendiente(int? id)
        {
            this._id = id;
        }
        #endregion
        ...
        /// <summary>
        /// Propiedad que asigna u obtiene el id de la FacFacturaPendiente
        /// </summary>
