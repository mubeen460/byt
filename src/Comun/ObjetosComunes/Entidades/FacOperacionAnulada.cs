...
{
    [Serializable]
    public class FacOperacionAnulada
    {
        #region "Atributos"
        ...
        public FacOperacionAnulada()
        {
        }
        /// <summary>
        /// Constructor que inicializa el Id de la FacOperacionAnulada
        /// </summary>
        /// <param name="id">Id de FacOperacionAnulada</param>
        public FacOperacionAnulada(string id,int? codigooperacion)
        {
            this._id = id;
        ...
        public override bool Equals(object obj)
        {
            ...
            var t = obj as FacOperacionAnulada;
            if (t == null)
            {
                return false;
            }
        ...
        /// <summary>
        /// Propiedad que asigna u obtiene el id de la FacOperacionAnulada
        /// </summary>
