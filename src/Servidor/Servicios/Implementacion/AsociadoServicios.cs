...
namespace Trascend.Bolet.Servicios.Implementacion
{
    public class AsociadoServicios : MarshalByRefObject, IAsociadoServicios
    {
        ...
        /// <returns>Lista de Entidades</returns>
        public IList<Asociado> ConsultarPorOtroCampo(String campo, String tipoOrdenamiento)
        {
            throw new NotImplementedException();
        }
        //-------------------------------------------------------------
        ...
        public bool InsertarOModificar(Asociado asociado, int hash)
        {
            try
            {
                ...
                bool exitoso = ControladorAsociado.InsertarOModificar(ref asociado, hash);
        ...
        public bool VerificarCartasPorAsociado(Asociado asociado)
        {
            try
            {
                #region trace
                ...
                retorno = ControladorAsociado.VerificarCartasPorAsociado(asociado);
        ...
        public IList<ContactosDelAsociadoVista> ConsultarContactosDelAsociado(Asociado asociado, bool todos)
        {
            try
            {
                #region trace
        ...
        public IList<EmailAsociado> ConsultarEmailsDelAsociado(Asociado asociado)
        {
            try
            {
                ...
                IList<EmailAsociado> retorno = ControladorAsociado.ConsultarEmailsDelAsociado(asociado);
        ...
        /// </summary>
        /// <param name="asociado">Asociado a insertar</param>
        /// <param name="hash">hash del usuario que ejecuta la insercion</param>
        /// <returns>Id de la Asociado insertada</returns>
        public int? InsertarOModificarAsociado(Asociado asociado, int hash)
        {
            try
            {
                #region trace
        ...
        public bool ActualizarConectividadAsociados(ParametroProcedimiento parametro)
        {
            ...
            try
            {
                ...
                retorno = ControladorAsociado.EjecutarProcedimiento(parametro);
