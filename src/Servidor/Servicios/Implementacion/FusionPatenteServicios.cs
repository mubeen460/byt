    ...
    public class FusionPatenteServicios : MarshalByRefObject, IFusionPatenteServicios
    {
        ...
        public FusionPatente ConsultarPorId(FusionPatente entidad)
        {
            try
            {
                ...
                FusionPatente fusion = ControladorFusionPatente.ConsultarPorId(entidad);
        ...
        /// <returns>Lista de Entidades</returns>
        public IList<FusionPatente> ConsultarPorOtroCampo(String campo, String tipoOrdenamiento)
        {
        ...
        public bool InsertarOModificar(FusionPatente fusion, int hash)
        {
            try
            {
                ...
                bool exitoso = ControladorFusionPatente.InsertarOModificar(ref fusion, hash);
        ...
        public int? InsertarOModificarFusion(FusionPatente fusion, int hash)
        {
            try
            {
                #region trace
