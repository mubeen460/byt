...
namespace Trascend.Bolet.Servicios.Implementacion
{
    public class LicenciaPatenteServicios : MarshalByRefObject, ILicenciaPatenteServicios
    {
        ...
        /// <returns>Lista de Entidades</returns>
        public IList<LicenciaPatente> ConsultarPorOtroCampo(String campo, String tipoOrdenamiento)
        {
            throw new NotImplementedException();
        }
        //-------------------------------------------------------------
        ...
        public bool InsertarOModificar(LicenciaPatente licencia, int hash)
        {
            try
            {
                ...
                bool exitoso = ControladorLicenciaPatente.InsertarOModificar(ref licencia, hash);
        ...
        public int? InsertarOModificarLicencia(LicenciaPatente licencia, int hash)
        {
            try
            {
                #region trace
