...
{
    public class LicenciaServicios : MarshalByRefObject, ILicenciaServicios
    {
        ...
        public IList<Licencia> ConsultarTodos()
        {
            try
            {
                #region trace
                ...
                IList<Licencia> licencias = ControladorLicencia.ConsultarTodos();
        ...
        /// <returns></returns>
        public Licencia ConsultarPorId(Licencia entidad)
        {
        ...
        /// <returns>Lista de Entidades</returns>
        public IList<Licencia> ConsultarPorOtroCampo(String campo, String tipoOrdenamiento)
        {
            throw new NotImplementedException();
        }
        //-------------------------------------------------------------
        ...
        public bool InsertarOModificar(Licencia licencia, int hash)
        {
            try
            {
                #region trace
                ...
                bool exitoso = ControladorLicencia.InsertarOModificar(ref licencia, hash);
        ...
        /// <returns>true en caso de ser exitoso, false en caso contrario</returns>
        public bool Eliminar(Licencia licencia, int hash)
        {
            try
            {
                #region trace
                ...
                bool exitoso = ControladorLicencia.Eliminar(licencia, hash);
        ...
        /// <returns>True en caso de ser exitoso, false en caso contrario</returns>
        public bool VerificarExistencia(Licencia licencia)
        {
            try
            {
                #region trace
                ...
                bool exitoso = ControladorLicencia.VerificarExistencia(licencia);
        ...
        public int? InsertarOModificarLicencia(Licencia licencia, int hash)
        {
            try
            {
                #region trace
