...
{
    public class ControladorObjeto : ControladorBase
    {
        ...
        public static bool InsertarOModificar(Objeto objeto, int hash)
        {
            bool exitoso = false;
            try
            {
        ...
        public static bool Eliminar(Objeto objeto, int hash)
        {
            bool exitoso = false;
            try
            {
        ...
        public static IList<Objeto> ConsultarTodos()
        {
            IList<Objeto> retorno;
