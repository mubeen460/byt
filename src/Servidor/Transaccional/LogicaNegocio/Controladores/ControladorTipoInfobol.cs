    ...
    public class ControladorTipoInfobol : ControladorBase
    {
        ...
        public static bool VerificarExistencia(TipoInfobol TipoInfobol)
        {
            ...
            try
            {
                ...
                ComandoBase<bool> comando = FabricaComandosTipoInfobol.ObtenerComandoVerificarExistenciaTipoInfobol(TipoInfobol);
                comando.Ejecutar();
