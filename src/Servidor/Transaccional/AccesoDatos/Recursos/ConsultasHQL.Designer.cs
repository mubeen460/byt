...
namespace Trascend.Bolet.AccesoDatos.Recursos {
    ...
    public class ConsultasHQL {
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a Select c from Cesion c left join fetch c.Marca as marca where .
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a Select f from Fusion f left join fetch f.Marca as marca where .
        /// </summary>
        ...
        ///   Busca una cadena traducida similar a Select m from Marca m left join fetch m.Asociado as asociado left join fetch m.Corresponsal as corresponsal wherem.Id = &apos;{0}&apos; order by m.Id.
        /// </summary>
