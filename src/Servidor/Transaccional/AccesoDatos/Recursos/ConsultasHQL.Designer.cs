...
namespace Trascend.Bolet.AccesoDatos.Recursos {
    ...
    public class ConsultasHQL {
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a Select m from Marca m left join fetch m.Asociado as asociado left join fetch m.Corresponsal as corresponsal left join fetch m.Interesado as interesado left join fetch asociado.Pais as pais left join fetch asociado.Idioma as pais where .
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a Select m from MarcaBaseTercero where .
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a Select m from MarcaTercero m left join fetch m.Asociado as asociado left join fetch m.Interesado as interesado left join fetch m.MarcasBaseTercero as marcaBaseTercero where .
        /// </summary>
