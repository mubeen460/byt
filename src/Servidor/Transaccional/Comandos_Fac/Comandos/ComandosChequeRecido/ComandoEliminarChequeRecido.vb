...
Namespace Comandos.ComandosChequeRecido
    Public Class ComandoEliminarChequeRecido
        ...
        ''' </summary>
        ''' <param name="ChequeRecido">ChequeRecido a eliminar</param>
        ...
        Public Overrides Sub Ejecutar()
            Try
                ...
                Me.Receptor = New Receptor(Of Boolean)(dao.Eliminar(Me._ChequeRecido))
