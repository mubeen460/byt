...
Namespace Comandos.ComandosFacOperacionDetaTmProforma
    Public Class ComandoInsertarOModificarFacOperacionDetaTmProforma
        ...
        Public Overrides Sub Ejecutar()
            Try
                ...
                Me.Receptor = New Receptor(Of Boolean)(dao.InsertarOModificar(Me._FacOperacionDetaTmProforma))
