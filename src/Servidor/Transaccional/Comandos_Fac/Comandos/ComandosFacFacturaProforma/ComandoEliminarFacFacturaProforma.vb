...
Namespace Comandos.ComandosFacFacturaProforma
    Public Class ComandoEliminarFacFacturaProforma
        ...
        ''' </summary>
        ''' <param name="FacFacturaProforma">FacFacturaProforma a eliminar</param>
        ...
        Public Overrides Sub Ejecutar()
            Try
                ...
                Me.Receptor = New Receptor(Of Boolean)(dao.Eliminar(Me._FacFacturaProforma))
