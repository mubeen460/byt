...
Namespace Comandos.ComandosFacOperacionPais
    Public Class ComandoEliminarFacOperacionPais
        ...
        ''' </summary>
        ''' <param name="FacOperacionPais">FacOperacionPais a eliminar</param>
        ...
        Public Overrides Sub Ejecutar()
            Try
                ...
                Me.Receptor = New Receptor(Of Boolean)(dao.Eliminar(Me._FacOperacionPais))
