...
Namespace Comandos.ComandosFacOperacionDetaAnulada
    Public Class ComandoVerificarExistenciaFacOperacionDetaAnulada
        ...
        Public Overrides Sub Ejecutar()
            Try
                ...
                Me.Receptor = New Receptor(Of Boolean)(dao.VerificarExistencia(Me._FacOperacionDetaAnulada.Id))
