...
Namespace Comandos.ComandosFacContadorPro
    Class ComandoInsertarOModificarFacContadorPro
        Inherits ComandoBase(Of Boolean)
        Private Shared logger As Logger = LogManager.GetCurrentClassLogger()
        Private _contador As FacContadorPro

        ''' <summary>
        ''' Constructor predeterminado
        ''' </summary>
        ''' <param name="contador">Contador a insertar o modificar</param>
        Public Sub New(ByVal contador As FacContadorPro)
            Me._contador = contador
        End Sub
        ...
        Public Overrides Sub Ejecutar()
            Try
                ...
                dao.InsertarOModificar(Me._contador)
