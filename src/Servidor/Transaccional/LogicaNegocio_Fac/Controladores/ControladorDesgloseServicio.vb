...
Namespace Controladores
    Public Class ControladorDesgloseServicio
        ...
        ''' </summary>
        ''' <returns></returns>
        Public Shared Function ConsultarTodos() As IList(Of FacDesgloseServicio)
            ...
            Try
                ...
                End If
                '#End Region                
                Dim comando As ComandoBase(Of IList(Of FacDesgloseServicio)) = FabricaComandosDesgloseServicio.ObtenerComandoConsultarTodos()
                comando.Ejecutar()
