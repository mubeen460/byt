...
{
    public class ComandoInsertarOModificarDetallePresentacion : ComandoBase<bool>
    {
        ...
        public ComandoInsertarOModificarDetallePresentacion(PresentacionSapiDetalle detallePresentacion)
        {
        ...
        public override void Ejecutar()
        {
            try
            {
                ...
                this.Receptor = new Receptor<bool>(dao.InsertarOModificar(this._detallePresentacion));
