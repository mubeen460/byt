...
{
    class ComandoConsultarTodosInstruccionesCorrespondencia : ComandoBase<IList<InstruccionCorrespondencia>>
    {
        ...
        public override void Ejecutar()
        {
            try
            {
                ...
                this.Receptor = new Receptor<IList<InstruccionCorrespondencia>>(dao.ObtenerTodos());
