...
{
    public class ComandoConsultarTodosCambioPeticionarioPatente : ComandoBase<IList<CambioPeticionarioPatente>>
    {
        ...
        public override void Ejecutar()
        {
            try
            {
                ...
                this.Receptor = new Receptor<IList<CambioPeticionarioPatente>>(dao.ObtenerTodos());
