...
Namespace Ventanas.FacPagoBolivias
    ...
    ''' </summary>
    Partial Public Class ConsultarFacPagoBolivias
        Inherits Page
        Implements IConsultarFacPagoBolivias

        Private _CurSortCol As GridViewColumnHeader = Nothing
        Private _CurAdorner As SortAdorner = Nothing
        Private _presentador As PresentadorConsultarFacPagoBolivias
        Private _cargada As Boolean

#Region "IConsultarFacPagoBoliviaes"
        ...
        Public Property FacPagoBoliviaFiltrar() As Object Implements Contratos.FacPagoBolivias.IConsultarFacPagoBolivias.FacPagoBoliviaFiltrar
            Get
        ...
        Public ReadOnly Property FacPagoBoliviaSeleccionado() As Object Implements Contratos.FacPagoBolivias.IConsultarFacPagoBolivias.FacPagoBoliviaSeleccionado
            Get
        ...
        Public Property Resultados() As Object Implements Contratos.FacPagoBolivias.IConsultarFacPagoBolivias.Resultados
            Get
        ...
        'Public Property Id() As Integer Implements Contratos.FacPagoBolivias.IConsultarFacPagoBolivias.Id
        '    Get
        ...
        Public Property CurSortCol() As System.Windows.Controls.GridViewColumnHeader Implements Contratos.FacPagoBolivias.IConsultarFacPagoBolivias.CurSortCol
            Get
                Return _CurSortCol
            End Get
        ...
        Public Property CurAdorner() As SortAdorner Implements Contratos.FacPagoBolivias.IConsultarFacPagoBolivias.CurAdorner
            Get
                Return _CurAdorner
            End Get
        ...
        Public Property ListaResultados() As System.Windows.Controls.ListView Implements Contratos.FacPagoBolivias.IConsultarFacPagoBolivias.ListaResultados
            Get
...
#End Region
        ...
        Public Sub New()
            ...
            Me._presentador = New PresentadorConsultarFacPagoBolivias(Me)
        End Sub
        ...
        Private Sub _lstResultados_MouseDoubleClick(ByVal sender As Object, ByVal e As MouseButtonEventArgs)
            If Me._lstResultados.SelectedItem IsNot Nothing Then
                Me._presentador.IrConsultarFacPagoBolivia()
            End If            
        End Sub
        ...
        Public Property BancoRec As Object Implements Contratos.FacPagoBolivias.IConsultarFacPagoBolivias.BancoRec
            Get
        ...
        Public Property BancosRec As Object Implements Contratos.FacPagoBolivias.IConsultarFacPagoBolivias.BancosRec
            Get
        ...
        Public ReadOnly Property FechaReg() As String Implements Contratos.FacPagoBolivias.IConsultarFacPagoBolivias.FechaReg
            Get
                Return Me._dpkFechaBanco.SelectedDate.ToString()
            End Get
        End Property

        Public ReadOnly Property FechaBanco() As String Implements Contratos.FacPagoBolivias.IConsultarFacPagoBolivias.FechaBanco
            Get
                Return Me._dpkFechaBanco.SelectedDate.ToString()
            End Get
        End Property

        Public ReadOnly Property TipoPago As Char Implements Contratos.FacPagoBolivias.IConsultarFacPagoBolivias.TipoPago
            Get
        ...
        'Contratos.FacPagoBolivias.IConsultarFacPagoBolivias

        Public Property Asociado As Object Implements Contratos.FacPagoBolivias.IConsultarFacPagoBolivias.Asociado
        ...
        Public Property Asociados As Object Implements Contratos.FacPagoBolivias.IConsultarFacPagoBolivias.Asociados
            Get
        ...
        Public Property NombreAsociado() As String Implements Contratos.FacPagoBolivias.IConsultarFacPagoBolivias.NombreAsociado
            Get
        ...
        Public Property idAsociadoFiltrar() As String Implements Contratos.FacPagoBolivias.IConsultarFacPagoBolivias.idAsociadoFiltrar
            Get
        ...
        Public Property NombreAsociadoFiltrar() As String Implements Contratos.FacPagoBolivias.IConsultarFacPagoBolivias.NombreAsociadoFiltrar
            Get
        ...
        Public WriteOnly Property Count As Integer Implements Contratos.FacPagoBolivias.IConsultarFacPagoBolivias.Count
