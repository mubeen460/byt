...
Namespace Ventanas.FacInternacionales
    Partial Public Class FacInternacionalRegistro
        Inherits Page
        Implements IFacInternacionalRegistro

        Private _presentador As PresentadorFacInternacionalRegistro
        Private _cargada As Boolean

#Region "IFacInternacionalRegistro"
        ...
        Public Sub Mensaje(ByVal mensaje__1 As String) Implements Contratos.FacInternacionales.IFacInternacionalRegistro.Mensaje
...
#End Region
        ...
        Public Sub New(ByVal proforma As Object)
            InitializeComponent()
            Me._cargada = False
            Me._presentador = New PresentadorFacInternacionalRegistro(Me, proforma)
        End Sub
        ...
        Public Property Fecha As Object Implements Contratos.FacInternacionales.IFacInternacionalRegistro.Fecha
            Get
        ...
        Public Property FechaRecepcion As Object Implements Contratos.FacInternacionales.IFacInternacionalRegistro.FechaRecepcion
            Get
                Return _dpkFechaRecepcion.Text
            End Get
            Set(ByVal value As Object)
                _dpkFechaRecepcion.Text = value
            End Set
        End Property
        ...
        Public Property Asociado As Object Implements Contratos.FacInternacionales.IFacInternacionalRegistro.Asociado
        ...
        Public Property Asociados As Object Implements Contratos.FacInternacionales.IFacInternacionalRegistro.Asociados
            Get
        ...
        Public Property NombreAsociado() As String Implements Contratos.FacInternacionales.IFacInternacionalRegistro.NombreAsociado
            Get
        ...
        Public Property idAsociadoFiltrar() As String Implements Contratos.FacInternacionales.IFacInternacionalRegistro.idAsociadoFiltrar
            Get
        ...
        Public Property NombreAsociadoFiltrar() As String Implements Contratos.FacInternacionales.IFacInternacionalRegistro.NombreAsociadoFiltrar
            Get
        ...
        Public Property Pais As Object Implements Contratos.FacInternacionales.IFacInternacionalRegistro.Pais
            Get
        ...
        Public Property Paises As Object Implements Contratos.FacInternacionales.IFacInternacionalRegistro.Paises
            Get
        ...
        Public Property Asociado2 As Object Implements Contratos.FacInternacionales.IFacInternacionalRegistro.Asociado2
        ...
        Public Property Asociados2 As Object Implements Contratos.FacInternacionales.IFacInternacionalRegistro.Asociados2
            Get
        ...
        Public Property NombreAsociado2() As String Implements Contratos.FacInternacionales.IFacInternacionalRegistro.NombreAsociado2
            Get
        ...
        Public Property idAsociadoFiltrar2() As String Implements Contratos.FacInternacionales.IFacInternacionalRegistro.idAsociadoFiltrar2
            Get
        ...
        Public Property NombreAsociadoFiltrar2() As String Implements Contratos.FacInternacionales.IFacInternacionalRegistro.NombreAsociadoFiltrar2
            Get
        ...
        Public Property FacInternacional As Object Implements Contratos.FacInternacionales.IFacInternacionalRegistro.FacInternacional
            Get
        ...
        Public ReadOnly Property GetTipoPago As Char Implements Contratos.FacInternacionales.IFacInternacionalRegistro.GetTipoPago
            Get
