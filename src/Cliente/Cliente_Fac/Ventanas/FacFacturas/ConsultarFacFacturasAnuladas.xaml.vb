...
Namespace Ventanas.FacFacturas
    ...
    ''' </summary>
    Partial Public Class ConsultarFacFacturasAnuladas
        Inherits Page
        Implements IConsultarFacFacturasAnuladas

        Private _CurSortCol As GridViewColumnHeader = Nothing
        Private _CurAdorner As SortAdorner = Nothing
        Private _presentador As PresentadorConsultarFacFacturasAnuladas
        Private _cargada As Boolean

#Region "IConsultarFacFacturasAnuladas"
        ...
        Public Property FacFacturaFiltrar() As Object Implements Contratos.FacFacturas.IConsultarFacFacturasAnuladas.FacFacturaFiltrar
            Get
        ...
        Public ReadOnly Property FacFacturaSeleccionado() As Object Implements Contratos.FacFacturas.IConsultarFacFacturasAnuladas.FacFacturaSeleccionado
            Get
        ...
        Public Property Resultados() As Object Implements Contratos.FacFacturas.IConsultarFacFacturasAnuladas.Resultados
            Get
        ...
        'Public Property Id() As Integer Implements Contratos.FacFacturas.IConsultarFacFacturasAnuladas.Id
        '    Get
        ...
        Public Property CurSortCol() As System.Windows.Controls.GridViewColumnHeader Implements Contratos.FacFacturas.IConsultarFacFacturasAnuladas.CurSortCol
            Get
                Return _CurSortCol
            End Get
        ...
        Public Property CurAdorner() As SortAdorner Implements Contratos.FacFacturas.IConsultarFacFacturasAnuladas.CurAdorner
            Get
                Return _CurAdorner
            End Get
        ...
        Public Property ListaResultados() As System.Windows.Controls.ListView Implements Contratos.FacFacturas.IConsultarFacFacturasAnuladas.ListaResultados
            Get
...
#End Region
        ...
        Public Sub New()
            ...
            Me._presentador = New PresentadorConsultarFacFacturasAnuladas(Me)
        End Sub
        ...
        Public Property Asociado As Object Implements Contratos.FacFacturas.IConsultarFacFacturasAnuladas.Asociado
        ...
        Public Property Asociados As Object Implements Contratos.FacFacturas.IConsultarFacFacturasAnuladas.Asociados
            Get
        ...
        'Public Property Bancos As Object Implements Contratos.FacFacturas.IConsultarFacFacturasAnuladas.Bancos
        '    Get
        ...
        'Public Property Idioma As Object Implements Contratos.FacFacturas.IConsultarFacFacturasAnuladas.Idioma
        '    Get
        ...
        'Public Property Idiomas As Object Implements Contratos.FacFacturas.IConsultarFacFacturasAnuladas.Idiomas
        '    Get
        ...
        'Public Property Moneda As Object Implements Contratos.FacFacturas.IConsultarFacFacturasAnuladas.Moneda
        '    Get
        ...
        'Public Property Monedas As Object Implements Contratos.FacFacturas.IConsultarFacFacturasAnuladas.Monedas
        '    Get
        ...
        Public Property NombreAsociado() As String Implements Contratos.FacFacturas.IConsultarFacFacturasAnuladas.NombreAsociado
            Get
        ...
        Public Property idAsociadoFiltrar() As String Implements Contratos.FacFacturas.IConsultarFacFacturasAnuladas.idAsociadoFiltrar
            Get
        ...
        Public Property NombreAsociadoFiltrar() As String Implements Contratos.FacFacturas.IConsultarFacFacturasAnuladas.NombreAsociadoFiltrar
            Get
        ...
        Public ReadOnly Property FechaFactura() As String Implements Contratos.FacFacturas.IConsultarFacFacturasAnuladas.FechaFactura
            Get
                Return Me._dpkFechaFactura.SelectedDate.ToString()
            End Get
        End Property

        Public ReadOnly Property Id() As String Implements Contratos.FacFacturas.IConsultarFacFacturasAnuladas.Id
            Get
                Return Me._txtId.Text
            End Get
        End Property

        'Public ReadOnly Property CreditoSent As String Implements Contratos.FacFacturas.IConsultarFacFacturasAnuladas.CreditoSent
        '    Get
        ...
        Public WriteOnly Property Count As Integer Implements Contratos.FacFacturas.IConsultarFacFacturasAnuladas.Count
