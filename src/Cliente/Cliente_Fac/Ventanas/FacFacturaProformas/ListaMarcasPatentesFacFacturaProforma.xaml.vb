...
Namespace Ventanas.FacFacturaProformas
    ...
    ''' </summary>
    Partial Public Class ListaMarcasPatentesFacFacturaProforma
        Inherits Page
        Implements IListaMarcasPatentesFacFacturaProforma

        Private _CurSortCol As GridViewColumnHeader = Nothing
        Private _CurAdorner As SortAdorner = Nothing
        Private _presentador As PresentadorListaMarcasPatentesFacFacturaProforma
        Private _cargada As Boolean

#Region "ListaMarcasPatentesFacFacturaProforma"
        ...
        Public Property Elementos As Object Implements Contratos.FacFacturaProformas.IListaMarcasPatentesFacFacturaProforma.Elementos
            Get
        ...
        Public Property ElementoConsultado As Object Implements Contratos.FacFacturaProformas.IListaMarcasPatentesFacFacturaProforma.ElementoConsultado
        ...
        Public Property IdElemento As String Implements Contratos.FacFacturaProformas.IListaMarcasPatentesFacFacturaProforma.IdElemento
            Get
        ...
        Public Property IdInternacionalElemento As String Implements Contratos.FacFacturaProformas.IListaMarcasPatentesFacFacturaProforma.IdInternacionalElemento
            Get
        ...
        Public Property Solicitud As String Implements Contratos.FacFacturaProformas.IListaMarcasPatentesFacFacturaProforma.Solicitud
            Get
        ...
        Public Property Registro As String Implements Contratos.FacFacturaProformas.IListaMarcasPatentesFacFacturaProforma.Registro
            Get
        ...
        Public Property Marcas() As Object Implements Contratos.FacFacturaProformas.IListaMarcasPatentesFacFacturaProforma.Marcas
            Get
        ...
        Public ReadOnly Property MarcaSeleccionada() As Object Implements Contratos.FacFacturaProformas.IListaMarcasPatentesFacFacturaProforma.MarcaSeleccionada
            Get
                Return Me._lstMarcas.SelectedItem
            End Get
        End Property

        Public Property Patentes() As Object Implements Contratos.FacFacturaProformas.IListaMarcasPatentesFacFacturaProforma.Patentes
            Get
        ...
        Public ReadOnly Property PatenteSeleccionada() As Object Implements Contratos.FacFacturaProformas.IListaMarcasPatentesFacFacturaProforma.PatenteSeleccionada
            Get
...
#Region "Constructores"
        Public Sub New()
            InitializeComponent()
            Me._cargada = False
            Me._presentador = New PresentadorListaMarcasPatentesFacFacturaProforma(Me)
        End Sub

        Public Sub New(ByVal ventanaPadre As Object)
            InitializeComponent()
            Me._cargada = False
            Me._presentador = New PresentadorListaMarcasPatentesFacFacturaProforma(Me, ventanaPadre)
        End Sub
...
#Region "Metodos"
        Public Sub HabilitarCampoInternacional(ByVal estado As Boolean) Implements Contratos.FacFacturaProformas.IListaMarcasPatentesFacFacturaProforma.HabilitarCampoInternacional
            Me._txtIdInternacionalElemento.IsEnabled = estado
        End Sub

        Public Sub Mensaje(ByVal mensaje As String, ByVal tipoMensaje As Integer) Implements Contratos.FacFacturaProformas.IListaMarcasPatentesFacFacturaProforma.Mensaje
        ...
        Public Sub GestionarVisibilidadListas(ByVal estado As Boolean) Implements Contratos.FacFacturaProformas.IListaMarcasPatentesFacFacturaProforma.GestionarVisibilidadListas
            If estado Then
