...
Namespace Ventanas.FacFacturaProformas
    ...
    ''' </summary>
    Partial Public Class ConsultarFacFacturaProformasAutorizacion
        Inherits Page
        Implements IConsultarFacFacturaProformasAutorizacion

        Dim value As Boolean = False
        Private _CurSortCol As GridViewColumnHeader = Nothing
        Private _CurAdorner As SortAdorner = Nothing
        Private _presentador As PresentadorConsultarFacFacturaProformasAutorizacion
        Private _cargada As Boolean

#Region "IConsultarFacFacturaProformasAutorizacion"
        ...
        Public Property FacFacturaProformaFiltrar() As Object Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.FacFacturaProformaFiltrar
            Get
        ...
        Public ReadOnly Property FacFacturaProformaSeleccionado() As Object Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.FacFacturaProformaSeleccionado
            Get
        ...
        Public Property Resultados() As Object Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.Resultados
            Get
        ...
        'Public Property Id() As Integer Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.Id
        '    Get
        ...
        Public Property CurSortCol() As System.Windows.Controls.GridViewColumnHeader Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.CurSortCol
            Get
                Return _CurSortCol
            End Get
        ...
        Public Property CurAdorner() As SortAdorner Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.CurAdorner
            Get
                Return _CurAdorner
            End Get
        ...
        Public Property ListaResultados() As System.Windows.Controls.ListView Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.ListaResultados
            Get
...
#End Region
        ...
        Public Sub New()
            ...
            Me._presentador = New PresentadorConsultarFacFacturaProformasAutorizacion(Me)
        End Sub
        ...
        Public Property Asociado As Object Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.Asociado
        ...
        Public Property Asociados As Object Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.Asociados
            Get
        ...
        'Public Property Banco As Object Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.Banco
        '    Get
        ...
        'Public Property Bancos As Object Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.Bancos
        '    Get
        ...
        'Public Property Idioma As Object Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.Idioma
        '    Get
        ...
        'Public Property Idiomas As Object Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.Idiomas
        '    Get
        ...
        'Public Property Moneda As Object Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.Moneda
        '    Get
        ...
        'Public Property Monedas As Object Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.Monedas
        '    Get
        ...
        Public Property NombreAsociado() As String Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.NombreAsociado
            Get
        ...
        Public Property idAsociadoFiltrar() As String Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.idAsociadoFiltrar
            Get
        ...
        Public Property NombreAsociadoFiltrar() As String Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.NombreAsociadoFiltrar
            Get
        ...
        Public ReadOnly Property FechaFactura() As String Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.FechaFactura
            Get
                Return Me._dpkFechaFactura.SelectedDate.ToString()
            End Get
        End Property

        Public ReadOnly Property Id() As String Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.Id
            Get
                Return Me._txtId.Text
            End Get
        End Property

        'Public ReadOnly Property CreditoSent As String Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.CreditoSent
        '    Get
        ...
        'Public WriteOnly Property Cba As Double Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.Cba
        '    Set(ByVal value As Double)
        '        Me._txtCba.Text = value
        '    End Set
        'End Property

        'Public WriteOnly Property Cbf As Double Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.Cbf
        '    Set(ByVal value As Double)
        '        Me._txtCbf.Text = value
        '    End Set
        'End Property

        Public WriteOnly Property Cbp As Double Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.Cbp
            Set(ByVal value As Double)
                Me._txtCbp.Text = value
            End Set
        End Property

        Public WriteOnly Property Cbr As Double Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.Cbr
            Set(ByVal value As Double)
                Me._txtCbr.Text = value
            End Set
        End Property

        'Public WriteOnly Property Cda As Double Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.Cda
        '    Set(ByVal value As Double)
        '        Me._txtCda.Text = value
        '    End Set
        'End Property

        'Public WriteOnly Property Cdf As Double Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.Cdf
        '    Set(ByVal value As Double)
        '        Me._txtCdf.Text = value
        '    End Set
        'End Property

        Public WriteOnly Property Cdp As Double Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.Cdp
            Set(ByVal value As Double)
                Me._txtCdp.Text = value
            End Set
        End Property

        Public WriteOnly Property Cdr As Double Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.Cdr
            Set(ByVal value As Double)
                Me._txtCdr.Text = value
            End Set
        End Property

        Public WriteOnly Property Count As Integer Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasAutorizacion.Count
