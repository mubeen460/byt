...
Namespace Ventanas.Consultas
    ...
    ''' </summary>
    Partial Public Class ConsultaFacturacionVigenteAsociado
        Inherits Page
        Implements IConsultaFacturacionVigenteAsociado

        Private _CurSortCol As GridViewColumnHeader = Nothing
        Private _CurAdorner As SortAdorner = Nothing
        Private _presentador As PresentadorConsultaFacturacionVigenteAsociado
...
#Region "IConsultarFacOperacionsAnuladas"
        ...
        Public Property FacOperacionFiltrar() As Object Implements Contratos.Consultas.IConsultaFacturacionVigenteAsociado.FacOperacionFiltrar
            Get
        ...
        Public ReadOnly Property FacOperacionSeleccionado() As Object Implements Contratos.Consultas.IConsultaFacturacionVigenteAsociado.FacOperacionSeleccionado
            Get
        ...
        Public Property Resultados() As Object Implements Contratos.Consultas.IConsultaFacturacionVigenteAsociado.Resultados
            Get
        ...
        'Public Property Id() As Integer Implements Contratos.Consultas.IConsultaFacturacionVigenteAsociado.Id
        '    Get
        ...
        Public Property CurSortCol() As System.Windows.Controls.GridViewColumnHeader Implements Contratos.Consultas.IConsultaFacturacionVigenteAsociado.CurSortCol
            Get
                Return _CurSortCol
            End Get
        ...
        Public Property CurAdorner() As SortAdorner Implements Contratos.Consultas.IConsultaFacturacionVigenteAsociado.CurAdorner
            Get
                Return _CurAdorner
            End Get
        ...
        Public Property ListaResultados() As System.Windows.Controls.ListView Implements Contratos.Consultas.IConsultaFacturacionVigenteAsociado.ListaResultados
            Get
...
#End Region
        ...
        Public Sub New()
            ...
            Me._presentador = New PresentadorConsultaFacturacionVigenteAsociado(Me)
        End Sub
        ...
        Public Property Asociado As Object Implements Contratos.Consultas.IConsultaFacturacionVigenteAsociado.Asociado
        ...
        Public Property Asociados As Object Implements Contratos.Consultas.IConsultaFacturacionVigenteAsociado.Asociados
            Get
        ...
        Public Property NombreAsociado() As String Implements Contratos.Consultas.IConsultaFacturacionVigenteAsociado.NombreAsociado
            Get
        ...
        Public Property idAsociadoFiltrar() As String Implements Contratos.Consultas.IConsultaFacturacionVigenteAsociado.idAsociadoFiltrar
            Get
        ...
        Public Property NombreAsociadoFiltrar() As String Implements Contratos.Consultas.IConsultaFacturacionVigenteAsociado.NombreAsociadoFiltrar
            Get
        ...
        'Public ReadOnly Property FechaFactura() As String Implements Contratos.Consultas.IConsultaFacturacionVigenteAsociado.FechaFactura
        '    Get
        '        Return Me._dpkFechaFactura.SelectedDate.ToString()
        '    End Get
        'End Property

        'Public ReadOnly Property Id() As String Implements Contratos.Consultas.IConsultaFacturacionVigenteAsociado.Id
        '    Get
        '        Return Me._txtId.Text
        '    End Get
        'End Property

        Public WriteOnly Property Count As Integer Implements Contratos.Consultas.IConsultaFacturacionVigenteAsociado.Count
            Set(ByVal value As Integer)
                _lblHits.Text = value
            End Set
        End Property
