...
Namespace Ventanas.Consultas
    ...
    ''' </summary>
    Partial Public Class ConsultaFacturacionAsociado
        Inherits Page
        Implements IConsultaFacturacionAsociado

        Private _CurSortCol As GridViewColumnHeader = Nothing
        Private _CurAdorner As SortAdorner = Nothing
        Private _presentador As PresentadorConsultaFacturacionAsociado
...
#Region "IConsultarFacOperacionsAnuladas"
        ...
        Public Property FacOperacionFiltrar() As Object Implements Contratos.Consultas.IConsultaFacturacionAsociado.FacOperacionFiltrar
            Get
        ...
        Public ReadOnly Property FacOperacionSeleccionado() As Object Implements Contratos.Consultas.IConsultaFacturacionAsociado.FacOperacionSeleccionado
            Get
        ...
        Public Property Resultados() As Object Implements Contratos.Consultas.IConsultaFacturacionAsociado.Resultados
            Get
        ...
        'Public Property Id() As Integer Implements Contratos.Consultas.IConsultaFacturacionAsociado.Id
        '    Get
        ...
        Public Property CurSortCol() As System.Windows.Controls.GridViewColumnHeader Implements Contratos.Consultas.IConsultaFacturacionAsociado.CurSortCol
            Get
                Return _CurSortCol
            End Get
        ...
        Public Property CurAdorner() As SortAdorner Implements Contratos.Consultas.IConsultaFacturacionAsociado.CurAdorner
            Get
                Return _CurAdorner
            End Get
        ...
        Public Property ListaResultados() As System.Windows.Controls.ListView Implements Contratos.Consultas.IConsultaFacturacionAsociado.ListaResultados
            Get
...
#End Region
        ...
        Public Sub New()
            ...
            Me._presentador = New PresentadorConsultaFacturacionAsociado(Me)
        End Sub
        ...
        Public Property Asociado As Object Implements Contratos.Consultas.IConsultaFacturacionAsociado.Asociado
        ...
        Public Property Asociados As Object Implements Contratos.Consultas.IConsultaFacturacionAsociado.Asociados
            Get
        ...
        Public Property NombreAsociado() As String Implements Contratos.Consultas.IConsultaFacturacionAsociado.NombreAsociado
            Get
        ...
        Public Property idAsociadoFiltrar() As String Implements Contratos.Consultas.IConsultaFacturacionAsociado.idAsociadoFiltrar
            Get
        ...
        Public Property NombreAsociadoFiltrar() As String Implements Contratos.Consultas.IConsultaFacturacionAsociado.NombreAsociadoFiltrar
            Get
        ...
        'Public ReadOnly Property FechaFactura() As String Implements Contratos.Consultas.IConsultaFacturacionAsociado.FechaFactura
        '    Get
        '        Return Me._dpkFechaFactura.SelectedDate.ToString()
        '    End Get
        'End Property

        'Public ReadOnly Property Id() As String Implements Contratos.Consultas.IConsultaFacturacionAsociado.Id
        '    Get
        '        Return Me._txtId.Text
        '    End Get
        'End Property

        Public WriteOnly Property Count As Integer Implements Contratos.Consultas.IConsultaFacturacionAsociado.Count
            Set(ByVal value As Integer)
                _lblHits.Text = value
            End Set
        End Property
