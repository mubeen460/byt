...
Namespace Ventanas.Consultas
    ...
    ''' </summary>
    Partial Public Class ConsultaPagosAsociado
        Inherits Page
        Implements IConsultaPagosAsociado

        Private _CurSortCol As GridViewColumnHeader = Nothing
        Private _CurAdorner As SortAdorner = Nothing
        Private _presentador As PresentadorConsultaPagosAsociado
...
#Region "IConsultarFacOperacionsAnuladas"
        ...
        Public Property FacOperacionFiltrar() As Object Implements Contratos.Consultas.IConsultaPagosAsociado.FacOperacionFiltrar
            Get
        ...
        Public ReadOnly Property FacOperacionSeleccionado() As Object Implements Contratos.Consultas.IConsultaPagosAsociado.FacOperacionSeleccionado
            Get
        ...
        Public Property Resultados() As Object Implements Contratos.Consultas.IConsultaPagosAsociado.Resultados
            Get
        ...
        'Public Property Id() As Integer Implements Contratos.Consultas.IConsultaPagosAsociado.Id
        '    Get
        ...
        Public Property CurSortCol() As System.Windows.Controls.GridViewColumnHeader Implements Contratos.Consultas.IConsultaPagosAsociado.CurSortCol
            Get
                Return _CurSortCol
            End Get
        ...
        Public Property CurAdorner() As SortAdorner Implements Contratos.Consultas.IConsultaPagosAsociado.CurAdorner
            Get
                Return _CurAdorner
            End Get
        ...
        Public Property ListaResultados() As System.Windows.Controls.ListView Implements Contratos.Consultas.IConsultaPagosAsociado.ListaResultados
            Get
...
#End Region
        ...
        Public Sub New()
            ...
            Me._presentador = New PresentadorConsultaPagosAsociado(Me)
        End Sub
        ...
        Public Property Asociado As Object Implements Contratos.Consultas.IConsultaPagosAsociado.Asociado
        ...
        Public Property Asociados As Object Implements Contratos.Consultas.IConsultaPagosAsociado.Asociados
            Get
        ...
        Public Property NombreAsociado() As String Implements Contratos.Consultas.IConsultaPagosAsociado.NombreAsociado
            Get
        ...
        Public Property idAsociadoFiltrar() As String Implements Contratos.Consultas.IConsultaPagosAsociado.idAsociadoFiltrar
            Get
        ...
        Public Property NombreAsociadoFiltrar() As String Implements Contratos.Consultas.IConsultaPagosAsociado.NombreAsociadoFiltrar
            Get
        ...
        'Public ReadOnly Property FechaFactura() As String Implements Contratos.Consultas.IConsultaPagosAsociado.FechaFactura
        '    Get
        '        Return Me._dpkFechaFactura.SelectedDate.ToString()
        '    End Get
        'End Property

        'Public ReadOnly Property Id() As String Implements Contratos.Consultas.IConsultaPagosAsociado.Id
        '    Get
        '        Return Me._txtId.Text
        '    End Get
        'End Property

        Public WriteOnly Property Count As Integer Implements Contratos.Consultas.IConsultaPagosAsociado.Count
            Set(ByVal value As Integer)
                _lblHits.Text = value
            End Set
        End Property

        Public Sub Mensaje(ByVal mensaje As String, ByVal tipo As Integer) Implements Contratos.Consultas.IConsultaPagosAsociado.Mensaje
            If tipo = 0 Then
