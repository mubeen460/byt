...
Namespace Ventanas.FacReportes
    Partial Public Class FacturaCopiaRpt
        Inherits Page
        Implements IFacturaCopiaRpt


        Private _presentador As PresentadorFacturaCopiaRpt
        Private _cargada As Boolean

#Region "IFacturaCopiaRpt"
        ...
        Public Sub Mensaje(ByVal mensaje__1 As String) Implements Contratos.FacReportes.IFacturaCopiaRpt.Mensaje
...
#End Region
        ...
        Public Sub New(ByVal FacFactura As Object)
            InitializeComponent()
            Me._cargada = False
            Me._presentador = New PresentadorFacturaCopiaRpt(Me, FacFactura)
        End Sub
        ...
        Public WriteOnly Property CrystalViewer() As Object Implements Contratos.FacReportes.IFacturaCopiaRpt.CrystalViewer
