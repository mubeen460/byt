...
Namespace Ventanas.FacReportes
    Partial Public Class FacturaRpt
        Inherits Page
        Implements IFacturaRpt


        Private _presentador As PresentadorFacturaRpt
...
#Region "IFacturaRpt"
        ...
        Public Sub Mensaje(ByVal mensaje__1 As String) Implements Contratos.FacReportes.IFacturaRpt.Mensaje
...
#End Region
        ...
        Public Sub New(ByVal FacFactura As Object)
            InitializeComponent()
            Me._cargada = False
            Me._presentador = New PresentadorFacturaRpt(Me, FacFactura)
        End Sub
