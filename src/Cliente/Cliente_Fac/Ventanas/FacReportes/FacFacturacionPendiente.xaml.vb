...
Namespace Ventanas.FacReportes
    Partial Public Class FacFacturacionPendiente
        Inherits Page
        Implements IFacFacturacionPendiente

        Private _presentador As PresentadorFacFacturacionPendiente
        Private _cargada As Boolean

#Region "IFacFacturacionPendiente"

        Public Sub New()
            InitializeComponent()
            Me._cargada = False
            Me._presentador = New PresentadorFacFacturacionPendiente(Me)
        End Sub
        ...
        Public Sub Mensaje(ByVal mensaje__1 As String) Implements Contratos.FacReportes.IFacFacturacionPendiente.Mensaje
...
#End Region
        ...
        '    InitializeComponent()
        '    Me._cargada = False
        '    Me._presentador = New PresentadorFacFacturacionPendiente()
        'End Sub
        ...
        Public Property Fecha1 As String Implements Contratos.FacReportes.IFacFacturacionPendiente.Fecha1
            Get
        ...
        Public ReadOnly Property TipoMoneda As String Implements Contratos.FacReportes.IFacFacturacionPendiente.TipoMoneda
            Get
                Return _cbxTipoMoneda.Text
            End Get
        End Property

        Public Property MayorMenor As Object Implements Contratos.FacReportes.IFacFacturacionPendiente.MayorMenor
            Get
                If RbMayor.IsChecked = True Then
                    Return "Ma"
                Else
                    If RbMenor.IsChecked = True Then
                        Return "ME"
                    Else
                        Return ""
                    End If
            ...
            Set(ByVal value As Object)
                If value = "Ma" Then
                    RbMayor.IsChecked = True
                Else
                    RbMenor.IsChecked = True
                End If
            End Set
        End Property
        ...
        Public Property Asociado As Object Implements Contratos.FacReportes.IFacFacturacionPendiente.Asociado
        ...
        Public Property Asociados As Object Implements Contratos.FacReportes.IFacFacturacionPendiente.Asociados
            Get
        ...
        Public Property NombreAsociado() As String Implements Contratos.FacReportes.IFacFacturacionPendiente.NombreAsociado
            Get
        ...
        Public Property idAsociadoFiltrar() As String Implements Contratos.FacReportes.IFacFacturacionPendiente.idAsociadoFiltrar
            Get
        ...
        Public Property NombreAsociadoFiltrar() As String Implements Contratos.FacReportes.IFacFacturacionPendiente.NombreAsociadoFiltrar
            Get
        ...
        Public Property Asociado2 As Object Implements Contratos.FacReportes.IFacFacturacionPendiente.Asociado2
        ...
        Public Property Asociados2 As Object Implements Contratos.FacReportes.IFacFacturacionPendiente.Asociados2
            Get
        ...
        Public Property NombreAsociado2() As String Implements Contratos.FacReportes.IFacFacturacionPendiente.NombreAsociado2
            Get
        ...
        Public Property idAsociadoFiltrar2() As String Implements Contratos.FacReportes.IFacFacturacionPendiente.idAsociadoFiltrar2
            Get
        ...
        Public Property NombreAsociadoFiltrar2() As String Implements Contratos.FacReportes.IFacFacturacionPendiente.NombreAsociadoFiltrar2
            Get
