...
Namespace Presentadores.FacFacturaProformas
    Class PresentadorConsultarFacFacturaProformasDepartamentos
        Inherits PresentadorBase
        Private Shared _paginaPrincipal As PaginaPrincipal = PaginaPrincipal.ObtenerInstancia
        Private Shared logger As Logger = LogManager.GetCurrentClassLogger()

        Private _ventana As IConsultarFacFacturaProformasDepartamentos
        ...
        Public Sub New(ByVal ventana As IConsultarFacFacturaProformasDepartamentos)
            Try
                Me._ventana = ventana
        ...
        Public Sub ActualizarTitulo()
            Me.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.fac_titleConsultarFacFacturaProformasDepartamentos, Recursos.Ids.fac_ConsultarFacFacturaProforma)
        End Sub
        ...
        Public Sub Limpiar()
            ...
            Me.Navegar(New ConsultarFacFacturaProformasDepartamentos())
        ...
        Public Sub sumar(ByVal proforma As IList(Of FacFacturaProforma))
            Dim cbp, cba, cbr, cdp, cda, cdr As Integer
            cbp = 0
            cba = 0
            'cbf = 0
            cbr = 0
