...
Namespace Presentadores.FacOperacionAnuladas
    Class PresentadorConsultarFacOperacionAnuladas
        Inherits PresentadorBase
        Private Shared _paginaPrincipal As PaginaPrincipal = PaginaPrincipal.ObtenerInstancia
        Private Shared logger As Logger = LogManager.GetCurrentClassLogger()

        Private _ventana As IConsultarFacOperacionAnuladas
        ...
        Public Sub New(ByVal ventana As IConsultarFacOperacionAnuladas)
            Try
                Me._ventana = ventana
        ...
        Public Sub CargarPagina()
            ...
            Try
                ...
                Me._ventana.Resultados = Me._FacOperacionAnuladas
                Me._ventana.FacOperacionAnuladaFiltrar = New FacOperacionAnulada()
        ...
        Public Sub Consultar()
            Try
                ...
                Dim FacOperacionAnuladaAuxiliar As New FacOperacionAnulada()
                Dim FacOperacionAnuladas As FacOperacionAnulada = DirectCast(_ventana.FacOperacionAnuladaFiltrar, FacOperacionAnulada)

                If Not Me._ventana.Id.Equals("") Then
                    FacOperacionAnuladaAuxiliar.Id = Integer.Parse(Me._ventana.Id)
                End If

                'If Not Me._ventana.CreditoSent.Equals("") Then
                '    FacOperacionAnuladaAuxiliar.CreditoSent = Integer.Parse(Me._ventana.CreditoSent)
                'End If

                If (Me._ventana.Asociado IsNot Nothing) AndAlso (DirectCast(Me._ventana.Asociado, Asociado).Id <> Integer.MinValue) Then
                    FacOperacionAnuladaAuxiliar.Asociado = DirectCast(Me._ventana.Asociado, Asociado)
                End If

                If (Me._ventana.Banco IsNot Nothing) AndAlso (DirectCast(Me._ventana.Banco, FacBanco).Id <> Integer.MinValue) Then
                    FacOperacionAnuladaAuxiliar.Banco = DirectCast(Me._ventana.Banco, FacBanco)
                End If

                If (Me._ventana.Idioma IsNot Nothing) AndAlso (DirectCast(Me._ventana.Idioma, Idioma).Id <> "") Then
                    FacOperacionAnuladaAuxiliar.Idioma = DirectCast(Me._ventana.Idioma, Idioma)
                End If

                If (Me._ventana.Moneda IsNot Nothing) AndAlso (DirectCast(Me._ventana.Moneda, Moneda).Id <> "") Then
                    FacOperacionAnuladaAuxiliar.Moneda = DirectCast(Me._ventana.Moneda, Moneda)
                End If

                If Not Me._ventana.FechaCobro.Equals("") Then
                    Dim FechaFacOperacionAnulada As DateTime = DateTime.Parse(Me._ventana.FechaCobro)
                    FacOperacionAnuladaAuxiliar.FechaCobro = FechaFacOperacionAnulada
                End If
