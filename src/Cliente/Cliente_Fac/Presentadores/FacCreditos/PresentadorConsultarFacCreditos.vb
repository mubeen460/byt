...
Namespace Presentadores.FacCreditos
    Class PresentadorConsultarFacCreditos
        Inherits PresentadorBase
        Private Shared _paginaPrincipal As PaginaPrincipal = PaginaPrincipal.ObtenerInstancia
        Private Shared logger As Logger = LogManager.GetCurrentClassLogger()

        Private _ventana As IConsultarFacCreditos
        ...
        Public Sub New(ByVal ventana As IConsultarFacCreditos)
            Try
                Me._ventana = ventana
        ...
        Public Sub CargarPagina()
            ...
            Try
                ...
                Me._ventana.FacCreditoFiltrar = New FacCredito()
        ...
        Public Sub Limpiar()
            ...
            Me.Navegar(New ConsultarFacCreditos())
        ...
        Public Sub Consultar()
            Try
                ...
                Dim FacCreditoAuxiliar As New FacCredito()
                Dim FacCreditos As FacCredito = DirectCast(_ventana.FacCreditoFiltrar, FacCredito)

                If Not Me._ventana.Id.Equals("") Then
                    FacCreditoAuxiliar.Id = Integer.Parse(Me._ventana.Id)
                End If

                If Not Me._ventana.CreditoSent.Equals("") Then
                    FacCreditoAuxiliar.CreditoSent = Integer.Parse(Me._ventana.CreditoSent)
                End If

                If (Me._ventana.Asociado IsNot Nothing) AndAlso (DirectCast(Me._ventana.Asociado, Asociado).Id <> Integer.MinValue) Then
                    FacCreditoAuxiliar.Asociado = DirectCast(Me._ventana.Asociado, Asociado)
                End If

                If (Me._ventana.Banco IsNot Nothing) AndAlso (DirectCast(Me._ventana.Banco, FacBanco).Id <> Integer.MinValue) Then
                    FacCreditoAuxiliar.Banco = DirectCast(Me._ventana.Banco, FacBanco)
                End If

                If (Me._ventana.Idioma IsNot Nothing) AndAlso (DirectCast(Me._ventana.Idioma, Idioma).Id <> "") Then
                    FacCreditoAuxiliar.Idioma = DirectCast(Me._ventana.Idioma, Idioma)
                End If

                If (Me._ventana.Moneda IsNot Nothing) AndAlso (DirectCast(Me._ventana.Moneda, Moneda).Id <> "") Then
                    FacCreditoAuxiliar.Moneda = DirectCast(Me._ventana.Moneda, Moneda)
                End If

                If Not Me._ventana.FechaCredito.Equals("") Then
                    Dim FechaCreditoFacCredito As DateTime = DateTime.Parse(Me._ventana.FechaCredito)
                    FacCreditoAuxiliar.FechaCredito = FechaCreditoFacCredito
                End If
