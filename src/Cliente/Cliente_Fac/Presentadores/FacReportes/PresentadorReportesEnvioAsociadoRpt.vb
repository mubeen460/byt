...
Namespace Presentadores.FacReportes
    Class PresentadorReportesEnvioAsociadoRpt
        Inherits PresentadorBase

        Private _ventana As IReportesEnvioAsociadoRpt
        ...
        Public Sub New(ByVal ventana As IReportesEnvioAsociadoRpt, ByVal reporte As Object)
            Try
                Me._ventana = ventana
        ...
        Public Sub Limpiar()
            ...
            ' Me.Navegar(New Diginsoft.Bolet.Cliente.Fac.Ventanas.FacReportes.ReportesEnvioAsociadoRpt())
