...
Namespace Presentadores.FacReportes
    Class PresentadorFacturaRpt
        Inherits PresentadorBase

        Private _ventana As IFacturaRpt
        ...
        Public Sub New(ByVal ventana As IFacturaRpt, ByVal FacFactura As Object)
            Try
                Me._ventana = ventana
        ...
        Public Sub Limpiar()
            ...
            Me.Navegar(New Diginsoft.Bolet.Cliente.Fac.Ventanas.FacReportes.FacturaRpt(_FacFactura))
