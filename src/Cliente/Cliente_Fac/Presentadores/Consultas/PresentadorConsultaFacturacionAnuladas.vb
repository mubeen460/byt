...
Namespace Presentadores.Consultas
    Class PresentadorConsultaFacturacionAnuladas
        Inherits PresentadorBase
        Private Shared _paginaPrincipal As PaginaPrincipal = PaginaPrincipal.ObtenerInstancia
        Private Shared logger As Logger = LogManager.GetCurrentClassLogger()

        Private _ventana As IConsultaFacturacionAnuladas
        ...
        Public Sub New(ByVal ventana As IConsultaFacturacionAnuladas)
            Try
                Me._ventana = ventana
        ...
        Public Sub ActualizarTitulo()
            Me.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.fac_menuItemConsultaFacturacionAnuladas, Recursos.Ids.fac_menuItemConsultaFacturacionAnuladas)
        End Sub
        ...
        Public Sub Limpiar()
            ...
            Me.Navegar(New ConsultaFacturacionAnuladas())
