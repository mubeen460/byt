...
Namespace Presentadores.Consultas
    Class PresentadorConsultaPagosAsociado
        ...
        Private _ventana As IConsultaPagosAsociado
        ...
        Public Sub New(ByVal ventana As IConsultaPagosAsociado)
            Try
                Me._ventana = ventana
        ...
        Public Sub ActualizarTitulo()
            Me.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.fac_menuItemConsultaPagosAsociado, Recursos.Ids.fac_menuItemConsultaPagosAsociado)
        End Sub
        ...
        Public Sub Limpiar()
            ...
            Me.Navegar(New ConsultaPagosAsociado())
