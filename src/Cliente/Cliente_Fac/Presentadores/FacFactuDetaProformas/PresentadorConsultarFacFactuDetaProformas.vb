...
Namespace Presentadores.FacFactuDetaProformas
    Class PresentadorConsultarFacFactuDetaProformas
        Inherits PresentadorBase
        Private Shared _paginaPrincipal As PaginaPrincipal = PaginaPrincipal.ObtenerInstancia
        Private Shared logger As Logger = LogManager.GetCurrentClassLogger()

        Private _ventana As IConsultarFacFactuDetaProformas
        ...
        Public Sub New(ByVal ventana As IConsultarFacFactuDetaProformas)
            Try
                Me._ventana = ventana
        ...
        Public Sub CargarPagina()
            ...
            Try
                ...
                Me._ventana.Resultados = Me._FacFactuDetaProformas
                Me._ventana.FacFactuDetaProformaFiltrar = New FacFactuDetaProforma()
        ...
        Public Sub Consultar()
            Try
                ...
                Dim FacFactuDetaProformaAuxiliar As New FacFactuDetaProforma()
                Dim FacFactuDetaProformas As FacFactuDetaProforma = DirectCast(_ventana.FacFactuDetaProformaFiltrar, FacFactuDetaProforma)

                If Not Me._ventana.Id.Equals("") Then
                    FacFactuDetaProformaAuxiliar.Id = Integer.Parse(Me._ventana.Id)
                End If

                'If Not Me._ventana.CreditoSent.Equals("") Then
                '    FacFactuDetaProformaAuxiliar.CreditoSent = Integer.Parse(Me._ventana.CreditoSent)
                'End If

                If (Me._ventana.Asociado IsNot Nothing) AndAlso (DirectCast(Me._ventana.Asociado, Asociado).Id <> Integer.MinValue) Then
                    FacFactuDetaProformaAuxiliar.Asociado = DirectCast(Me._ventana.Asociado, Asociado)
                End If

                If (Me._ventana.Banco IsNot Nothing) AndAlso (DirectCast(Me._ventana.Banco, FacBanco).Id <> Integer.MinValue) Then
                    FacFactuDetaProformaAuxiliar.Banco = DirectCast(Me._ventana.Banco, FacBanco)
                End If

                If (Me._ventana.Idioma IsNot Nothing) AndAlso (DirectCast(Me._ventana.Idioma, Idioma).Id <> "") Then
                    FacFactuDetaProformaAuxiliar.Idioma = DirectCast(Me._ventana.Idioma, Idioma)
                End If

                If (Me._ventana.Moneda IsNot Nothing) AndAlso (DirectCast(Me._ventana.Moneda, Moneda).Id <> "") Then
                    FacFactuDetaProformaAuxiliar.Moneda = DirectCast(Me._ventana.Moneda, Moneda)
                End If

                If Not Me._ventana.FechaCobro.Equals("") Then
                    Dim FechaFacFactuDetaProforma As DateTime = DateTime.Parse(Me._ventana.FechaCobro)
                    FacFactuDetaProformaAuxiliar.FechaCobro = FechaFacFactuDetaProforma
                End If
