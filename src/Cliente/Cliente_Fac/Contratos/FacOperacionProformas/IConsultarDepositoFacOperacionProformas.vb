...
Namespace Contratos.FacOperacionProformas
    Interface IConsultarDepositoFacOperacionProformas
        Inherits IPaginaBaseFac
        Property FacOperacionProformaFiltrar() As Object

        ReadOnly Property FacOperacionProformaSeleccionado() As Object
