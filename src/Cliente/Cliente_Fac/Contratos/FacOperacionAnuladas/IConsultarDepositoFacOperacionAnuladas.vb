...
Namespace Contratos.FacOperacionAnuladas
    Interface IConsultarDepositoFacOperacionAnuladas
        Inherits IPaginaBaseFac
        Property FacOperacionAnuladaFiltrar() As Object

        ReadOnly Property FacOperacionAnuladaSeleccionado() As Object
