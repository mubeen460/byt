...
{
    class PresentadorAgregarNacional : PresentadorBase
    {
        private IAgregarNacional _ventana;
        ...
        public PresentadorAgregarNacional(IAgregarNacional ventana)
        {
            try
            {
                ...
                this._ventana.Nacional = new Nacional();
            }
            catch (Exception ex)
            {
        ...
        public void CargarPagina()
        {
            ...
            try
            {
                ...
                this.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.titleAgregarNacional,
                    Recursos.Ids.AgregarNacional);
        ...
        /// <summary>
        /// Método que agrega un Nacional
        /// </summary>
        public void AgregarNacional()
        {
            try
            {
                #region trace
                ...
                {
                    this.Navegar(Recursos.MensajesConElUsuario.NacionalInsertado,false);
                }
