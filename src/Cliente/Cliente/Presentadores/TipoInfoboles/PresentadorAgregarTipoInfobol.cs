...
{
    class PresentadorAgregarTipoInfobol : PresentadorBase
    {
        private IAgregarTipoInfobol _ventana;
        ...
        public PresentadorAgregarTipoInfobol(IAgregarTipoInfobol ventana)
        {
            try
            {
                ...
                this._ventana.TipoInfobol = new TipoInfobol();
            }
            catch (Exception ex)
            {
        ...
        public void CargarPagina()
        {
            ...
            try
            {
                ...
                this.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.titleAgregarTipoInfobol,
                    Recursos.Ids.AgregarTipoInfobol);
        ...
        /// <summary>
        /// Método que agrega un TipoInfobol
        /// </summary>
