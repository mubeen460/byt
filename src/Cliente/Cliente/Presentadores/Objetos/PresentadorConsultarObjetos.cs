...
{
    class PresentadorConsultarObjetos : PresentadorBase
    {
        private IConsultarObjetos _ventana;
        ...
        public PresentadorConsultarObjetos(IConsultarObjetos ventana)
        {
            try
            {
        ...
        public void Consultar()
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(this._ventana.Descripcion))
                {
                    objetosFiltrados = from objeto in objetosFiltrados
                                       where objeto.Descripcion != null &&
                                       objeto.Descripcion.ToLower().Contains(this._ventana.Descripcion.ToLower())
                                       select objeto;
                }
        ...
        /// <summary>
        /// Método que invoca una nueva página "ConsultarObjeto" y la instancia con el objeto seleccionado
        /// </summary>
        public void IrConsultarObjeto()
        {
            #region trace
            if (ConfigurationManager.AppSettings["ambiente"].ToString().Equals("desarrollo"))
                logger.Debug("Entrando al metodo {0}", (new System.Diagnostics.StackFrame()).GetMethod().Name);
            ...
            if (this._ventana.ObjetoSeleccionado != null)
                this.Navegar(new ConsultarObjeto(this._ventana.ObjetoSeleccionado));
