...
namespace Trascend.Bolet.Cliente.Presentadores.EscritosMarca
{
    class PresentadorReingresoDeDistingue : PresentadorBase
    {
        ...
        public void CargarPagina()
        {
            ...
            try
            {
                this.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.titleEscritoReingresoDeDistingue,
                    "");
        ...
        public string GenerarString()
        {
            ...
            if (null != this._ventana.DetalleDistingue)
                StringLlleno += ((ListaDatosValores)this._ventana.DetalleDistingue).Valor + "  ";
        ...
        /// <summary>
        /// Método que arma el string y hace el llamado para generar el escrito
        /// </summary>
        public void Aceptar()
        {                        
            try
                ...
                if (ValidarEscrito())
                {
                    string parametroMarcas = ArmarStringParametroMarcas(this._marcasAgregadas);
                                this.EjecutarArchivoBAT(ConfigurationManager.AppSettings["RutaBatEscrito"].ToString()
                                 ...
                                 +" "+((ListaDatosValores)this._ventana.DetalleDistingue).Valor
