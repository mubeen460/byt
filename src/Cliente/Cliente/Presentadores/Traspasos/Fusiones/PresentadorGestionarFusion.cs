...
namespace Trascend.Bolet.Cliente.Presentadores.Traspasos.Fusiones
{
    class PresentadorGestionarFusion : PresentadorBase
    {
        ...
        /// </summary>
        /// <param name="ventana">página que satisface el contrato</param>
        public PresentadorGestionarFusion(IGestionarFusion ventana, object fusion, object ventanaPadre)
        {
            try
            {
                this._ventana = ventana;
        ...
        public void CargarPagina()
        {
            ...
            try
            {
                ...
                if (_agregar == false)
                {
                    ...
                    this._ventana.IdCadenaDeCambios = fusion.CadenaDeCambios.ToString();
        ...
        public Fusion CargarFusionDeLaPantalla()
        {
            ...
            {
                fusion.CadenaDeCambios = int.Parse(this._ventana.IdCadenaDeCambios);
            }
            else
                fusion.CadenaDeCambios = null;
