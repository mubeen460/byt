...
{
    class PresentadorConsignacionDeJuramento : PresentadorBase
    {
        private IConsignacionDeJuramento _ventana;
        ...
        public PresentadorConsignacionDeJuramento(IConsignacionDeJuramento ventana)
        {
            try
            {
        ...
        {           
            try
            {
                ...
                this.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.titleEscritoConsignacionDeJuramento,
                    "");
                CargarAgente();
                CargarPatente();
