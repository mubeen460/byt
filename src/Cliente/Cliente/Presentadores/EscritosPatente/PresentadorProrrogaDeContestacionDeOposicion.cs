...
{
    class PresentadorProrrogaDeContestacionDeOposicion : PresentadorBase
    {
        private IProrrogaDeContestacionDeOposicion _ventana;
        ...
        public PresentadorProrrogaDeContestacionDeOposicion(IProrrogaDeContestacionDeOposicion ventana)
        {
            try
            {
