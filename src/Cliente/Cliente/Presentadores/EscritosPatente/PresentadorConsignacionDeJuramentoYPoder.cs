...
{
    class PresentadorConsignacionDeJuramentoYPoder : PresentadorBase
    {
        private IConsignacionDeJuramentoYPoder _ventana;
        ...
        public PresentadorConsignacionDeJuramentoYPoder(IConsignacionDeJuramentoYPoder ventana)
        {
            try
            {
        ...
        {           
            try
            {
                ...
                this.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.titleEscritoConsignacionDeJuramentoYPoder,
                    "");
                CargarAgente();
                CargarPatente();
            ...
            try
            {
                ...
                if (ValidarEscrito())
                {
                    ...
                    this.EjecutarArchivoBAT(ConfigurationManager.AppSettings["RutaBatEscrito"].ToString()
                        + "\\" + ConfigurationManager.AppSettings["EscritoConsignacionDeJuramentoYPoder"].ToString(),
