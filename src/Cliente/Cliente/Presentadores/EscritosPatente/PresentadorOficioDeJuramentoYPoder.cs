...
{
    class PresentadorOficioDeJuramentoYPoder : PresentadorBase
    {
        private IOficioDeJuramentoYPoder _ventana;
        ...
        public PresentadorOficioDeJuramentoYPoder(IOficioDeJuramentoYPoder ventana)
        {
            try
            {
        ...
        {           
            try
            {
                ...
                this.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.titleEscritoOficioDeJuramentoYPoder,
                    "");
                CargarAgente();
                CargarPatente();
                CargaBoletines();
            ...
            try
            {
                ...
                if (ValidarEscrito())
                {
                    ...
                    this.EjecutarArchivoBAT(ConfigurationManager.AppSettings["RutaBatEscrito"].ToString()
                        + "\\" + ConfigurationManager.AppSettings["EscritoOficioDeJuramentoYPoder"].ToString(),
