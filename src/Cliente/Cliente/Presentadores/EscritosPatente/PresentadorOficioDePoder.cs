...
{
    class PresentadorOficioDePoder : PresentadorBase
    {
        private IOficioDePoder _ventana;
        ...
        public PresentadorOficioDePoder(IOficioDePoder ventana)
        {
            try
            {
        ...
        {           
            try
            {
                ...
                this.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.titleEscritoOficioDePoder,
                    "");
                CargarAgente();
                CargarPatente();
                CargaBoletines();
            ...
            try
            {
                ...
                if (ValidarEscrito())
                {
                    ...
                    this.EjecutarArchivoBAT(ConfigurationManager.AppSettings["RutaBatEscrito"].ToString()
                        + "\\" + ConfigurationManager.AppSettings["EscritoOficioDePoder"].ToString(),
