...
{
    class PresentadorConsignacionDePrioridadExtranjera : PresentadorBase
    {
        private IConsignacionDePrioridadExtranjera _ventana;
        ...
        public PresentadorConsignacionDePrioridadExtranjera(IConsignacionDePrioridadExtranjera ventana)
        {
            try
            {
        ...
        {           
            try
            {
                ...
                this.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.titleEscritoConsignacionDePrioridadExtranjera,
                    "");
                CargarAgente();
                CargarPatente();
                CargaTipoEscrito();
        ...
        private bool ValidarEscrito()
        {
            ...
            if ((this._ventana.AgenteFiltrado != null) && null != ((Agente)this._ventana.AgenteFiltrado).Id)
            {
                ...
                {
                    if ((ListaDatosValores)this._ventana.TipoEscrito != null)
                    {
        ...
        /// <summary>
        /// Método que carga los tipo escrito registrados
        /// </summary>
        private void CargaTipoEscrito()
        {
            #region trace
            if (ConfigurationManager.AppSettings["ambiente"].ToString().Equals("desarrollo"))
                logger.Debug("Entrando al metodo {0}", (new System.Diagnostics.StackFrame()).GetMethod().Name);
            ...
            IList<ListaDatosValores> tiposEscritos =
               this._listaDatosValoresServicios.ConsultarListaDatosValoresPorParametro(new ListaDatosValores(Recursos.Etiquetas.cbiConsignacionDePrioridadExtranjera));
            this._ventana.TiposEscrito = tiposEscritos;
