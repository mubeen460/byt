...
{
    class PresentadorGestionarArchivoDePatente : PresentadorBase
    {
        ...
        private IGestionarArchivoDePatente _ventana;
        ...
        public PresentadorGestionarArchivoDePatente(IGestionarArchivoDePatente ventana, object archivo, object patente, object ventanaPadre)
        {
            try
            {
                #region trace
        ...
        public void CargarPagina()
        {
            ...
            try
            {
                ...
                Patente patente = this._patente;
                Archivo archivo = this._archivo;

                //if (patente.CodigoPatenteInternacional != 0)
                //    this._ventana.AuxArchivo = patente.CodigoPatenteInternacional.ToString();
                //else
                //    this._ventana.AuxArchivo = "1";

                this._ventana.IdPatenteArchivo = patente.Id.ToString();


                //IList<TipoDocumento> documentos = this._tipoDocumentoServicios.ConsultarTodos();

                IList<TipoDocumento> documentos = this._tipoDocumentoServicios.ObtenerTipoDocumentoMarcaOPatente("P", "J");
                ...
                IList<ListaDatosValores> tipoDocumentos = this._listaDatosValoresServicios.
                    ConsultarListaDatosValoresPorParametro(new ListaDatosValores(Recursos.Etiquetas.cbiTipoDocumentoArchivoPatente));
                ...
                IList<TipoCaja> tiposDeCaja = this._tipoCajaServicios.ObtenerTipoCajaMarcaOPatente(Recursos.Etiquetas.filterArchivoTipoCajaPatentes);
        ...
        /// <summary>
        /// Metodo que guardar el Archivo de Patente, lo inserta como nuevo o lo modifica
        /// </summary>
                    ...
                    if ((archivo.Aux != null) && (!archivo.Aux.Equals("")))
                    {
                        if ((archivo.Documento != null) && (!((TipoDocumento)archivo.Documento).Id.Equals("NGN")))
                        {
                            if ((archivo.TipoDeDocumento != null) && (!archivo.TipoDeDocumento.Equals("")))
                            {
                                ...
                                //    this.Navegar("Archivo modificado con exito", false);
                                //}
                            }
                            else
                                this._ventana.Mensaje("El Archivo de la Patente debe tener un Tipo de Documento asignado", 0);
                        }
                        else
                            this._ventana.Mensaje("El Archivo de la Patente debe tener un Documento asignado", 0);
                    }
                    else
                        this._ventana.Mensaje("El archivo de la Patente debe tener un Codigo Internacional valido", 0);
                }
                else
                    this._ventana.Mensaje("El Archivo de la Patente debe tener como Id el codigo de la Patente", 0);
        ...
        {
            return ((Patente)this._patente).Id.ToString();
        }
