...
namespace Trascend.Bolet.Cliente.Presentadores.Patentes
{
    class PresentadorListaInfoBoles : PresentadorBase
    {
        ...
        public PresentadorListaInfoBoles(IListaInfoBoles ventana, object patente)
        {
            #region trace
        ...
        public void CargarPagina()
        {
            ...
            try
            {
                ...
                this._ventana.InfoBoles = ((Patente)this._patente).InfoBoles;
                this._ventana.TotalHits = ((Patente)this._patente).InfoBoles.Count.ToString();
        ...
        public void IrGestionarInfoBol(bool nuevo)
        {
            ...
            if (!nuevo)
            {
                ((InfoBolPatente)this._ventana.InfoBolSeleccionado).Patente = this._patente;
                this.Navegar(new GestionarInfoBol(this._ventana.InfoBolSeleccionado));
            }
            else
            {
                InfoBolPatente infoBol = new InfoBolPatente();
                infoBol.Patente = this._patente;
