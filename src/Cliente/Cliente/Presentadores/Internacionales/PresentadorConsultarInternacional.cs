...
{
    class PresentadorConsultarInternacional : PresentadorBase
    {
        private IConsultarInternacional _ventana;
        ...
        /// <param name="nacional">Internacional a mostrar</param>
        public PresentadorConsultarInternacional(IConsultarInternacional ventana, Internacional nacional)
        {
            try
            {
                this._ventana = ventana;
                this._ventana.Internacional = nacional;
        ...
        public void Eliminar()
        {
            try
            {
                ...
                if (this._internacionalServicios.Eliminar((Internacional)this._ventana.Internacional, UsuarioLogeado.Hash))
                {
                    _paginaPrincipal.MensajeUsuario = Recursos.MensajesConElUsuario.InternacionalEliminado;
