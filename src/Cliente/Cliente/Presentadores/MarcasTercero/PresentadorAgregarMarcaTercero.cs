...
{
    class PresentadorAgregarMarcaTercero : PresentadorBase
    {
        private static PaginaPrincipal _paginaPrincipal = PaginaPrincipal.ObtenerInstancia;
        private static Logger logger = LogManager.GetCurrentClassLogger();
        private IAgregarMarcaTercero _ventana;
        private bool _esMarcaTerceroDuplicada = false;
        ...
        public PresentadorAgregarMarcaTercero(IAgregarMarcaTercero ventana, object marcaTerceroDuplicada)
        {
            try
            {
                this._ventana = ventana;
                MarcaTercero marcaTercero;

                if (marcaTerceroDuplicada != null)
                {
                    marcaTercero = (MarcaTercero)marcaTerceroDuplicada;
                    _esMarcaTerceroDuplicada = true;
                }
                else
                {
                ...
                marcaTercero.Internacional = new Internacional();
                if (!_esMarcaTerceroDuplicada)
                    marcaTercero.Interesado = new Interesado();
        ...
        /// <summary>
        /// Método que se encarga de duplicar una marcaTercero ya existente
        /// </summary>
        public void CargarDatosDeMarcaTerceroDuplicada()
        {
            try
            {
                ...
                marcaTercero.CodigoInscripcion = "";
                marcaTercero.CodigoRegistro = "";
                this._ventana.TipoMarcaTerceroDatos = this.BuscarTipoMarca((IList<ListaDatosDominio>)this._ventana.TipoMarcaTerceroDatos, marcaTercero.Tipo);

                this._ventana.Agente = this.BuscarAgente((IList<Agente>)this._ventana.Agentes, marcaTercero.Agente);

                this._ventana.PaisSolicitud = this.BuscarPais((IList<Pais>)this._ventana.PaisesSolicitud, marcaTercero.Pais);

                this._ventana.StatusWeb = this.BuscarStatusWeb((IList<StatusWeb>)this._ventana.StatusWebs, marcaTercero.StatusWeb);
                ...
                this._ventana.Servicio = this.BuscarServicio((IList<Servicio>)this._ventana.Servicios, marcaTercero.Servicio);

                //this._ventana.BoletinConcesion = this.BuscarBoletin((IList<Boletin>)this._ventana.BoletinesConcesion, marcaTercero.BoletinConcesion);
                this._ventana.BoletinPublicacion = this.BuscarBoletin((IList<Boletin>)this._ventana.BoletinesPublicacion, marcaTercero.BoletinPublicacion);
                ...
                this._ventana.Sector = this.BuscarSector((IList<ListaDatosDominio>)this._ventana.Sectores, marcaTercero.Sector);
                this._ventana.TipoReproduccion = this.BuscarTipoReproduccion((IList<ListaDatosDominio>)this._ventana.TipoReproducciones, marcaTercero.Tipo);
        ...
        public void CargarPagina()
        {
            ...
            try
            {
                ...
                if (_esMarcaTerceroDuplicada)
                    CargarDatosDeMarcaTerceroDuplicada();
        ...
        /// <summary>
        /// Método que realiza toda la lógica para agregar la MarcaTercero dentro de la base de datos
        /// </summary>
        public void Aceptar()
        {
            try
            {
                ...
                if (exitoso)
                    this.Navegar(Recursos.MensajesConElUsuario.MarcaTerceroInsertada, false);
        ...
        public void CargarPoderes()
        {
            ...
            if (_esMarcaTerceroDuplicada)
            {
                ...
                this._ventana.PoderSolicitud = this.BuscarPoder(poderes, marcaTercero.Poder);
            }
