    ...
    public partial class GestionarCambioDeDomicilio : Page, IGestionarCambioDeDomicilio
    {
        ...
        public bool HabilitarCampos
        {
            set
            {
                ...
                _txtOtros.IsEnabled = value;
                _txtAnexo.IsEnabled = value;
                _txtComentario.IsEnabled = value;
                _txtReferencia.IsEnabled = value;
                _txtObservacion.IsEnabled = value;
                _txtBoletinPub.IsEnabled = value;
                _cbxAsientoLibros.IsEnabled = value;
        ...
        /// <param name="ventanaPadre">Ventana Padre de donde se llama esta ventana</param>
        public GestionarCambioDeDomicilio(object cambioDeDomicilio, object parametro, object ventanaPadre)
        {
            InitializeComponent();
            this._cargada = false;
            //this._presentador = new PresentadorGestionarCambioDeDomicilio(this, cambioDeDomicilio);
            this._presentador = new PresentadorGestionarCambioDeDomicilio(this, cambioDeDomicilio,ventanaPadre);
