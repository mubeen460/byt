...
namespace Trascend.Bolet.Cliente.Ventanas.Traspasos.CambiosDeDomicilio
{
    ...
    /// </summary>
    public partial class ConsultarCambiosDeDomicilio : Page, IConsultarCambiosDeDomicilio
    {
        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;
        private PresentadorConsultarCambiosDeDomicilio _presentador;
        private bool _cargada;

        #region IConsultarCambiosDeDomicilio
        ...
        /// </summary>
        public ConsultarCambiosDeDomicilio()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorConsultarCambiosDeDomicilio(this);
        }
        ...
        {
            this._presentador.IrConsultarCambioDeDomicilio();
        }
