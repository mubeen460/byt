...
namespace Trascend.Bolet.Cliente.Ventanas.EscritosPatente
{
    ...
    /// </summary>
    public partial class ProrrogaDeFondo : Page, IProrrogaDeFondo
    {
        private PresentadorProrrogaDeFondo _presentador;
        ...
        public ProrrogaDeFondo()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorProrrogaDeFondo(this);
        }
