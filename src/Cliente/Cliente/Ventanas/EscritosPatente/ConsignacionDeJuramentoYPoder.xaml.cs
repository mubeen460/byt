...
{
    /// <summary>
    /// Interaction logic for ConsignacionDeJuramentoYPoder.xaml
    /// </summary>
    public partial class ConsignacionDeJuramentoYPoder : Page, IConsignacionDeJuramentoYPoder
    {
        private PresentadorConsignacionDeJuramentoYPoder _presentador;
        private bool _cargada;

        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;

        #region IConsignacionDeJuramentoYPoder
        ...
        public ConsignacionDeJuramentoYPoder()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorConsignacionDeJuramentoYPoder(this);
        }
