...
namespace Trascend.Bolet.Cliente.Ventanas.EscritosPatente
{
    ...
    /// </summary>
    public partial class ConsignacionDeJuramento : Page, IConsignacionDeJuramento
    {
        private PresentadorConsignacionDeJuramento _presentador;
        private bool _cargada;

        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;

        #region IConsignacionDeJuramento
        ...
        public ConsignacionDeJuramento()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorConsignacionDeJuramento(this);
        }
