...
{
    /// <summary>
    /// Interaction logic for NumeracionDePoderPorMarca.xaml
    /// </summary>
    public partial class PrioridadExtranjera : Page, IPrioridadExtranjera
    {
        private PresentadorPrioridadExtranjera _presentador;
        private bool _cargada;

        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;

        #region IPrioridadExtranjera
        ...
        public object TipoDetallePrioridades
        {
            get { return this._cbxTipoDetallePrioridad.DataContext; }
            set { this._cbxTipoDetallePrioridad.DataContext = value; }
        }

        public object TipoDetallePrioridad
        {
            get { return this._cbxTipoDetallePrioridad.SelectedItem; }
            set { this._cbxTipoDetallePrioridad.SelectedItem = value; }
        }
        ...
        public PrioridadExtranjera()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorPrioridadExtranjera(this);
        }
