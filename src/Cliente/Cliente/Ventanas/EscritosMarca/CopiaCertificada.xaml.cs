...
{
    /// <summary>
    /// Interaction logic for CopiaCertificada.xaml
    /// </summary>
    public partial class CopiaCertificada : Page, ICopiaCertificada
    {
        private PresentadorCopiaCertificada _presentador;
        private bool _cargada;

        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;

        #region ICopiaCertificada
        ...
        public CopiaCertificada()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorCopiaCertificada(this);
        }
        ...
        public object TipoCopiasCertificadas
        {
            get { return this._cbxTipoCopiaCertificada.DataContext; }
            set { this._cbxTipoCopiaCertificada.DataContext = value; }
        }

        public object TipoCopiaCertificada
        {
            get { return this._cbxTipoCopiaCertificada.SelectedItem; }
            set { this._cbxTipoCopiaCertificada.SelectedItem = value; }
        }
    }
}
