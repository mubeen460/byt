...
{
    /// <summary>
    /// Interaction logic for DeDesistimiento.xaml
    /// </summary>
    public partial class DeDesistimiento : Page, IDeDesistimiento
    {
        private PresentadorDeDesistimiento _presentador;
        ...
        public DeDesistimiento()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorDeDesistimiento(this);
        }
