...
namespace Trascend.Bolet.Cliente.Ventanas.EscritosMarca
{
    ...
    /// </summary>
    public partial class NumeracionDePoderPorMarca : Page, INumeracionDePoderPorMarca
    {
        private PresentadorNumeracionDePoderPorMarca _presentador;
        private bool _cargada;

        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;

        #region ICambioDeTramitante
        ...
        public NumeracionDePoderPorMarca()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorNumeracionDePoderPorMarca(this);
        }
