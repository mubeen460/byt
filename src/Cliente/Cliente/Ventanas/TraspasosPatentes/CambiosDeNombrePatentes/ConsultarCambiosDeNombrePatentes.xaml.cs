...
namespace Trascend.Bolet.Cliente.Ventanas.TraspasosPatentes.CambiosDeNombrePatentes
{
    ...
    /// </summary>
    public partial class ConsultarCambiosDeNombrePatentes : Page, IConsultarCambiosDeNombrePatentes
    {
        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;
        private PresentadorConsultarCambiosDeNombrePatentes _presentador;
        private bool _cargada;

        #region IConsultarCambiosDeNombrePatentes
        ...
        /// </summary>
        public ConsultarCambiosDeNombrePatentes()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorConsultarCambiosDeNombrePatentes(this);
        }
        ...
        {
            this._presentador.IrConsultarCambioDeNombrePatentes();
        }
