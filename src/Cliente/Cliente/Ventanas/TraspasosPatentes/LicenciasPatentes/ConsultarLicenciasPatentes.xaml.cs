...
namespace Trascend.Bolet.Cliente.Ventanas.TraspasosPatentes.LicenciasPatentes
{
    ...
    /// </summary>
    public partial class ConsultarLicenciasPatentes : Page, IConsultarLicenciasPatentes
    {
        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;
        private PresentadorConsultarLicenciasPatentes _presentador;
        ...
        /// </summary>
        public ConsultarLicenciasPatentes()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorConsultarLicenciasPatentes(this);
        }
