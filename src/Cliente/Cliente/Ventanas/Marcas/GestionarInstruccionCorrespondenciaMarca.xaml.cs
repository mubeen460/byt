...
namespace Trascend.Bolet.Cliente.Ventanas.Marcas
{
    ...
    /// <summary>
    /// Lógica de interacción para GestionarInstruccionCorrespondenciaMarca.xaml
    /// </summary>
    public partial class GestionarInstruccionCorrespondenciaMarca : Page, IGestionarInstruccionCorrespondenciaMarca
    {

        private PresentadorGestionarInstruccionCorrespondenciaMarca _presentador;
        ...
        /// <param name="ventanaPadre">Vetnana que precede a esta ventana</param>
        public GestionarInstruccionCorrespondenciaMarca(object instruccionEnvioEmails, object instruccionEnvioOriginales, object marca, object ventanaPadre, object ventanaConsultarMarcas)
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorGestionarInstruccionCorrespondenciaMarca(this, instruccionEnvioEmails, instruccionEnvioOriginales, marca, ventanaPadre, ventanaConsultarMarcas);
        ...
        {
            //this._txtMensaje.Text = "Instruccion de Correspondencia modificada exitosamente.";
        }
        ...
        #region IGestionarInstruccionCorrespondenciaMarca
        ...
        #region Datos Instruccion de Correspondencia de Envio de Emails

        public object InstruccionCorrespondenciaEnvioEmail
        {
            get { return this._gridEnvioDeEmails.DataContext; }
            set { this._gridEnvioDeEmails.DataContext = value; }
        }

        public string IdInstruccionCorrespondenciaEnvioEmails
        {
        ...
        #region Datos Instruccion de Correspondencia de Envio de Originales

        public object InstruccionCorrespondenciaEnvioOriginales
        {
            get { return this._gridEnvioOriginales.DataContext; }
            set { this._gridEnvioOriginales.DataContext = value; }
        }

        public string IdInstruccionCorrespondenciaEnvioOriginales
        {
