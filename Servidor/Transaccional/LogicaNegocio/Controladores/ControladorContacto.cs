    ...
    public class ControladorContacto : ControladorBase
    {
        ...
        public static IList<Contacto> ConsultarTodos()
        {
            ...
            try
            {
                ...
                ComandoBase<IList<Contacto>> comando = FabricaComandosContacto.ObtenerComandoConsultarTodos();
                comando.Ejecutar();
        ...
        public static IList<Contacto> ConsultarContactosPorAsociado(Asociado asociado)
        {
            ...
            try
            {
                ...
                ComandoBase<IList<Contacto>> comando = FabricaComandosContacto.ObtenerComandoConsultarContactosPorAsociado(asociado);
                comando.Ejecutar();
                retorno = comando.Receptor.ObjetoAlmacenado;
        ...
        public static Contacto ConsultarPorId(Contacto contacto)
        {
            Contacto retorno;
            try
            {
                ...
                ComandoBase<Contacto> comando = FabricaComandosContacto.ObtenerComandoConsultarContactoPorId(contacto);
                comando.Ejecutar();
                retorno = comando.Receptor.ObjetoAlmacenado;
