...
{
    public class ComandoConsultarTodasTipoEmailAsociado : ComandoBase<IList<TipoEmailAsociado>>
    {
        ...
        public override void Ejecutar()
        {
            try
            {
                ...
                this.Receptor = new Receptor<IList<TipoEmailAsociado>>(dao.ObtenerTodos());
