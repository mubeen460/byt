...
{
    public class ComandoEliminarFusionPatente : ComandoBase<bool>
    {
        ...
        /// </summary>
        /// <param name="fusion">FusionPatente a eliminar</param>
        public ComandoEliminarFusionPatente(FusionPatente fusion)
        {
            this._fusion = fusion;
        }
