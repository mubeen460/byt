...
namespace Trascend.Bolet.Servicios.Implementacion
{
    public class CambioDeNombrePatenteServicios : MarshalByRefObject, ICambioDeNombrePatenteServicios
    {
        ...
        /// <returns>Lista de Entidades</returns>
        public IList<CambioDeNombrePatente> ConsultarPorOtroCampo(String campo, String tipoOrdenamiento)
        {
            throw new NotImplementedException();
        }
        //-------------------------------------------------------------
        ...
        public bool InsertarOModificar(CambioDeNombrePatente cambioDeNombre, int hash)
        {
            try
            {
                ...
                bool exitoso = ControladorCambioDeNombrePatente.InsertarOModificar(ref cambioDeNombre, hash);
        ...
        public int? InsertarOModificarCambioNombre(CambioDeNombrePatente cambioNombre, int hash)
        {
            try
            {
                #region trace
                ...
                bool exitoso = ControladorCambioDeNombrePatente.InsertarOModificar(ref cambioNombre, hash);
