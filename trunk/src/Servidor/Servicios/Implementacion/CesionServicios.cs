...
namespace Trascend.Bolet.Servicios.Implementacion
{
    public class CesionServicios : MarshalByRefObject, ICesionServicios
    {
        ...
        /// <returns>Lista de Entidades</returns>
        public IList<Cesion> ConsultarPorOtroCampo(String campo, String tipoOrdenamiento)
        {
            throw new NotImplementedException();
        }
        //-------------------------------------------------------------
        ...
        public bool InsertarOModificar(Cesion cesion, int hash)
        {
            try
            {
                ...
                bool exitoso = ControladorCesion.InsertarOModificar(ref cesion, hash);
        ...
        public int? InsertarOModificarCesion(Cesion cesion, int hash)
        {
            try
            {
                #region trace
