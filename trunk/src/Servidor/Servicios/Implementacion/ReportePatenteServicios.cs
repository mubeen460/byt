...
{
    public class ReportePatenteServicios : MarshalByRefObject, IReportePatenteServicios
    {
        ...
        public IList<ReportePatente> ConsultarTodos()
        {
        ...
        /// <returns></returns>
        public ReportePatente ConsultarPorId(ReportePatente entidad)
        {
            try
            {
                #region trace
                ...
                ReportePatente retorno = ControladorReportePatente.ConsultarPorId(entidad);
        ...
        /// <returns>Lista de Entidades</returns>
        public IList<ReportePatente> ConsultarPorOtroCampo(String campo, String tipoOrdenamiento)
        {
            throw new NotImplementedException();
        }
        //-------------------------------------------------------------
        ...
        public bool InsertarOModificar(ReportePatente entidad, int hash)
        {
            throw new NotImplementedException();
        }
        ...
        /// <returns>true en caso de ser exitoso, false en caso contrario</returns>
        public bool Eliminar(ReportePatente entidad, int hash)
        {
            throw new NotImplementedException();
        }
        ...
        /// <returns>True en caso de ser exitoso, false en caso contrario</returns>
        public bool VerificarExistencia(ReportePatente entidad)
        {
            throw new NotImplementedException();
        }
        ...
        /// <returns>ReportePatente que insertó</returns>
        public ReportePatente ImprimirProcedimiento(ParametroProcedimiento parametro)
        {
            ...
            try
            {
                ...
                retorno = ControladorReportePatente.EjecutarProcedimiento(parametro);
