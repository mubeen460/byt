...
namespace Trascend.Bolet.Servicios.Implementacion
{
    public class CambioPeticionarioPatenteServicios : MarshalByRefObject, ICambioPeticionarioPatenteServicios
    {
        ...
        /// <returns>Lista de Entidades</returns>
        public IList<CambioPeticionarioPatente> ConsultarPorOtroCampo(String campo, String tipoOrdenamiento)
        {
            throw new NotImplementedException();
        }
        //-------------------------------------------------------------
        ...
        public bool InsertarOModificar(CambioPeticionarioPatente cambioPeticionario, int hash)
        {
            try
            {
                ...
                bool exitoso = ControladorCambioPeticionarioPatente.InsertarOModificar(ref cambioPeticionario, hash);
        ...
        public int? InsertarOModificarCambioPeticionario(CambioPeticionarioPatente cambioPeticionario, int hash)
        {
            try
            {
                #region trace
