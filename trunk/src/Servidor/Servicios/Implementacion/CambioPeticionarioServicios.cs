...
namespace Trascend.Bolet.Servicios.Implementacion
{
    public class CambioPeticionarioServicios : MarshalByRefObject, ICambioPeticionarioServicios
    {
        ...
        /// <returns>Lista de Entidades</returns>
        public IList<CambioPeticionario> ConsultarPorOtroCampo(String campo, String tipoOrdenamiento)
        {
            throw new NotImplementedException();
        }
        //-------------------------------------------------------------
        ...
        public bool InsertarOModificar(CambioPeticionario cambioPeticionario, int hash)
        {
            try
            {
                ...
                bool exitoso = ControladorCambioPeticionario.InsertarOModificar(ref cambioPeticionario, hash);
        ...
        public int? InsertarOModificarCambioPeticionario(CambioPeticionario cambioPeticionario, int hash)
        {
            try
            {
                #region trace
