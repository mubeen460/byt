    ...
    public class ContactoServicios : MarshalByRefObject, IContactoServicios
    {
        ...
        public Contacto ConsultarPorId(Contacto contacto)
        {
            ...
            try
            {
                ...
                retorno = ControladorContacto.ConsultarPorId(contacto);
        ...
        /// <returns>Lista de Entidades</returns>
        public IList<Contacto> ConsultarPorOtroCampo(String campo, String tipoOrdenamiento)
        {
        ...
        public IList<Contacto> ConsultarContactosFiltro(Contacto contacto)
        {
            IList<Contacto> contactos;
            try
            {
                ...
                contactos = ControladorContacto.ConsultarContactosFiltro(contacto);
