...
namespace Trascend.Bolet.Servicios.Implementacion
{
    public class CorresponsalServicios : MarshalByRefObject, ICorresponsalServicios
    {
        ...
        /// <returns>Lista de Entidades</returns>
        public IList<Corresponsal> ConsultarPorOtroCampo(String campo, String tipoOrdenamiento)
        {
            throw new NotImplementedException();
        }
        //-------------------------------------------------------------
        ...
        public IList<Auditoria> AuditoriaPorFkyTabla(Auditoria auditoria)
        {
            try
            {
                ...
                IList<Auditoria> auditorias = ControladorCorresponsal.AuditoriaPorFkyTabla(auditoria);
