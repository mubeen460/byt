...
{
    public class ComandoVerificarExistenciaTipoInfoBol : ComandoBase<bool>
    {
        ...
        public ComandoVerificarExistenciaTipoInfoBol(TipoInfobol tipoInfobol)
        {
        ...
        public override void Ejecutar()
        {
            try
            {
                ...
                this.Receptor = new Receptor<bool>(dao.VerificarExistencia(this._tipoInfobol.Id));
