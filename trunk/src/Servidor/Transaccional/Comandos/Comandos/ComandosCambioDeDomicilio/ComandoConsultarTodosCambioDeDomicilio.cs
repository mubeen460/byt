...
{
    public class ComandoConsultarTodosCambioDeDomicilio : ComandoBase<IList<CambioDeDomicilio>>
    {
        ...
        public override void Ejecutar()
        {
            try
            {
                ...
                this.Receptor = new Receptor<IList<CambioDeDomicilio>>(dao.ObtenerTodos());
