...
{
    public class ComandoInsertarOModificarFusionPatente : ComandoBase<bool>
    {
        private static Logger logger = LogManager.GetCurrentClassLogger();
        FusionPatente _fusion;

        /// <summary>
        /// Constructor predeterminado
        /// </summary>
        /// <param name="usuario">Usuario a insertar o modificar</param>
        public ComandoInsertarOModificarFusionPatente(FusionPatente fusion)
        {
            this._fusion = fusion;
        }
