...
{
    class ComandoConsultarTodasInstruccionesDescuento : ComandoBase<IList<InstruccionDescuento>>
    {
        ...
        public override void Ejecutar()
        {
            try
            {
                ...
                this.Receptor = new Receptor<IList<InstruccionDescuento>>(dao.ObtenerTodos());
