...
{
    public class ComandoEliminarCasoBase : ComandoBase<bool>
    {
        ...
        public ComandoEliminarCasoBase(CasoBase casoBase)
        {
        ...
        public override void Ejecutar()
        {
            try
            {
                ...
                this.Receptor = new Receptor<bool>(dao.Eliminar(this._casoBase));
