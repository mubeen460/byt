...
{
    class ComandoConsultarTodosMaestrosDePlantilla : ComandoBase<IList<MaestroDePlantilla>> 
    {
        ...
        public override void Ejecutar()
        {
            try
            {
                ...
                this.Receptor = new Receptor<IList<MaestroDePlantilla>>(dao.ObtenerTodos());
