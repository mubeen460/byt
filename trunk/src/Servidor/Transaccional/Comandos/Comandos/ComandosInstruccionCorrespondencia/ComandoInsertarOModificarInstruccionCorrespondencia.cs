...
{
    class ComandoInsertarOModificarInstruccionCorrespondencia : ComandoBase<bool>
    {
        ...
        /// </summary>
        /// <param name="infoBol">Instruccion de Correspondencia a insertar o modificar</param>
        public ComandoInsertarOModificarInstruccionCorrespondencia(InstruccionCorrespondencia instruccion)
        {
