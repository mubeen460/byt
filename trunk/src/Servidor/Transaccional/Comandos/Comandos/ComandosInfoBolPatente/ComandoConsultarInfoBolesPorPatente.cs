...
{
    class ComandoConsultarInfoBolesPorPatente : ComandoBase<IList<InfoBolPatente>>
    {
        ...
        public override void Ejecutar()
        {
            try
            {
                ...
                this.Receptor = new Receptor<IList<InfoBolPatente>>(dao.ObtenerInfoBolesPorPatente(this._patente));
