...
{
    public class ControladorPais : ControladorBase
    {
        ...
        public static bool VerificarExistencia(Pais pais)
        {
            bool existe = false;
            try
            {
                ...
                ComandoBase<bool> comando = FabricaComandosPais.ObtenerComandoVerificarExistenciaPais(pais);
                comando.Ejecutar();
