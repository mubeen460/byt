...
{
    public class ControladorBoletin : ControladorBase
    {
        ...
        public static bool VerificarExistencia(Boletin boletin)
        {
            ...
            try
            {
                ...
                ComandoBase<bool> comando = FabricaComandosBoletin.ObtenerComandoVerificarExistenciaBoletin(boletin);
                comando.Ejecutar();
