...
Namespace Controladores
    Public Class ControladorBancoG
        ...
        ''' </summary>
        ''' <returns></returns>
        Public Shared Function ConsultarTodos() As IList(Of BancoG)
            ...
            Try
                ...
                End If
                '#End Region                
                Dim comando As ComandoBase(Of IList(Of BancoG)) = FabricaComandosBancoG.ObtenerComandoConsultarTodos()
                comando.Ejecutar()
        ...
        Public Shared Function InsertarOModificar(ByVal BancoG As BancoG, ByVal hash As Integer) As Boolean
            ...
            Try
                ...
                Dim comando As ComandoBase(Of Boolean) = FabricaComandosBancoG.ObtenerComandoInsertarOModificar(BancoG)
                comando.Ejecutar()
        ...
        Public Shared Function ConsultarPorId(ByVal BancoG As BancoG) As BancoG
            Dim retorno As BancoG
            ...
            Try
                ...
                Dim comando As ComandoBase(Of BancoG) = FabricaComandosBancoG.ObtenerComandoConsultarPorID(BancoG)
                comando.Ejecutar()
                retorno = comando.Receptor.ObjetoAlmacenado
        ...
        Public Shared Function Eliminar(ByVal BancoG As BancoG, ByVal hash As Integer) As Boolean
            Dim exitoso As Boolean = False
            Try
                '#Region "trace"
                If ConfigurationManager.AppSettings("Ambiente").ToString().Equals("Desarrollo") Then
                ...
                Dim comando As ComandoBase(Of Boolean) = FabricaComandosBancoG.ObtenerComandoEliminarBancoG(BancoG)
                comando.Ejecutar()
                exitoso = True
        ...
        Public Shared Function VerificarExistencia(ByVal BancoG As BancoG) As Boolean
            ...
            Try
                ...
                Dim comando As ComandoBase(Of Boolean) = FabricaComandosBancoG.ObtenerComandoVerificarExistenciaBancoG(BancoG)
                comando.Ejecutar()
