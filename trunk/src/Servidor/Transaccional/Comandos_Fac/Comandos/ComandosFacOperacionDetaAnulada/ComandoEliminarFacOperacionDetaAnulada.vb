...
Namespace Comandos.ComandosFacOperacionDetaAnulada
    Public Class ComandoEliminarFacOperacionDetaAnulada
        ...
        ''' </summary>
        ''' <param name="FacOperacionDetaAnulada">FacOperacionDetaAnulada a eliminar</param>
        ...
        Public Overrides Sub Ejecutar()
            Try
                ...
                Me.Receptor = New Receptor(Of Boolean)(dao.Eliminar(Me._FacOperacionDetaAnulada))
