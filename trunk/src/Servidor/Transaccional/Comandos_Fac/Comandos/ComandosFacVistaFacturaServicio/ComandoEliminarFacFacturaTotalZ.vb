...
Namespace Comandos.ComandosFacFacturaTotalZ
    Public Class ComandoEliminarFacFacturaTotalZ
        ...
        ''' </summary>
        ''' <param name="FacFacturaTotalZ">FacFacturaTotalZ a eliminar</param>
        ...
        Public Overrides Sub Ejecutar()
            Try
                ...
                Me.Receptor = New Receptor(Of Boolean)(dao.Eliminar(Me._FacFacturaTotalZ))
