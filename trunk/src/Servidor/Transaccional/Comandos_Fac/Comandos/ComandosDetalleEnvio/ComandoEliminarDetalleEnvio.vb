...
Namespace Comandos.ComandosDetalleEnvio
    Public Class ComandoEliminarDetalleEnvio
        ...
        ''' </summary>
        ''' <param name="DetalleEnvio">DetalleEnvio a eliminar</param>
        ...
        Public Overrides Sub Ejecutar()
            Try
                ...
                Me.Receptor = New Receptor(Of Boolean)(dao.Eliminar(Me._DetalleEnvio))
