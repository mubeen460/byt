...
Namespace Comandos.ComandosFacGestion
    Public Class ComandoEliminarFacGestion
        ...
        ''' </summary>
        ''' <param name="FacGestion">FacGestion a eliminar</param>
        ...
        Public Overrides Sub Ejecutar()
            Try
                ...
                Me.Receptor = New Receptor(Of Boolean)(dao.Eliminar(Me._FacGestion))
