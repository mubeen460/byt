...
Namespace Comandos.ComandosFacInternacionalAnulada
    Public Class ComandoVerificarExistenciaFacInternacionalAnulada
        ...
        Public Overrides Sub Ejecutar()
            Try
                ...
                Me.Receptor = New Receptor(Of Boolean)(dao.VerificarExistencia(Me._FacInternacionalAnulada.Id))
