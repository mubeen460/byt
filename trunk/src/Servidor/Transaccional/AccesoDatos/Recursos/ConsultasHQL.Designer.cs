...
namespace Trascend.Bolet.AccesoDatos.Recursos {
    ...
    public class ConsultasHQL {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Select m from Marca m left join fetch m.Asociado as asociado left join fetch m.Corresponsal as corresponsal left join fetch m.Servicio as servicio where m.Id = &apos;{0}&apos; order by m.Id.
        /// </summary>
