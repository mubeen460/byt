    ...
    public class DaoLicenciaNHibernate : DaoBaseNHibernate<Licencia, int>, IDaoLicencia
    {
        ...
        public IList<Licencia> ObtenerLicenciasFiltro(Licencia licencia)
        {
            ...
            try
            {
                ...
                if (null != licencia.CadenaDeCambios)
                {
                    if (variosFiltros)
                        filtro += " and ";
                    filtro += string.Format(Recursos.ConsultasHQL.FiltroObtenerLicenciaCadenaDeCambios, licencia.CadenaDeCambios);
                    variosFiltros = true;
                }
            ...
            catch (Exception ex)
            {
                ...
                throw new ApplicationException(Recursos.Errores.exObtenerLicenciaMarca);
            }
            finally
            {
                Session.Close();
