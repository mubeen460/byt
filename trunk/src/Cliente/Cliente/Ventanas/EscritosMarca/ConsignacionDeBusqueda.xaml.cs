...
namespace Trascend.Bolet.Cliente.Ventanas.EscritosMarca
{
    ...
    /// </summary>
    public partial class ConsignacionDeBusqueda : Page, IConsignacionDeBusqueda
    {
        private PresentadorConsignacionDeBusqueda _presentador;
        private bool _cargada;

        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;

        #region IConsignacionDeBusqueda
        ...
        public object MarcasBusqueda
        {
            get { return this._lstMarcasBusqueda.DataContext; }
            set { this._lstMarcasBusqueda.DataContext = value; }
        }

        public object MarcaBusquedaSeleccionada
        {
            get { return this._lstMarcasBusqueda.SelectedItem; }
            set { this._lstMarcasBusqueda.SelectedItem = value; }
        }

        public CheckBox ChkPalabra
        {
            get { return this._chkPalabra; }
            set { this._chkPalabra = value; }
        }

        public CheckBox ChkDiseño
        {
            get { return this._chkDiseño; }
            set { this._chkDiseño = value; }
        }

        public CheckBox ChkMixto
        {
            get { return this._chkMixto; }
            set { this._chkMixto = value; }
        }
        ...
        public ConsignacionDeBusqueda()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorConsignacionDeBusqueda(this);
        }
        ...
        private void _lstMarcas_MouseDoubleClick(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            this._presentador.LlenarMarcaBusqueda();
