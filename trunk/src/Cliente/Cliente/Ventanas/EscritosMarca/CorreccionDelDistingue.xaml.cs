...
{
    /// <summary>
    /// Interaction logic for CorreccionDelDistingue.xaml
    /// </summary>
    public partial class CorreccionDelDistingue : Page, ICorreccionDelDistingue
    {
        private PresentadorCorreccionDelDistingue _presentador;
        private bool _cargada;

        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;

        #region ICorreccionDelDistingue
        ...
        {
            get { return this._txtCorreccion.Text; }
            set { this._txtCorreccion.Text = value; }
        }
        ...
        public CorreccionDelDistingue()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorCorreccionDelDistingue(this);
        }
