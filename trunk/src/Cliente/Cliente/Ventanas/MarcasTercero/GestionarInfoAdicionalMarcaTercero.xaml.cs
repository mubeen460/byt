...
namespace Trascend.Bolet.Cliente.Ventanas.MarcasTercero
{
    ...
    /// </summary>
    public partial class GestionarInfoAdicionalMarcaTercero : Page, IGestionarInfoAdicionalMarcaTercero
    {
        private PresentadorGestionarInfoAdicionalMarcaTercero _presentador;
        ...
        public GestionarInfoAdicionalMarcaTercero(object marca)
        {
            InitializeComponent();
            this._cargada = false;
        ...
        public GestionarInfoAdicionalMarcaTercero(object marca, string tab)
            : this(marca)
        {
            this._tab = tab;
        }
