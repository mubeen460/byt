...
namespace Trascend.Bolet.Cliente.Ventanas.MarcasTercero
{
    ...
    /// </summary>
    public partial class ConsultarMarcasTercero : Page, IConsultarMarcasTercero
    {
        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;
        private PresentadorConsultarMarcasTercero _presentador;
        private bool _cargada;

        #region IConsultarMarcasTercero
        ...
        /// </summary>
        public ConsultarMarcasTercero()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorConsultarMarcasTercero(this);
        }
