...
{
    /// <summary>
    /// Interaction logic for AgregarMarcaTercero.xaml
    /// </summary>
    public partial class AgregarMarcaTercero : Page, IAgregarMarcaTercero
    {
        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;
        private PresentadorAgregarMarcaTercero _presentador;
        ...
        public AgregarMarcaTercero(object marcaTercero)
        {
            InitializeComponent();
            ...
            this._presentador = new PresentadorAgregarMarcaTercero(this,marcaTercero);
        }
