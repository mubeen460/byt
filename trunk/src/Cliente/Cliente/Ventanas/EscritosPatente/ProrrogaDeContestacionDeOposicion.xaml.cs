...
namespace Trascend.Bolet.Cliente.Ventanas.EscritosPatente
{
    ...
    /// </summary>
    public partial class ProrrogaDeContestacionDeOposicion : Page, IProrrogaDeContestacionDeOposicion
    {
        private PresentadorProrrogaDeContestacionDeOposicion _presentador;
        ...
        public ProrrogaDeContestacionDeOposicion()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorProrrogaDeContestacionDeOposicion(this);
        }
