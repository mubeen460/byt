...
{
    /// <summary>
    /// Interaction logic for ConsignacionDePrioridadExtranjera.xaml
    /// </summary>
    public partial class ConsignacionDePrioridadExtranjera : Page, IConsignacionDePrioridadExtranjera
    {
        private PresentadorConsignacionDePrioridadExtranjera _presentador;
        private bool _cargada;

        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;

        #region IConsignacionDePrioridadExtranjera
        ...
        public object TiposEscrito
        {
            get { return this._cbxTipoEscrito.DataContext; }
            set { this._cbxTipoEscrito.DataContext = value; }
        }

        public object TipoEscrito
        {
            get { return this._cbxTipoEscrito.SelectedItem; }
            set { this._cbxTipoEscrito.SelectedItem = value; }
        }
        ...
        public ConsignacionDePrioridadExtranjera()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorConsignacionDePrioridadExtranjera(this);
        }
