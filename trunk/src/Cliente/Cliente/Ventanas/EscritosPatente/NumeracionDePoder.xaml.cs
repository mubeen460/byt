...
{
    /// <summary>
    /// Interaction logic for NumeracionDePoder.xaml
    /// </summary>
    public partial class NumeracionDePoder : Page, INumeracionDePoder
    {
        private PresentadorNumeracionDePoder _presentador;
        private bool _cargada;

        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;

        #region INumeracionDePoder
        ...
        public NumeracionDePoder()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorNumeracionDePoder(this);
        }
