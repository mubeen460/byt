...
{
    /// <summary>
    /// Interaction logic for OficioDeJuramentoYPoder.xaml
    /// </summary>
    public partial class OficioDeJuramentoYPoder : Page, IOficioDeJuramentoYPoder
    {
        private PresentadorOficioDeJuramentoYPoder _presentador;
        private bool _cargada;

        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;

        #region IOficioDeJuramentoYPoder
        ...
        public OficioDeJuramentoYPoder()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorOficioDeJuramentoYPoder(this);
        }
