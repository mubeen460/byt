...
namespace Trascend.Bolet.Cliente.Ventanas.EscritosPatente
{
    ...
    /// </summary>
    public partial class ProrrogaDeForma : Page, IProrrogaDeForma
    {
        private PresentadorProrrogaDeForma _presentador;
        ...
        public ProrrogaDeForma()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorProrrogaDeForma(this);
        }
