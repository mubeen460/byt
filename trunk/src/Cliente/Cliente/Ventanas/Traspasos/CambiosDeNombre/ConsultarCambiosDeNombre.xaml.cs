...
namespace Trascend.Bolet.Cliente.Ventanas.Traspasos.CambiosDeNombre
{
    ...
    /// </summary>
    public partial class ConsultarCambiosDeNombre : Page, IConsultarCambiosDeNombre
    {
        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;
        private PresentadorConsultarCambiosDeNombre _presentador;
        private bool _cargada;

        #region IConsultarCambiosDeNombre
        ...
        /// </summary>
        public ConsultarCambiosDeNombre()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorConsultarCambiosDeNombre(this);
        }
        ...
        {
            this._presentador.IrConsultarCambioDeNombre();
        }
