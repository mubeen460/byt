...
namespace Trascend.Bolet.Cliente.Ventanas.Traspasos.CambiosPeticionario
{
    ...
    /// </summary>
    public partial class ConsultarCambiosPeticionario : Page, IConsultarCambiosDePeticionario
    {
        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;
        private PresentadorConsultarCambiosDePeticionario _presentador;
        ...
        /// </summary>
        public ConsultarCambiosPeticionario()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorConsultarCambiosDePeticionario(this);
        }
