...
{
    class PresentadorExamenDePatentabilidad : PresentadorBase
    {
        private IExamenDePatentabilidad _ventana;
        ...
        public PresentadorExamenDePatentabilidad(IExamenDePatentabilidad ventana)
        {
            try
            {
        ...
        {           
            try
            {
                ...
                this.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.titleEscritoExamenDePatentabilidad,
                    "");
                CargarAgente();
                CargarPatente();
