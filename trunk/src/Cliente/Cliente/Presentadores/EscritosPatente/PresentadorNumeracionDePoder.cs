...
{
    class PresentadorNumeracionDePoder : PresentadorBase
    {
        private INumeracionDePoder _ventana;
        ...
        public PresentadorNumeracionDePoder(INumeracionDePoder ventana)
        {
            try
            {
        ...
        {           
            try
            {
                ...
                this.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.titleEscritoNumeracionDePoder,
                    "");
                CargarAgente();
                CargarPatente();
            ...
            try
            {
                ...
                if (ValidarEscrito())
                {
                    ...
                    this.EjecutarArchivoBAT(ConfigurationManager.AppSettings["RutaBatEscrito"].ToString()
                        + "\\" + ConfigurationManager.AppSettings["EscritoNumeracionDePoder"].ToString(),
