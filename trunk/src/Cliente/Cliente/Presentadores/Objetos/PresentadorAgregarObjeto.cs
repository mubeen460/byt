...
{
    class PresentadorAgregarObjeto : PresentadorBase
    {
        private IAgregarObjeto _ventana;
        ...
        /// <param name="objeto">Objeto a mostrar</param>
        public PresentadorAgregarObjeto(IAgregarObjeto ventana)
        {
            try
            {
                ...
                this._ventana.Objeto = new Objeto();
            }
            catch (Exception ex)
            {
        ...
        public void CargarPagina()
        {
            ...
            try
            {
                ...
                this.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.titleAgregarObjeto,
                    Recursos.Ids.AgregarObjeto);
