...
namespace Trascend.Bolet.Cliente.Presentadores.Anexos
{
    class PresentadorAgregarAnexo : PresentadorBase
    {
        ...
        public PresentadorAgregarAnexo(IAgregarAnexo ventana)
        {
            try
            {
        ...
        public void AgregarAnexo()
        {
            try
            {
                ...
                if (!this._anexoServicios.VerificarExistencia((Anexo)this._ventana.Anexo))
                {

                    if (this._anexoServicios.InsertarOModificar((Anexo)this._ventana.Anexo, UsuarioLogeado.Hash))
                    {
                        this.Navegar(Recursos.MensajesConElUsuario.AnexoInsertado, false);
                    }
                }
                else
                {
