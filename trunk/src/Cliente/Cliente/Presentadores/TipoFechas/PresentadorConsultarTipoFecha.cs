...
{
    class PresentadorConsultarTipoFecha : PresentadorBase
    {
        private IConsultarTipoFecha _ventana;
        ...
        /// <param name="nacional">TipoFecha a mostrar</param>
        public PresentadorConsultarTipoFecha(IConsultarTipoFecha ventana, TipoFecha nacional)
        {
            try
            {
                this._ventana = ventana;
                this._ventana.TipoFecha = nacional;
        ...
        public void Eliminar()
        {
            try
            {
                ...
                if (this._tipoFechaServicios.Eliminar((TipoFecha)this._ventana.TipoFecha, UsuarioLogeado.Hash))
                {
                    _paginaPrincipal.MensajeUsuario = Recursos.MensajesConElUsuario.TipoFechaEliminado;
