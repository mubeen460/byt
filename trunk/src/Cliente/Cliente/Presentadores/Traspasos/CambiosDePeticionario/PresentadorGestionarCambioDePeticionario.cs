...
namespace Trascend.Bolet.Cliente.Presentadores.Traspasos.CambiosDePeticionario
{
    class PresentadorGestionarCambioDePeticionario : PresentadorBase
    {
            ...
            try
            {
                ...
                else if (this._ventana.TextoBotonModificar == Recursos.Etiquetas.btnAceptar)
                {
                    ...
                    if ((exitoso) && (this._agregar == false))
                        ...
                        this.Navegar(Recursos.MensajesConElUsuario.CambioPeticionarioInsertado, false);
                }
        ...
        //            new ParametroProcedimiento(((Cesion)this._ventana.CambioPeticionario).Id, UsuarioLogeado, 1, paqueteProcedimiento, procedimiento);
