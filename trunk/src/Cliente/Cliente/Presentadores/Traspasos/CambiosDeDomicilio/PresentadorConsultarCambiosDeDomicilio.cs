...
{
    class PresentadorConsultarCambiosDeDomicilio : PresentadorBase
    {
        private static PaginaPrincipal _paginaPrincipal = PaginaPrincipal.ObtenerInstancia;
        private static Logger logger = LogManager.GetCurrentClassLogger();

        private IConsultarCambiosDeDomicilio _ventana;
        private IMarcaServicios _marcaServicios;
        private IAsociadoServicios _asociadoServicios;
        private IInteresadoServicios _interesadoServicios;
        private ICambioDeDomicilioServicios _cambioDeDomicilioServicios;

        private IList<CambioDeDomicilio> _cambiosDeDomicilio;
        ...
        public PresentadorConsultarCambiosDeDomicilio(IConsultarCambiosDeDomicilio ventana)
        {
            try
            {
        ...
        public void Consultar()
        {
            try
            {
                ...
                CambioDeDomicilio CambioDeDomicilioAuxiliar = new CambioDeDomicilio();
                ...
                {
                    CambioDeDomicilioAuxiliar.Marca = (Marca)this._ventana.Marca;
                    filtroValido = 2;
                }
        ...
        /// </summary>
        public void IrConsultarCambioDeDomicilio()
        {
            #region trace
            if (ConfigurationManager.AppSettings["ambiente"].ToString().Equals("desarrollo"))
                logger.Debug("Entrando al metodo {0}", (new System.Diagnostics.StackFrame()).GetMethod().Name);
