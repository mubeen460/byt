...
namespace Trascend.Bolet.Cliente.Presentadores.TraspasosPatentes.FusionesPatentes
{
    class PresentadorGestionarFusionPatentes : PresentadorBase
    {
        ...
        /// </summary>
        /// <param name="ventana">página que satisface el contrato</param>
        public PresentadorGestionarFusionPatentes(IGestionarFusionPatentes ventana, object fusion, object ventanaPadre)
        {
            try
            {
                this._ventana = ventana;
        ...
        public void LlenarListasPoderes(FusionPatente fusion)
        {
            ...
            if (fusion.Agente != null)
                //this._poderesApoderado = this._poderServicios.ObtenerPoderesEntreAgenteEInteresado(fusion.Agente, fusion.InteresadoEntre);
        ...
        public bool ValidarListaDePoderes(IList<Poder> listaPoderesA, IList<Poder> listaPoderesB)
        {
            ...
            else
            {
                ...
                {
                    //Hago una lista con los poderes que tiene el interesado
                    Poder poderExistente = (Poder)this._ventana.PoderFiltrado;
                    listaIntereseccionInteresado.Add(poderExistente);
                }
                else
                {
                    //Hago una lista con los poderes que tiene el interesado
