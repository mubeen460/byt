...
{
    class PresentadorGestionarInstruccionCorrespondenciaMarca : PresentadorBase
    {
        
        private static PaginaPrincipal _paginaPrincipal = PaginaPrincipal.ObtenerInstancia;
        private static Logger logger = LogManager.GetCurrentClassLogger();
        private IGestionarInstruccionCorrespondenciaMarca _ventana;
        ...
        public PresentadorGestionarInstruccionCorrespondenciaMarca (IGestionarInstruccionCorrespondenciaMarca ventana, 
                                                                    ...
                                                                    object ventanaConsultarMarcas)
        {
            try
            {
                ...
                this._ventana.InstruccionCorrespondenciaEnvioEmail = (InstruccionCorrespondencia)instruccionEnvioEmails;
                this._ventana.InstruccionCorrespondenciaEnvioOriginales = (InstruccionEnvioOriginales)instruccionEnvioOriginales;
        ...
        private void CargarDatosInstruccionEnvioOriginales()
        {
            try
            {
                ...
                Asociado asociadoEO = ((InstruccionEnvioOriginales)this._ventana.InstruccionCorrespondenciaEnvioOriginales).Asociado;
                Interesado interesadoEO = ((InstruccionEnvioOriginales)this._ventana.InstruccionCorrespondenciaEnvioOriginales).Interesado;
        ...
        private void CargarDatosInstruccionEnvioEmails()
        {
            ...
            try
            {
                ...
                InstruccionCorrespondencia instruccion = (InstruccionCorrespondencia)this._ventana.InstruccionCorrespondenciaEnvioEmail;
            ...
            try
            {
                ...
                if (botonPresionado.Equals("_btnModificar"))
                {
                    ...
                    if ((instruccion.TipoInstruccion != null) && (!instruccion.TipoInstruccion.Equals("")))
                    {
                        ...
                        if (exitoso)
                            this._ventana.Mensaje("La instruccion de Correspondencia de Envio de Email fue guardada exitosamente", 1);

                    }
                    else
                        this._ventana.Mensaje("La Instruccion por Correspondencia de Envio de Email debe tener un Tipo", 0);
                }
        ...
        private InstruccionEnvioOriginales CargarInstruccionEnvioOriginalesDeLaPantalla()
        {
            ...
            try
            {
                instruccion.Id = ((InstruccionEnvioOriginales)this._ventana.InstruccionCorrespondenciaEnvioOriginales).Id;
        ...
        private InstruccionCorrespondencia CargarInstruccionDeCorrespondenciaDeLaPantalla()
        {
            ...
            try
            {
                instruccion.Id = ((InstruccionCorrespondencia)this._ventana.InstruccionCorrespondenciaEnvioEmail).Id;

                instruccion.AplicadaA = ((InstruccionCorrespondencia)this._ventana.InstruccionCorrespondenciaEnvioEmail).AplicadaA;

                instruccion.Concepto = ((InstruccionCorrespondencia)this._ventana.InstruccionCorrespondenciaEnvioEmail).Concepto;
