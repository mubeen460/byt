    ...
    class PresentadorConsultarCategoria : PresentadorBase
    {
        ...
        public void CargarPagina()
        {
            ...
            try
            {
                ...
                this.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.titleConsultarCategoria,"");
        ...
        public void Modificar()
        {
            try
            {
                ...
                else
                {
                    ...
                    if (this._categoriaServicios.InsertarOModificar(categoria, UsuarioLogeado.Hash))
                    {
                        _paginaPrincipal.MensajeUsuario = Recursos.MensajesConElUsuario.CategoriaModificado;
        ...
        public void Eliminar()
        {
            try
            {
                ...
                if (this._categoriaServicios.Eliminar((Categoria)this._ventana.Categoria, UsuarioLogeado.Hash))
                {
                    _paginaPrincipal.MensajeUsuario = Recursos.MensajesConElUsuario.CategoriaEliminado;
                    this.Navegar(_paginaPrincipal);
                }
