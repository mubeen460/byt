...
{
    class PresentadorConsultarPais : PresentadorBase
    {

        private IConsultarPais _ventana;
        ...
        /// <param name="pais">Pais a mostrar</param>
        public PresentadorConsultarPais(IConsultarPais ventana, object pais)
        {
            try
            {
