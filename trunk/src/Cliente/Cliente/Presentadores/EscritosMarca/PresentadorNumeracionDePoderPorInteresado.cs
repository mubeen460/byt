...
namespace Trascend.Bolet.Cliente.Presentadores.EscritosMarca
{
    class PresentadorNumeracionDePoderPorInteresado : PresentadorBase
    {
        ...
        public string GenerarString()
        {
            ...
            string parametroInteresados = "";
            if (this._interesadosAgregados.Count != 0)
            {
                parametroInteresados = ArmarStringParametroInteresados(this._interesadosAgregados);
            }

            string StringLlleno = "";
            if (null != ((Agente)this._ventana.Agente))
                StringLlleno += ((Agente)this._ventana.Agente).Id + "  ";
            this._ventana.String = StringLlleno + "  " + parametroInteresados;
