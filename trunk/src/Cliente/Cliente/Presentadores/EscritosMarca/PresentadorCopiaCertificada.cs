...
namespace Trascend.Bolet.Cliente.Presentadores.EscritosMarca
{
    class PresentadorCopiaCertificada : PresentadorBase
    {
        ...
        public PresentadorCopiaCertificada(ICopiaCertificada ventana)
        {
            try
            {
        ...
        public void CargarPagina()
        {
            try
            {
                ...
                CargarTipoCopiaCertificada();

                this.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.titleEscritoCopiaCertificada,
                    "");
                CargarAgente();
                CargarMarca();
        ...
        /// </summary>
        private void CargarTipoCopiaCertificada()
        {


            ListaDatosValores filtro = new ListaDatosValores(Recursos.Etiquetas.cbiTipoCopiaCertificada);
            _listaRecordatorios =
                this._listaDatosValoresServicios.ConsultarListaDatosValoresPorParametro(filtro);
            this._ventana.TipoCopiasCertificadas = _listaRecordatorios;
            this._ventana.TipoCopiaCertificada = _listaRecordatorios[0];
            //this._ventana.TipoCopiaCertificada = this.BuscarRecordatorio(_listaRecordatorios, _listaRecordatorios.ElementAt(0));
        }
            ...
            try
            {
                if (ValidarEscrito())
                {
                    ...
                    this.EjecutarArchivoBAT(ConfigurationManager.AppSettings["RutaBatEscrito"].ToString()
                        ...
                        ((Agente)this._ventana.AgenteFiltrado).Id + " " + parametroMarcas +" "+ ((ListaDatosValores)this._ventana.TipoCopiaCertificada).Valor);
                }
            }
            catch (ApplicationException ex)
            {
