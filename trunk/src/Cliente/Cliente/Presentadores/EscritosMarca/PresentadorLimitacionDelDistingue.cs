...
{
    class PresentadorLimitacionDelDistingue : PresentadorBase
    {
        private ILimitacionDelDistingue _ventana;
        ...
        public PresentadorLimitacionDelDistingue(ILimitacionDelDistingue ventana)
        {
            try
            {
        ...
        public void CargarPagina()
        {
            ...
            try
            {
                this.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.titleEscritoLimitacionDelDistingue,
                    "");
                CargarAgente();
                CargarMarca();
