...
namespace Trascend.Bolet.Cliente.Presentadores.Boletines
{
    class PresentadorConsultarBoletin : PresentadorBase
    {
        ...
        /// <param name="boletin">Boletin a mostrar</param>
        public PresentadorConsultarBoletin(IConsultarBoletin ventana, Boletin boletin)
        {
            try
            {
                #region trace
            ...
            try
            {
                ...
                else
                {
                    if (this._boletinServicios.InsertarOModificar((Boletin)this._ventana.Boletin, UsuarioLogeado.Hash))
                    {
                        ...
                        paginaPrincipal.MensajeUsuario = Recursos.MensajesConElUsuario.BoletinModificado;
        ...
        public void Eliminar()
        {
            try
            {
                ...
                if (this._boletinServicios.Eliminar((Boletin)this._ventana.Boletin, UsuarioLogeado.Hash))
                {
                    _paginaPrincipal.MensajeUsuario = Recursos.MensajesConElUsuario.BoletinEliminado;
