...
{
    class PresentadorAgregarUsuario : PresentadorBase
    {
        private IAgregarUsuario _ventana;
        ...
        public PresentadorAgregarUsuario(IAgregarUsuario ventana)
        {
            try
            {
                this._ventana = ventana;
                this._ventana.Usuario = new Usuario();
