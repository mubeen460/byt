...
Namespace Ventanas.FacOperacionDetaProformas
    ...
    ''' </summary>
    Partial Public Class ConsultarFacOperacionDetaProformas
        Inherits Page
        Implements IConsultarFacOperacionDetaProformas


        Private _CurSortCol As GridViewColumnHeader = Nothing
        Private _CurAdorner As SortAdorner = Nothing
        Private _presentador As PresentadorConsultarFacOperacionDetaProformas
...
#Region "IConsultarFacOperacionDetaProformaes"
        ...
        Public Property FacOperacionDetaProformaFiltrar() As Object Implements Contratos.FacOperacionDetaProformas.IConsultarFacOperacionDetaProformas.FacOperacionDetaProformaFiltrar
            Get
        ...
        Public ReadOnly Property FacOperacionDetaProformaSeleccionado() As Object Implements Contratos.FacOperacionDetaProformas.IConsultarFacOperacionDetaProformas.FacOperacionDetaProformaSeleccionado
            Get
        ...
        Public Property Resultados() As Object Implements Contratos.FacOperacionDetaProformas.IConsultarFacOperacionDetaProformas.Resultados
            Get
        ...
        'Public Property Id() As Integer Implements Contratos.FacOperacionDetaProformas.IConsultarFacOperacionDetaProformas.Id
        '    Get
        ...
        Public Property CurSortCol() As System.Windows.Controls.GridViewColumnHeader Implements Contratos.FacOperacionDetaProformas.IConsultarFacOperacionDetaProformas.CurSortCol
            Get
                Return _CurSortCol
            End Get
        ...
        Public Property CurAdorner() As SortAdorner Implements Contratos.FacOperacionDetaProformas.IConsultarFacOperacionDetaProformas.CurAdorner
            Get
                Return _CurAdorner
            End Get
        ...
        Public Property ListaResultados() As System.Windows.Controls.ListView Implements Contratos.FacOperacionDetaProformas.IConsultarFacOperacionDetaProformas.ListaResultados
            Get
...
#End Region
        ...
        Public Sub New()
            ...
            Me._presentador = New PresentadorConsultarFacOperacionDetaProformas(Me)
        End Sub
        ...
        Private Sub _lstResultados_MouseDoubleClick(ByVal sender As Object, ByVal e As MouseButtonEventArgs)
            Me._presentador.IrConsultarFacOperacionDetaProforma()
        End Sub
        ...
        Public Property Asociado As Object Implements Contratos.FacOperacionDetaProformas.IConsultarFacOperacionDetaProformas.Asociado
        ...
        Public Property Asociados As Object Implements Contratos.FacOperacionDetaProformas.IConsultarFacOperacionDetaProformas.Asociados
            Get
        ...
        Public Property Banco As Object Implements Contratos.FacOperacionDetaProformas.IConsultarFacOperacionDetaProformas.Banco
            Get
        ...
        Public Property Bancos As Object Implements Contratos.FacOperacionDetaProformas.IConsultarFacOperacionDetaProformas.Bancos
            Get
        ...
        Public Property Idioma As Object Implements Contratos.FacOperacionDetaProformas.IConsultarFacOperacionDetaProformas.Idioma
            Get
        ...
        Public Property Idiomas As Object Implements Contratos.FacOperacionDetaProformas.IConsultarFacOperacionDetaProformas.Idiomas
            Get
        ...
        Public Property Moneda As Object Implements Contratos.FacOperacionDetaProformas.IConsultarFacOperacionDetaProformas.Moneda
            Get
        ...
        Public Property Monedas As Object Implements Contratos.FacOperacionDetaProformas.IConsultarFacOperacionDetaProformas.Monedas
            Get
        ...
        End Sub
        Public Property NombreAsociado() As String Implements Contratos.FacOperacionDetaProformas.IConsultarFacOperacionDetaProformas.NombreAsociado
            Get
        ...
        Public Property idAsociadoFiltrar() As String Implements Contratos.FacOperacionDetaProformas.IConsultarFacOperacionDetaProformas.idAsociadoFiltrar
            Get
        ...
        Public Property NombreAsociadoFiltrar() As String Implements Contratos.FacOperacionDetaProformas.IConsultarFacOperacionDetaProformas.NombreAsociadoFiltrar
            Get
        ...
        Public ReadOnly Property FechaCobro() As String Implements Contratos.FacOperacionDetaProformas.IConsultarFacOperacionDetaProformas.FechaCobro
            Get
                Return Me._dpkFechaCobro.SelectedDate.ToString()
            End Get
        End Property

        Public ReadOnly Property Id() As String Implements Contratos.FacOperacionDetaProformas.IConsultarFacOperacionDetaProformas.Id
            Get
                Return Me._txtId.Text
            End Get
        End Property

        'Public ReadOnly Property CreditoSent As String Implements Contratos.FacOperacionDetaProformas.IConsultarFacOperacionDetaProformas.CreditoSent
        '    Get
