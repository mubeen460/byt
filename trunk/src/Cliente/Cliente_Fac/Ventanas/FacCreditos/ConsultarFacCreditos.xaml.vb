...
Namespace Ventanas.FacCreditos
    ...
    ''' </summary>
    Partial Public Class ConsultarFacCreditos
        Inherits Page
        Implements IConsultarFacCreditos

        Private _CurSortCol As GridViewColumnHeader = Nothing
        Private _CurAdorner As SortAdorner = Nothing
        Private _presentador As PresentadorConsultarFacCreditos
        Private _cargada As Boolean

#Region "IConsultarFacCreditoes"
        ...
        Public Property FacCreditoFiltrar() As Object Implements Contratos.FacCreditos.IConsultarFacCreditos.FacCreditoFiltrar
            Get
        ...
        Public ReadOnly Property FacCreditoSeleccionado() As Object Implements Contratos.FacCreditos.IConsultarFacCreditos.FacCreditoSeleccionado
            Get
        ...
        Public Property Resultados() As Object Implements Contratos.FacCreditos.IConsultarFacCreditos.Resultados
            Get
        ...
        'Public Property Id() As Integer Implements Contratos.FacCreditos.IConsultarFacCreditos.Id
        '    Get
        ...
        Public Property CurSortCol() As System.Windows.Controls.GridViewColumnHeader Implements Contratos.FacCreditos.IConsultarFacCreditos.CurSortCol
            Get
                Return _CurSortCol
            End Get
        ...
        Public Property CurAdorner() As SortAdorner Implements Contratos.FacCreditos.IConsultarFacCreditos.CurAdorner
            Get
                Return _CurAdorner
            End Get
        ...
        Public Property ListaResultados() As System.Windows.Controls.ListView Implements Contratos.FacCreditos.IConsultarFacCreditos.ListaResultados
            Get
...
#End Region
        ...
        Public Sub New()
            ...
            Me._presentador = New PresentadorConsultarFacCreditos(Me)
        End Sub
        ...
        Public Property Banco As Object Implements Contratos.FacCreditos.IConsultarFacCreditos.Banco
            Get
        ...
        Public Property Bancos As Object Implements Contratos.FacCreditos.IConsultarFacCreditos.Bancos
            Get
        ...
        Public Property Idioma As Object Implements Contratos.FacCreditos.IConsultarFacCreditos.Idioma
            Get
        ...
        Public Property Idiomas As Object Implements Contratos.FacCreditos.IConsultarFacCreditos.Idiomas
            Get
        ...
        Public Property Moneda As Object Implements Contratos.FacCreditos.IConsultarFacCreditos.Moneda
            Get
        ...
        Public Property Monedas As Object Implements Contratos.FacCreditos.IConsultarFacCreditos.Monedas
            Get
        ...
        Public ReadOnly Property FechaCredito() As String Implements Contratos.FacCreditos.IConsultarFacCreditos.FechaCredito
            Get
                Return Me._dpkFechaCredito.SelectedDate.ToString()
            End Get
        End Property

        Public ReadOnly Property Id() As String Implements Contratos.FacCreditos.IConsultarFacCreditos.Id
            Get
                Return Me._txtId.Text
            End Get
        End Property

        Public ReadOnly Property CreditoSent As String Implements Contratos.FacCreditos.IConsultarFacCreditos.CreditoSent
            Get
                Return Me._txtCreditoSent.Text
            End Get
        End Property

        Public Property Asociado As Object Implements Contratos.FacCreditos.IConsultarFacCreditos.Asociado
        ...
        Public Property Asociados As Object Implements Contratos.FacCreditos.IConsultarFacCreditos.Asociados
            Get
        ...
        Public Property NombreAsociado() As String Implements Contratos.FacCreditos.IConsultarFacCreditos.NombreAsociado
            Get
        ...
        Public Property idAsociadoFiltrar() As String Implements Contratos.FacCreditos.IConsultarFacCreditos.idAsociadoFiltrar
            Get
        ...
        Public Property NombreAsociadoFiltrar() As String Implements Contratos.FacCreditos.IConsultarFacCreditos.NombreAsociadoFiltrar
            Get
        ...
        Public WriteOnly Property Count As Integer Implements Contratos.FacCreditos.IConsultarFacCreditos.Count
