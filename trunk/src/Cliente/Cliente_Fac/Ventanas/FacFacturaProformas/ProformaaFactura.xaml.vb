...
Namespace Ventanas.FacFacturaProformas
    ...
    ''' </summary>
    Partial Public Class ProformaaFactura
        Inherits Page
        Implements IProformaaFactura

        Private _CurSortCol As GridViewColumnHeader = Nothing
        Private _CurAdorner As SortAdorner = Nothing
        Private _presentador As PresentadorProformaaFactura
        Private _cargada As Boolean

#Region "IProformaaFactura"
        ...
        Public Property FacFacturaProformaFiltrar() As Object Implements Contratos.FacFacturaProformas.IProformaaFactura.FacFacturaProformaFiltrar
            Get
        ...
        Public ReadOnly Property FacFacturaProformaSeleccionado() As Object Implements Contratos.FacFacturaProformas.IProformaaFactura.FacFacturaProformaSeleccionado
            Get
        ...
        Public Property Resultados() As Object Implements Contratos.FacFacturaProformas.IProformaaFactura.Resultados
            Get
        ...
        'Public Property Id() As Integer Implements Contratos.FacFacturaProformas.IProformaaFactura.Id
        '    Get
        ...
        Public Property CurSortCol() As System.Windows.Controls.GridViewColumnHeader Implements Contratos.FacFacturaProformas.IProformaaFactura.CurSortCol
            Get
                Return _CurSortCol
            End Get
        ...
        Public Property CurAdorner() As SortAdorner Implements Contratos.FacFacturaProformas.IProformaaFactura.CurAdorner
            Get
                Return _CurAdorner
            End Get
        ...
        Public Property ListaResultados() As System.Windows.Controls.ListView Implements Contratos.FacFacturaProformas.IProformaaFactura.ListaResultados
            Get
...
#End Region
        ...
        Public WriteOnly Property VerTipo As String Implements Contratos.FacFacturaProformas.IProformaaFactura.VerTipo
            Set(ByVal value As String)
                Select Case value
                    Case "1" 'para mostrar los datos a rellenar para rechazar
                        _GbBusqueda.Visibility = Windows.Visibility.Collapsed
                        _GbResultados.Visibility = Windows.Visibility.Collapsed
                        _GbTotales.Visibility = Windows.Visibility.Collapsed
                        _GbBotones.Visibility = Windows.Visibility.Collapsed
                        _GbRechazo.Visibility = Windows.Visibility.Visible
                        'Me._presentador.Rechazar()

                    Case "2" 'para mostrar los datos de busqueda y resultado
                        _GbBusqueda.Visibility = Windows.Visibility.Visible
                        _GbResultados.Visibility = Windows.Visibility.Visible
                        _GbTotales.Visibility = Windows.Visibility.Visible
                        _GbBotones.Visibility = Windows.Visibility.Visible
                        _GbRechazo.Visibility = Windows.Visibility.Collapsed
                End Select
            End Set
        End Property
        ...
        Public Property Asociado As Object Implements Contratos.FacFacturaProformas.IProformaaFactura.Asociado
            Get
        ...
        Public Property Asociados As Object Implements Contratos.FacFacturaProformas.IProformaaFactura.Asociados
            Get
        ...
        Private Sub _btnAplicarRechazo_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
            Me._presentador.Rechazar()
        End Sub

        Public Property Rechazar() As String Implements Contratos.FacFacturaProformas.IProformaaFactura.Rechazar
            Get
                Return Me._txtRechazar.Text
            End Get
            Set(ByVal value As String)
                Me._txtRechazar.Text = value
            End Set
        End Property
        ...
        Private Sub _btnPasarFactura_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
            Me._presentador.GenFactura()
        End Sub

        Private Sub _btnRechazarFactura_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
            If MessageBoxResult.Yes = MessageBox.Show("Esta Seguro de Rechazar", "Rechazar Proforma", MessageBoxButton.YesNo, MessageBoxImage.Question) Then
                Me._presentador.VerRechazo()
            End If
        End Sub
        'Public Property Banco As Object Implements Contratos.FacFacturaProformas.IProformaaFactura.Banco
        '    Get
        ...
        'Public Property Bancos As Object Implements Contratos.FacFacturaProformas.IProformaaFactura.Bancos
        '    Get
        ...
        'Public Property Idioma As Object Implements Contratos.FacFacturaProformas.IProformaaFactura.Idioma
        '    Get
        ...
        'Public Property Idiomas As Object Implements Contratos.FacFacturaProformas.IProformaaFactura.Idiomas
        '    Get
        ...
        'Public Property Moneda As Object Implements Contratos.FacFacturaProformas.IProformaaFactura.Moneda
        '    Get
        ...
        'Public Property Monedas As Object Implements Contratos.FacFacturaProformas.IProformaaFactura.Monedas
        '    Get
        ...
        Public Property NombreAsociado() As String Implements Contratos.FacFacturaProformas.IProformaaFactura.NombreAsociado
            Get
        ...
        Public Property idAsociadoFiltrar() As String Implements Contratos.FacFacturaProformas.IProformaaFactura.idAsociadoFiltrar
            Get
        ...
        Public Property NombreAsociadoFiltrar() As String Implements Contratos.FacFacturaProformas.IProformaaFactura.NombreAsociadoFiltrar
            Get
        ...
        Public WriteOnly Property Cba As Double Implements Contratos.FacFacturaProformas.IProformaaFactura.Cba
            Set(ByVal value As Double)
                Me._txtCba.Text = value
            End Set
        End Property

        Public WriteOnly Property Mba As Double Implements Contratos.FacFacturaProformas.IProformaaFactura.Mba
            Set(ByVal value As Double)
                Me._txtMba.Text = value
            End Set
        End Property

        Public WriteOnly Property Mda As Double Implements Contratos.FacFacturaProformas.IProformaaFactura.Mda
            Set(ByVal value As Double)
                Me._txtMda.Text = value
            End Set
        End Property

        'Public WriteOnly Property Cbr As Double Implements Contratos.FacFacturaProformas.IProformaaFactura.Cbr
        '    Set(ByVal value As Double)
        '        Me._txtCbr.Text = value
        '    End Set
        'End Property

        Public WriteOnly Property Cda As Double Implements Contratos.FacFacturaProformas.IProformaaFactura.Cda
            Set(ByVal value As Double)
                Me._txtCda.Text = value
            End Set
        End Property

        'Public WriteOnly Property Cdf As Double Implements Contratos.FacFacturaProformas.IProformaaFactura.Cdf
        '    Set(ByVal value As Double)
        '        Me._txtCdf.Text = value
        '    End Set
        'End Property

        'Public WriteOnly Property Cdp As Double Implements Contratos.FacFacturaProformas.IProformaaFactura.Cdp
        '    Set(ByVal value As Double)
        '        Me._txtCdp.Text = value
        '    End Set
        'End Property

        'Public WriteOnly Property Cdr As Double Implements Contratos.FacFacturaProformas.IProformaaFactura.Cdr
        '    Set(ByVal value As Double)
        '        Me._txtCdr.Text = value
        '    End Set
        'End Property

        Public WriteOnly Property Count As Integer Implements Contratos.FacFacturaProformas.IProformaaFactura.Count
