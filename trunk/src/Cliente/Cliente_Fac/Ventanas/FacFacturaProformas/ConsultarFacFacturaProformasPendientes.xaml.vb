...
Namespace Ventanas.FacFacturaProformas
    ...
    ''' </summary>
    Partial Public Class ConsultarFacFacturaProformasPendientes
        Inherits Page
        Implements IConsultarFacFacturaProformasPendientes

        Private _CurSortCol As GridViewColumnHeader = Nothing
        Private _CurAdorner As SortAdorner = Nothing
        Private _presentador As PresentadorConsultarFacFacturaProformasPendientes
        Private _cargada As Boolean

#Region "IConsultarFacFacturaProformasPendientes"
        ...
        Public Property FacFacturaProformaFiltrar() As Object Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.FacFacturaProformaFiltrar
            Get
        ...
        Public ReadOnly Property FacFacturaProformaSeleccionado() As Object Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.FacFacturaProformaSeleccionado
            Get
        ...
        Public Property Resultados() As Object Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.Resultados
            Get
        ...
        'Public Property Id() As Integer Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.Id
        '    Get
        ...
        Public Property CurSortCol() As System.Windows.Controls.GridViewColumnHeader Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.CurSortCol
            Get
                Return _CurSortCol
            End Get
        ...
        Public Property CurAdorner() As SortAdorner Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.CurAdorner
            Get
                Return _CurAdorner
            End Get
        ...
        Public Property ListaResultados() As System.Windows.Controls.ListView Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.ListaResultados
            Get
...
#End Region
        ...
        Public Sub New()
            ...
            Me._presentador = New PresentadorConsultarFacFacturaProformasPendientes(Me)
        End Sub
        ...
        Public Property Asociado As Object Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.Asociado
        ...
        Public Property Asociados As Object Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.Asociados
            Get
        ...
        Private Sub _btnConsultar(ByVal sender As Object, ByVal e As RoutedEventArgs)
            ...
            End If
        End Sub
        'Public Property Banco As Object Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.Banco
        '    Get
        ...
        'Public Property Bancos As Object Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.Bancos
        '    Get
        ...
        'Public Property Idioma As Object Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.Idioma
        '    Get
        ...
        'Public Property Idiomas As Object Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.Idiomas
        '    Get
        ...
        'Public Property Moneda As Object Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.Moneda
        '    Get
        ...
        'Public Property Monedas As Object Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.Monedas
        '    Get
        ...
        Public Property NombreAsociado() As String Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.NombreAsociado
            Get
        ...
        Public Property idAsociadoFiltrar() As String Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.idAsociadoFiltrar
            Get
        ...
        Public Property NombreAsociadoFiltrar() As String Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.NombreAsociadoFiltrar
            Get
        ...
        Public ReadOnly Property FechaFactura() As String Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.FechaFactura
            Get
                Return Me._dpkFechaFactura.SelectedDate.ToString()
            End Get
        End Property

        Public ReadOnly Property Id() As String Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.Id
            Get
                Return Me._txtId.Text
            End Get
        End Property

        'Public ReadOnly Property CreditoSent As String Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.CreditoSent
        '    Get
        ...
        'Public WriteOnly Property Cba As Double Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.Cba
        '    Set(ByVal value As Double)
        '        Me._txtCba.Text = value
        '    End Set
        'End Property

        'Public WriteOnly Property Cbf As Double Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.Cbf
        '    Set(ByVal value As Double)
        '        Me._txtCbf.Text = value
        '    End Set
        'End Property

        Public WriteOnly Property Cbp As Double Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.Cbp
            Set(ByVal value As Double)
                Me._txtCbp.Text = value
            End Set
        End Property

        Public WriteOnly Property Cbr As Double Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.Cbr
            Set(ByVal value As Double)
                Me._txtCbr.Text = value
            End Set
        End Property

        'Public WriteOnly Property Cda As Double Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.Cda
        '    Set(ByVal value As Double)
        '        Me._txtCda.Text = value
        '    End Set
        'End Property

        'Public WriteOnly Property Cdf As Double Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.Cdf
        '    Set(ByVal value As Double)
        '        Me._txtCdf.Text = value
        '    End Set
        'End Property

        Public WriteOnly Property Cdp As Double Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.Cdp
            Set(ByVal value As Double)
                Me._txtCdp.Text = value
            End Set
        End Property

        Public WriteOnly Property Cdr As Double Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.Cdr
            Set(ByVal value As Double)
                Me._txtCdr.Text = value
            End Set
        End Property

        Public WriteOnly Property Count As Integer Implements Contratos.FacFacturaProformas.IConsultarFacFacturaProformasPendientes.Count
