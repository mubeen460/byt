...
Namespace Ventanas.FacPagoBolivias
    ...
    ''' </summary>
    Partial Public Class ConsultarPagoFacPagoBolivias
        Inherits Page
        Implements IConsultarPagoFacPagoBolivias

        Dim value As Boolean = False
        Private _CurSortCol As GridViewColumnHeader = Nothing
        Private _CurAdorner As SortAdorner = Nothing
        Private _presentador As PresentadorConsultarPagoFacPagoBolivias
...
#Region "IConsultarFacPagoBoliviaes"
        ...
        Public Sub FocoPredeterminado() Implements IPaginaBaseFac.FocoPredeterminado
            Me._cbxBancoPag.Focus()
        End Sub

        Public Property FacPagoBoliviaFiltrar() As Object Implements Contratos.FacPagoBolivias.IConsultarPagoFacPagoBolivias.FacPagoBoliviaFiltrar
            Get
        ...
        Public ReadOnly Property FacPagoBoliviaSeleccionado() As Object Implements Contratos.FacPagoBolivias.IConsultarPagoFacPagoBolivias.FacPagoBoliviaSeleccionado
            Get
        ...
        Public Property Resultados() As Object Implements Contratos.FacPagoBolivias.IConsultarPagoFacPagoBolivias.Resultados
            Get
        ...
        'Public Property Id() As Integer Implements Contratos.FacPagoBolivias.IConsultarPagoFacPagoBolivias.Id
        '    Get
        ...
        Public Property CurSortCol() As System.Windows.Controls.GridViewColumnHeader Implements Contratos.FacPagoBolivias.IConsultarPagoFacPagoBolivias.CurSortCol
            Get
                Return _CurSortCol
            End Get
        ...
        Public Property CurAdorner() As SortAdorner Implements Contratos.FacPagoBolivias.IConsultarPagoFacPagoBolivias.CurAdorner
            Get
                Return _CurAdorner
            End Get
        ...
        Public Property ListaResultados() As System.Windows.Controls.ListView Implements Contratos.FacPagoBolivias.IConsultarPagoFacPagoBolivias.ListaResultados
            Get
...
#End Region
        ...
        Public Sub New()
            ...
            Me._presentador = New PresentadorConsultarPagoFacPagoBolivias(Me)
        End Sub
        ...
        Public Property BancoPag As Object Implements Contratos.FacPagoBolivias.IConsultarPagoFacPagoBolivias.BancoPag
            Get
        ...
        Public Property BancosPag As Object Implements Contratos.FacPagoBolivias.IConsultarPagoFacPagoBolivias.BancosPag
            Get
        ...
        Public ReadOnly Property FormaPago As Char Implements Contratos.FacPagoBolivias.IConsultarPagoFacPagoBolivias.FormaPago
            Get
        ...
        Public Property Asociado As Object Implements Contratos.FacPagoBolivias.IConsultarPagoFacPagoBolivias.Asociado
        ...
        Public Property Asociados As Object Implements Contratos.FacPagoBolivias.IConsultarPagoFacPagoBolivias.Asociados
            Get
        ...
        Public Property NombreAsociado() As String Implements Contratos.FacPagoBolivias.IConsultarPagoFacPagoBolivias.NombreAsociado
            Get
        ...
        Public Property idAsociadoFiltrar() As String Implements Contratos.FacPagoBolivias.IConsultarPagoFacPagoBolivias.idAsociadoFiltrar
            Get
        ...
        Public Property NombreAsociadoFiltrar() As String Implements Contratos.FacPagoBolivias.IConsultarPagoFacPagoBolivias.NombreAsociadoFiltrar
            Get
        ...
        Public WriteOnly Property Count As Integer Implements Contratos.FacPagoBolivias.IConsultarPagoFacPagoBolivias.Count
