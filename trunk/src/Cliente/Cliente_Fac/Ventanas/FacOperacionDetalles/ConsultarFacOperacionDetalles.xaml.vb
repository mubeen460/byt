...
Namespace Ventanas.FacOperacionDetalles
    ...
    ''' </summary>
    Partial Public Class ConsultarFacOperacionDetalles
        Inherits Page
        Implements IConsultarFacOperacionDetalles


        Private _CurSortCol As GridViewColumnHeader = Nothing
        Private _CurAdorner As SortAdorner = Nothing
        Private _presentador As PresentadorConsultarFacOperacionDetalles
        Private _cargada As Boolean

#Region "IConsultarFacOperacionDetallees"
        ...
        Public Property FacOperacionDetalleFiltrar() As Object Implements Contratos.FacOperacionDetalles.IConsultarFacOperacionDetalles.FacOperacionDetalleFiltrar
            Get
        ...
        Public ReadOnly Property FacOperacionDetalleSeleccionado() As Object Implements Contratos.FacOperacionDetalles.IConsultarFacOperacionDetalles.FacOperacionDetalleSeleccionado
            Get
        ...
        Public Property Resultados() As Object Implements Contratos.FacOperacionDetalles.IConsultarFacOperacionDetalles.Resultados
            Get
        ...
        'Public Property Id() As Integer Implements Contratos.FacOperacionDetalles.IConsultarFacOperacionDetalles.Id
        '    Get
        ...
        Public Property CurSortCol() As System.Windows.Controls.GridViewColumnHeader Implements Contratos.FacOperacionDetalles.IConsultarFacOperacionDetalles.CurSortCol
            Get
                Return _CurSortCol
            End Get
        ...
        Public Property CurAdorner() As SortAdorner Implements Contratos.FacOperacionDetalles.IConsultarFacOperacionDetalles.CurAdorner
            Get
                Return _CurAdorner
            End Get
        ...
        Public Property ListaResultados() As System.Windows.Controls.ListView Implements Contratos.FacOperacionDetalles.IConsultarFacOperacionDetalles.ListaResultados
            Get
...
#End Region
        ...
        Public Sub New()
            ...
            Me._presentador = New PresentadorConsultarFacOperacionDetalles(Me)
        End Sub
        ...
        Private Sub _lstResultados_MouseDoubleClick(ByVal sender As Object, ByVal e As MouseButtonEventArgs)
            Me._presentador.IrConsultarFacOperacionDetalle()
        End Sub
        ...
        Public Property Asociado As Object Implements Contratos.FacOperacionDetalles.IConsultarFacOperacionDetalles.Asociado
        ...
        Public Property Asociados As Object Implements Contratos.FacOperacionDetalles.IConsultarFacOperacionDetalles.Asociados
            Get
        ...
        Public Property Banco As Object Implements Contratos.FacOperacionDetalles.IConsultarFacOperacionDetalles.Banco
            Get
        ...
        Public Property Bancos As Object Implements Contratos.FacOperacionDetalles.IConsultarFacOperacionDetalles.Bancos
            Get
        ...
        Public Property Idioma As Object Implements Contratos.FacOperacionDetalles.IConsultarFacOperacionDetalles.Idioma
            Get
        ...
        Public Property Idiomas As Object Implements Contratos.FacOperacionDetalles.IConsultarFacOperacionDetalles.Idiomas
            Get
        ...
        Public Property Moneda As Object Implements Contratos.FacOperacionDetalles.IConsultarFacOperacionDetalles.Moneda
            Get
        ...
        Public Property Monedas As Object Implements Contratos.FacOperacionDetalles.IConsultarFacOperacionDetalles.Monedas
            Get
        ...
        End Sub
        Public Property NombreAsociado() As String Implements Contratos.FacOperacionDetalles.IConsultarFacOperacionDetalles.NombreAsociado
            Get
        ...
        Public Property idAsociadoFiltrar() As String Implements Contratos.FacOperacionDetalles.IConsultarFacOperacionDetalles.idAsociadoFiltrar
            Get
        ...
        Public Property NombreAsociadoFiltrar() As String Implements Contratos.FacOperacionDetalles.IConsultarFacOperacionDetalles.NombreAsociadoFiltrar
            Get
        ...
        Public ReadOnly Property FechaCobro() As String Implements Contratos.FacOperacionDetalles.IConsultarFacOperacionDetalles.FechaCobro
            Get
                Return Me._dpkFechaCobro.SelectedDate.ToString()
            End Get
        End Property

        Public ReadOnly Property Id() As String Implements Contratos.FacOperacionDetalles.IConsultarFacOperacionDetalles.Id
            Get
                Return Me._txtId.Text
            End Get
        End Property

        'Public ReadOnly Property CreditoSent As String Implements Contratos.FacOperacionDetalles.IConsultarFacOperacionDetalles.CreditoSent
        '    Get
