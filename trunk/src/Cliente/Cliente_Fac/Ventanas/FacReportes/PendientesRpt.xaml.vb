...
Namespace Ventanas.FacReportes
    Partial Public Class PendientesRpt
        Inherits Page
        Implements IPendientesRpt

        Private _presentador As PresentadorPendientesRpt
        Private _cargada As Boolean

#Region "IPendientesRpt"
        ...
        Public Sub Mensaje(ByVal mensaje__1 As String) Implements Contratos.FacReportes.IPendientesRpt.Mensaje
...
#End Region
        ...
        Public Sub New(ByVal Tipo As String, ByVal Asociado As Object)
            InitializeComponent()
            Me._cargada = False
            Me._presentador = New PresentadorPendientesRpt(Me, Tipo, Asociado)
        End Sub
        ...
        Public Property Fecha1 As String Implements Contratos.FacReportes.IPendientesRpt.Fecha1
            Get
        ...
        Public Property Fecha2 As String Implements Contratos.FacReportes.IPendientesRpt.Fecha2
            Get
        ...
        Public Property Asociado As Object Implements Contratos.FacReportes.IPendientesRpt.Asociado
        ...
        Public Property Asociados As Object Implements Contratos.FacReportes.IPendientesRpt.Asociados
            Get
        ...
        Public Property NombreAsociado() As String Implements Contratos.FacReportes.IPendientesRpt.NombreAsociado
            Get
        ...
        Public Property idAsociadoFiltrar() As String Implements Contratos.FacReportes.IPendientesRpt.idAsociadoFiltrar
            Get
        ...
        Public Property NombreAsociadoFiltrar() As String Implements Contratos.FacReportes.IPendientesRpt.NombreAsociadoFiltrar
            Get
        ...
        Public ReadOnly Property TipoMoneda As Object Implements Contratos.FacReportes.IPendientesRpt.TipoMoneda
            Get
        ...
        Public Property Pais As Object Implements Contratos.FacReportes.IPendientesRpt.Pais
            Get
        ...
        Public Property Paises As Object Implements Contratos.FacReportes.IPendientesRpt.Paises
            Get
        ...
        Public Property Asociados2 As Object Implements Contratos.FacReportes.IPendientesRpt.Asociados2
            Get
        ...
        Public Property NombreAsociado2() As String Implements Contratos.FacReportes.IPendientesRpt.NombreAsociado2
            Get
        ...
        Public Property idAsociadoFiltrar2() As String Implements Contratos.FacReportes.IPendientesRpt.idAsociadoFiltrar2
            Get
        ...
        Public Property NombreAsociadoFiltrar2() As String Implements Contratos.FacReportes.IPendientesRpt.NombreAsociadoFiltrar2
            Get
