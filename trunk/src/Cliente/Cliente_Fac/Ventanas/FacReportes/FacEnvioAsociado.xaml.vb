...
Namespace Ventanas.FacReportes
    Partial Public Class FacEnvioAsociado
        Inherits Page
        Implements IFacEnvioAsociado

        Private _presentador As PresentadorFacEnvioAsociado
        Private _cargada As Boolean

#Region "IFacEnvioAsociado"
        ...
        Public Sub Mensaje(ByVal mensaje__1 As String) Implements Contratos.FacReportes.IFacEnvioAsociado.Mensaje
...
#End Region
        ...
        Public Sub New()
            InitializeComponent()
            Me._cargada = False
            Me._presentador = New PresentadorFacEnvioAsociado(Me)
        End Sub
        ...
        Public Property FechaCorte As Object Implements Contratos.FacReportes.IFacEnvioAsociado.FechaCorte
            Get
        ...
        Public Property FechaEnvio As Object Implements Contratos.FacReportes.IFacEnvioAsociado.FechaEnvio
            Get
                Return _dpkFechaEnvio.Text
            End Get
            Set(ByVal value As Object)
                _dpkFechaEnvio.Text = value
            End Set
        End Property
        ...
        Public Property Asociado As Object Implements Contratos.FacReportes.IFacEnvioAsociado.Asociado
        ...
        Public Property Asociados As Object Implements Contratos.FacReportes.IFacEnvioAsociado.Asociados
            Get
        ...
        Public Property NombreAsociado() As String Implements Contratos.FacReportes.IFacEnvioAsociado.NombreAsociado
            Get
        ...
        Public Property idAsociadoFiltrar() As String Implements Contratos.FacReportes.IFacEnvioAsociado.idAsociadoFiltrar
            Get
        ...
        Public Property NombreAsociadoFiltrar() As String Implements Contratos.FacReportes.IFacEnvioAsociado.NombreAsociadoFiltrar
            Get
        ...
        Public ReadOnly Property TipoSel As Object Implements Contratos.FacReportes.IFacEnvioAsociado.TipoSel
            Get
        ...
        Public Property Pais As Object Implements Contratos.FacReportes.IFacEnvioAsociado.Pais
            Get
        ...
        Public Property Paises As Object Implements Contratos.FacReportes.IFacEnvioAsociado.Paises
            Get
        ...
        Public Property Usuario As Object Implements Contratos.FacReportes.IFacEnvioAsociado.Usuario
            Get
                Return Me._CbxUsuario.SelectedItem
            End Get
            Set(ByVal value As Object)
                Me._CbxPais.SelectedItem = value
            End Set
        ...
        Public Property Usuarios As Object Implements Contratos.FacReportes.IFacEnvioAsociado.Usuarios
            Get
                Return Me._CbxPais.DataContext
            End Get
            Set(ByVal value As Object)
                Me._CbxUsuario.DataContext = value
            End Set
        End Property

        Public Property Asociado2 As Object Implements Contratos.FacReportes.IFacEnvioAsociado.Asociado2
        ...
        Public Property Asociados2 As Object Implements Contratos.FacReportes.IFacEnvioAsociado.Asociados2
            Get
        ...
        Public Property NombreAsociado2() As String Implements Contratos.FacReportes.IFacEnvioAsociado.NombreAsociado2
            Get
        ...
        Public Property idAsociadoFiltrar2() As String Implements Contratos.FacReportes.IFacEnvioAsociado.idAsociadoFiltrar2
            Get
        ...
        Public Property NombreAsociadoFiltrar2() As String Implements Contratos.FacReportes.IFacEnvioAsociado.NombreAsociadoFiltrar2
            Get
        ...
        Public Property B1 As Boolean Implements Contratos.FacReportes.IFacEnvioAsociado.B1
            Get
                Return _chkB1.IsChecked
            End Get
            Set(ByVal value As Boolean)
                _chkB1.IsChecked = value
            End Set
        End Property

        Public Property B2 As Boolean Implements Contratos.FacReportes.IFacEnvioAsociado.B2
            Get
                Return _chkB2.IsChecked
            End Get
            Set(ByVal value As Boolean)
                _chkB2.IsChecked = value
            End Set
        End Property

        Public Property B3 As Boolean Implements Contratos.FacReportes.IFacEnvioAsociado.B3
            Get
                Return _chkB3.IsChecked
            End Get
            Set(ByVal value As Boolean)
