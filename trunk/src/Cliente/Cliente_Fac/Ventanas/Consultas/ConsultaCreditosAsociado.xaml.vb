...
Namespace Ventanas.Consultas
    ...
    ''' </summary>
    Partial Public Class ConsultaCreditosAsociado
        Inherits Page
        Implements IConsultaCreditosAsociado

        Private _CurSortCol As GridViewColumnHeader = Nothing
        Private _CurAdorner As SortAdorner = Nothing
        Private _presentador As PresentadorConsultaCreditosAsociado
...
#Region "IConsultarFacOperacionsAnuladas"
        ...
        Public Property FacOperacionFiltrar() As Object Implements Contratos.Consultas.IConsultaCreditosAsociado.FacOperacionFiltrar
            Get
        ...
        Public ReadOnly Property FacOperacionSeleccionado() As Object Implements Contratos.Consultas.IConsultaCreditosAsociado.FacOperacionSeleccionado
            Get
        ...
        Public Property Resultados() As Object Implements Contratos.Consultas.IConsultaCreditosAsociado.Resultados
            Get
        ...
        'Public Property Id() As Integer Implements Contratos.Consultas.IConsultaCreditosAsociado.Id
        '    Get
        ...
        Public Property CurSortCol() As System.Windows.Controls.GridViewColumnHeader Implements Contratos.Consultas.IConsultaCreditosAsociado.CurSortCol
            Get
                Return _CurSortCol
            End Get
        ...
        Public Property CurAdorner() As SortAdorner Implements Contratos.Consultas.IConsultaCreditosAsociado.CurAdorner
            Get
                Return _CurAdorner
            End Get
        ...
        Public Property ListaResultados() As System.Windows.Controls.ListView Implements Contratos.Consultas.IConsultaCreditosAsociado.ListaResultados
            Get
...
#End Region
        ...
        Public Sub New()
            ...
            Me._presentador = New PresentadorConsultaCreditosAsociado(Me)
        End Sub
        ...
        Public Property Asociado As Object Implements Contratos.Consultas.IConsultaCreditosAsociado.Asociado
        ...
        Public Property Asociados As Object Implements Contratos.Consultas.IConsultaCreditosAsociado.Asociados
            Get
        ...
        Public Property NombreAsociado() As String Implements Contratos.Consultas.IConsultaCreditosAsociado.NombreAsociado
            Get
        ...
        Public Property idAsociadoFiltrar() As String Implements Contratos.Consultas.IConsultaCreditosAsociado.idAsociadoFiltrar
            Get
        ...
        Public Property NombreAsociadoFiltrar() As String Implements Contratos.Consultas.IConsultaCreditosAsociado.NombreAsociadoFiltrar
            Get
        ...
        'Public ReadOnly Property FechaFactura() As String Implements Contratos.Consultas.IConsultaCreditosAsociado.FechaFactura
        '    Get
        '        Return Me._dpkFechaFactura.SelectedDate.ToString()
        '    End Get
        'End Property

        'Public ReadOnly Property Id() As String Implements Contratos.Consultas.IConsultaCreditosAsociado.Id
        '    Get
        '        Return Me._txtId.Text
        '    End Get
        'End Property

        Public WriteOnly Property Count As Integer Implements Contratos.Consultas.IConsultaCreditosAsociado.Count
            Set(ByVal value As Integer)
                _lblHits.Text = value
            End Set
        End Property

        Public Sub Mensaje(ByVal mensaje As String, ByVal tipo As Integer) Implements Contratos.Consultas.IConsultaCreditosAsociado.Mensaje
            If tipo = 0 Then
