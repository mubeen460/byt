...
Namespace Ventanas.Consultas
    ...
    ''' </summary>
    Partial Public Class ConsultaFacturasAnuladas
        Inherits Page
        Implements IConsultaFacturasAnuladas

        Private _CurSortCol As GridViewColumnHeader = Nothing
        Private _CurAdorner As SortAdorner = Nothing
        Private _presentador As PresentadorConsultaFacturasAnuladas
        Private _cargada As Boolean

#Region "IConsultarFacFacturaAnuladasAnuladas"
        ...
        Public Property FacFacturaAnuladaFiltrar() As Object Implements Contratos.Consultas.IConsultaFacturasAnuladas.FacFacturaAnuladaFiltrar
            Get
        ...
        Public ReadOnly Property FacFacturaAnuladaSeleccionado() As Object Implements Contratos.Consultas.IConsultaFacturasAnuladas.FacFacturaAnuladaSeleccionado
            Get
        ...
        Public Property Resultados() As Object Implements Contratos.Consultas.IConsultaFacturasAnuladas.Resultados
            Get
        ...
        'Public Property Id() As Integer Implements Contratos.Consultas.IConsultaFacturasAnuladas.Id
        '    Get
        ...
        Public Property CurSortCol() As System.Windows.Controls.GridViewColumnHeader Implements Contratos.Consultas.IConsultaFacturasAnuladas.CurSortCol
            Get
                Return _CurSortCol
            End Get
        ...
        Public Property CurAdorner() As SortAdorner Implements Contratos.Consultas.IConsultaFacturasAnuladas.CurAdorner
            Get
                Return _CurAdorner
            End Get
        ...
        Public Property ListaResultados() As System.Windows.Controls.ListView Implements Contratos.Consultas.IConsultaFacturasAnuladas.ListaResultados
            Get
...
#End Region
        ...
        Public Sub New()
            ...
            Me._presentador = New PresentadorConsultaFacturasAnuladas(Me)
        End Sub
        ...
        Public Property Asociado As Object Implements Contratos.Consultas.IConsultaFacturasAnuladas.Asociado
        ...
        Public Property Asociados As Object Implements Contratos.Consultas.IConsultaFacturasAnuladas.Asociados
            Get
        ...
        Private Sub _btnConsultar(ByVal sender As Object, ByVal e As RoutedEventArgs)
            ...
            End If
        End Sub
        'Public Property Banco As Object Implements Contratos.Consultas.IConsultaFacturasAnuladas.Banco
        '    Get
        ...
        'Public Property Bancos As Object Implements Contratos.Consultas.IConsultaFacturasAnuladas.Bancos
        '    Get
        ...
        'Public Property Idioma As Object Implements Contratos.Consultas.IConsultaFacturasAnuladas.Idioma
        '    Get
        ...
        'Public Property Idiomas As Object Implements Contratos.Consultas.IConsultaFacturasAnuladas.Idiomas
        '    Get
        ...
        'Public Property Moneda As Object Implements Contratos.Consultas.IConsultaFacturasAnuladas.Moneda
        '    Get
        ...
        'Public Property Monedas As Object Implements Contratos.Consultas.IConsultaFacturasAnuladas.Monedas
        '    Get
        ...
        Public Property NombreAsociado() As String Implements Contratos.Consultas.IConsultaFacturasAnuladas.NombreAsociado
            Get
        ...
        Public Property idAsociadoFiltrar() As String Implements Contratos.Consultas.IConsultaFacturasAnuladas.idAsociadoFiltrar
            Get
        ...
        Public Property NombreAsociadoFiltrar() As String Implements Contratos.Consultas.IConsultaFacturasAnuladas.NombreAsociadoFiltrar
            Get
        ...
        Public ReadOnly Property Id() As String Implements Contratos.Consultas.IConsultaFacturasAnuladas.Id
            Get
                Return Me._txtId.Text
            End Get
        End Property

        Public ReadOnly Property FechaFacturaAnulada As String Implements Contratos.Consultas.IConsultaFacturasAnuladas.FechaFacturaAnulada
            Get
                Return Me._dpkFechaFactura.SelectedDate.ToString()
            End Get
        End Property

        Public WriteOnly Property Count As Integer Implements Contratos.Consultas.IConsultaFacturasAnuladas.Count
            Set(ByVal value As Integer)
                _lblHits.Text = value
            End Set
        End Property
