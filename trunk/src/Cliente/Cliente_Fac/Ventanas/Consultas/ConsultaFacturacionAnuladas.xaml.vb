...
Namespace Ventanas.Consultas
    ...
    ''' </summary>
    Partial Public Class ConsultaFacturacionAnuladas
        Inherits Page
        Implements IConsultaFacturacionAnuladas

        Private _CurSortCol As GridViewColumnHeader = Nothing
        Private _CurAdorner As SortAdorner = Nothing
        Private _presentador As PresentadorConsultaFacturacionAnuladas
...
#Region "IConsultarFacFacturasAnuladas"
        ...
        Public Property FacFacturaFiltrar() As Object Implements Contratos.Consultas.IConsultaFacturacionAnuladas.FacFacturaFiltrar
            Get
        ...
        Public ReadOnly Property FacFacturaSeleccionado() As Object Implements Contratos.Consultas.IConsultaFacturacionAnuladas.FacFacturaSeleccionado
            Get
        ...
        Public Property Resultados() As Object Implements Contratos.Consultas.IConsultaFacturacionAnuladas.Resultados
            Get
        ...
        'Public Property Id() As Integer Implements Contratos.Consultas.IConsultaFacturacionAnuladas.Id
        '    Get
        ...
        Public Property CurSortCol() As System.Windows.Controls.GridViewColumnHeader Implements Contratos.Consultas.IConsultaFacturacionAnuladas.CurSortCol
            Get
                Return _CurSortCol
            End Get
        ...
        Public Property CurAdorner() As SortAdorner Implements Contratos.Consultas.IConsultaFacturacionAnuladas.CurAdorner
            Get
                Return _CurAdorner
            End Get
        ...
        Public Property ListaResultados() As System.Windows.Controls.ListView Implements Contratos.Consultas.IConsultaFacturacionAnuladas.ListaResultados
            Get
...
#End Region
        ...
        Public Sub New()
            ...
            Me._presentador = New PresentadorConsultaFacturacionAnuladas(Me)
        End Sub
        ...
        Public Property Asociado As Object Implements Contratos.Consultas.IConsultaFacturacionAnuladas.Asociado
        ...
        Public Property Asociados As Object Implements Contratos.Consultas.IConsultaFacturacionAnuladas.Asociados
            Get
        ...
        Private Sub _btnConsultar(ByVal sender As Object, ByVal e As RoutedEventArgs)
            ...
            End If
        End Sub
        'Public Property Banco As Object Implements Contratos.Consultas.IConsultaFacturacionAnuladas.Banco
        '    Get
        ...
        'Public Property Bancos As Object Implements Contratos.Consultas.IConsultaFacturacionAnuladas.Bancos
        '    Get
        ...
        'Public Property Idioma As Object Implements Contratos.Consultas.IConsultaFacturacionAnuladas.Idioma
        '    Get
        ...
        'Public Property Idiomas As Object Implements Contratos.Consultas.IConsultaFacturacionAnuladas.Idiomas
        '    Get
        ...
        'Public Property Moneda As Object Implements Contratos.Consultas.IConsultaFacturacionAnuladas.Moneda
        '    Get
        ...
        'Public Property Monedas As Object Implements Contratos.Consultas.IConsultaFacturacionAnuladas.Monedas
        '    Get
        ...
        Public Property NombreAsociado() As String Implements Contratos.Consultas.IConsultaFacturacionAnuladas.NombreAsociado
            Get
        ...
        Public Property idAsociadoFiltrar() As String Implements Contratos.Consultas.IConsultaFacturacionAnuladas.idAsociadoFiltrar
            Get
        ...
        Public Property NombreAsociadoFiltrar() As String Implements Contratos.Consultas.IConsultaFacturacionAnuladas.NombreAsociadoFiltrar
            Get
        ...
        Public ReadOnly Property FechaFactura() As String Implements Contratos.Consultas.IConsultaFacturacionAnuladas.FechaFactura
            Get
                Return Me._dpkFechaFactura.SelectedDate.ToString()
            End Get
        End Property

        Public ReadOnly Property Id() As String Implements Contratos.Consultas.IConsultaFacturacionAnuladas.Id
            Get
                Return Me._txtId.Text
            End Get
        End Property

        Public WriteOnly Property Count As Integer Implements Contratos.Consultas.IConsultaFacturacionAnuladas.Count
            Set(ByVal value As Integer)
                _lblHits.Text = value
            End Set
        End Property
