...
Namespace Ventanas.Consultas
    ...
    ''' </summary>
    Partial Public Class ConsultaCreditosVigentesAsociado
        Inherits Page
        Implements IConsultaCreditosVigentesAsociado

        Private _CurSortCol As GridViewColumnHeader = Nothing
        Private _CurAdorner As SortAdorner = Nothing
        Private _presentador As PresentadorConsultaCreditosVigentesAsociado
        Private _cargada As Boolean

#Region "IConsultarFacOperacionsAnuladas"
        ...
        Public Property FacOperacionFiltrar() As Object Implements Contratos.Consultas.IConsultaCreditosVigentesAsociado.FacOperacionFiltrar
            Get
        ...
        Public ReadOnly Property FacOperacionSeleccionado() As Object Implements Contratos.Consultas.IConsultaCreditosVigentesAsociado.FacOperacionSeleccionado
            Get
        ...
        Public Property Resultados() As Object Implements Contratos.Consultas.IConsultaCreditosVigentesAsociado.Resultados
            Get
        ...
        'Public Property Id() As Integer Implements Contratos.Consultas.IConsultaCreditosVigentesAsociado.Id
        '    Get
        ...
        Public Property CurSortCol() As System.Windows.Controls.GridViewColumnHeader Implements Contratos.Consultas.IConsultaCreditosVigentesAsociado.CurSortCol
            Get
                Return _CurSortCol
            End Get
        ...
        Public Property CurAdorner() As SortAdorner Implements Contratos.Consultas.IConsultaCreditosVigentesAsociado.CurAdorner
            Get
                Return _CurAdorner
            End Get
        ...
        Public Property ListaResultados() As System.Windows.Controls.ListView Implements Contratos.Consultas.IConsultaCreditosVigentesAsociado.ListaResultados
            Get
...
#End Region
        ...
        Public Sub New()
            ...
            Me._presentador = New PresentadorConsultaCreditosVigentesAsociado(Me)
        End Sub
        ...
        Public Property Asociado As Object Implements Contratos.Consultas.IConsultaCreditosVigentesAsociado.Asociado
        ...
        Public Property Asociados As Object Implements Contratos.Consultas.IConsultaCreditosVigentesAsociado.Asociados
            Get
        ...
        Public Property NombreAsociado() As String Implements Contratos.Consultas.IConsultaCreditosVigentesAsociado.NombreAsociado
            Get
        ...
        Public Property idAsociadoFiltrar() As String Implements Contratos.Consultas.IConsultaCreditosVigentesAsociado.idAsociadoFiltrar
            Get
        ...
        Public Property NombreAsociadoFiltrar() As String Implements Contratos.Consultas.IConsultaCreditosVigentesAsociado.NombreAsociadoFiltrar
            Get
        ...
        'Public ReadOnly Property FechaFactura() As String Implements Contratos.Consultas.IConsultaCreditosVigentesAsociado.FechaFactura
        '    Get
        '        Return Me._dpkFechaFactura.SelectedDate.ToString()
        '    End Get
        'End Property

        'Public ReadOnly Property Id() As String Implements Contratos.Consultas.IConsultaCreditosVigentesAsociado.Id
        '    Get
        '        Return Me._txtId.Text
        '    End Get
        'End Property

        Public WriteOnly Property Count As Integer Implements Contratos.Consultas.IConsultaCreditosVigentesAsociado.Count
            Set(ByVal value As Integer)
                _lblHits.Text = value
            End Set
        End Property

        Public Sub Mensaje(ByVal mensaje As String, ByVal tipo As Integer) Implements Contratos.Consultas.IConsultaCreditosVigentesAsociado.Mensaje
            If tipo = 0 Then
