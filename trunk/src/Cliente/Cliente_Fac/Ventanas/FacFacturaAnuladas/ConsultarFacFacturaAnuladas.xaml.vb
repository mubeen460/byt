...
Namespace Ventanas.FacFacturaAnuladas
    ...
    ''' </summary>
    Partial Public Class ConsultarFacFacturaAnuladas
        Inherits Page
        Implements IConsultarFacFacturaAnuladas


        Private _CurSortCol As GridViewColumnHeader = Nothing
        Private _CurAdorner As SortAdorner = Nothing
        Private _presentador As PresentadorConsultarFacFacturaAnuladas
...
#Region "IConsultarFacFacturaAnuladaes"
        ...
        Public Property FacFacturaAnuladaFiltrar() As Object Implements Contratos.FacFacturaAnuladas.IConsultarFacFacturaAnuladas.FacFacturaAnuladaFiltrar
            Get
        ...
        Public ReadOnly Property FacFacturaAnuladaSeleccionado() As Object Implements Contratos.FacFacturaAnuladas.IConsultarFacFacturaAnuladas.FacFacturaAnuladaSeleccionado
            Get
        ...
        Public Property Resultados() As Object Implements Contratos.FacFacturaAnuladas.IConsultarFacFacturaAnuladas.Resultados
            Get
        ...
        'Public Property Id() As Integer Implements Contratos.FacFacturaAnuladas.IConsultarFacFacturaAnuladas.Id
        '    Get
        ...
        Public Property CurSortCol() As System.Windows.Controls.GridViewColumnHeader Implements Contratos.FacFacturaAnuladas.IConsultarFacFacturaAnuladas.CurSortCol
            Get
                Return _CurSortCol
            End Get
        ...
        Public Property CurAdorner() As SortAdorner Implements Contratos.FacFacturaAnuladas.IConsultarFacFacturaAnuladas.CurAdorner
            Get
                Return _CurAdorner
            End Get
        ...
        Public Property ListaResultados() As System.Windows.Controls.ListView Implements Contratos.FacFacturaAnuladas.IConsultarFacFacturaAnuladas.ListaResultados
            Get
...
#End Region
        ...
        Public Sub New()
            ...
            Me._presentador = New PresentadorConsultarFacFacturaAnuladas(Me)
        End Sub
        ...
        Private Sub _lstResultados_MouseDoubleClick(ByVal sender As Object, ByVal e As MouseButtonEventArgs)
            Me._presentador.IrConsultarFacFacturaAnulada()
        End Sub
        ...
        Public Property Asociado As Object Implements Contratos.FacFacturaAnuladas.IConsultarFacFacturaAnuladas.Asociado
        ...
        Public Property Asociados As Object Implements Contratos.FacFacturaAnuladas.IConsultarFacFacturaAnuladas.Asociados
            Get
        ...
        Public Property Banco As Object Implements Contratos.FacFacturaAnuladas.IConsultarFacFacturaAnuladas.Banco
            Get
        ...
        Public Property Bancos As Object Implements Contratos.FacFacturaAnuladas.IConsultarFacFacturaAnuladas.Bancos
            Get
        ...
        Public Property Idioma As Object Implements Contratos.FacFacturaAnuladas.IConsultarFacFacturaAnuladas.Idioma
            Get
        ...
        Public Property Idiomas As Object Implements Contratos.FacFacturaAnuladas.IConsultarFacFacturaAnuladas.Idiomas
            Get
        ...
        Public Property Moneda As Object Implements Contratos.FacFacturaAnuladas.IConsultarFacFacturaAnuladas.Moneda
            Get
        ...
        Public Property Monedas As Object Implements Contratos.FacFacturaAnuladas.IConsultarFacFacturaAnuladas.Monedas
            Get
        ...
        End Sub
        Public Property NombreAsociado() As String Implements Contratos.FacFacturaAnuladas.IConsultarFacFacturaAnuladas.NombreAsociado
            Get
        ...
        Public Property idAsociadoFiltrar() As String Implements Contratos.FacFacturaAnuladas.IConsultarFacFacturaAnuladas.idAsociadoFiltrar
            Get
        ...
        Public Property NombreAsociadoFiltrar() As String Implements Contratos.FacFacturaAnuladas.IConsultarFacFacturaAnuladas.NombreAsociadoFiltrar
            Get
        ...
        Public ReadOnly Property FechaCobro() As String Implements Contratos.FacFacturaAnuladas.IConsultarFacFacturaAnuladas.FechaCobro
            Get
                Return Me._dpkFechaCobro.SelectedDate.ToString()
            End Get
        End Property

        Public ReadOnly Property Id() As String Implements Contratos.FacFacturaAnuladas.IConsultarFacFacturaAnuladas.Id
            Get
                Return Me._txtId.Text
            End Get
        End Property

        'Public ReadOnly Property CreditoSent As String Implements Contratos.FacFacturaAnuladas.IConsultarFacFacturaAnuladas.CreditoSent
        '    Get
