...
Namespace Ventanas.ViGestionAsociados
    ...
    ''' </summary>
    Partial Public Class ConsultarViGestionAsociados
        Inherits Page
        Implements IConsultarViGestionAsociados

        Private _CurSortCol As GridViewColumnHeader = Nothing
        Private _CurAdorner As SortAdorner = Nothing
        Private _presentador As PresentadorConsultarViGestionAsociados
        Private _cargada As Boolean

#Region "IConsultarViGestionAsociadoes"
        ...
        Public Property ViGestionAsociadoFiltrar() As Object Implements Contratos.ViGestionAsociados.IConsultarViGestionAsociados.ViGestionAsociadoFiltrar
            Get
        ...
        Public ReadOnly Property ViGestionAsociadoSeleccionado() As Object Implements Contratos.ViGestionAsociados.IConsultarViGestionAsociados.ViGestionAsociadoSeleccionado
            Get
        ...
        Public Property Resultados() As Object Implements Contratos.ViGestionAsociados.IConsultarViGestionAsociados.Resultados
            Get
        ...
        'Public Property Id() As Integer Implements Contratos.ViGestionAsociados.IConsultarViGestionAsociados.Id
        '    Get
        ...
        Public Property CurSortCol() As System.Windows.Controls.GridViewColumnHeader Implements Contratos.ViGestionAsociados.IConsultarViGestionAsociados.CurSortCol
            Get
                Return _CurSortCol
            End Get
        ...
        Public Property CurAdorner() As SortAdorner Implements Contratos.ViGestionAsociados.IConsultarViGestionAsociados.CurAdorner
            Get
                Return _CurAdorner
            End Get
        ...
        Public Property ListaResultados() As System.Windows.Controls.ListView Implements Contratos.ViGestionAsociados.IConsultarViGestionAsociados.ListaResultados
            Get
...
#End Region
        ...
        Public Sub New()
            ...
            Me._presentador = New PresentadorConsultarViGestionAsociados(Me)
        End Sub
        ...
        Private Sub _btnConsultar_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
            ...
            'Me._dpkFechaUltima.BlackoutDates.Clear()
            'Me._dpkFechaUltima.Text = String.Empty
        End Sub
        ...
        Private Sub _lstResultados_MouseDoubleClick(ByVal sender As Object, ByVal e As MouseButtonEventArgs)
            If Me._lstResultados.SelectedItem IsNot Nothing Then
                Me._presentador.IrConsultarFacGestionesAsociado()
            End If
        End Sub
        ...
        Public ReadOnly Property FechaUltima() As String Implements Contratos.ViGestionAsociados.IConsultarViGestionAsociados.FechaUltima
            Get
                Return Me._dpkFechaUltima.SelectedDate.ToString()
            End Get
        End Property
        ...
        Public Property NCantidad As String Implements Contratos.ViGestionAsociados.IConsultarViGestionAsociados.NCantidad
            Get
        ...
        Public Property NSaldo As String Implements Contratos.ViGestionAsociados.IConsultarViGestionAsociados.NSaldo
            Get
                Return Me._txtNSaldo.Text
            End Get

            Set(ByVal value As String)
                Me._txtNSaldo.Text = value
            End Set
        End Property

        'Contratos.ViGestionAsociados.IConsultarViGestionAsociados

        Public Property Asociado As Object Implements Contratos.ViGestionAsociados.IConsultarViGestionAsociados.Asociado
        ...
        Public Property Asociados As Object Implements Contratos.ViGestionAsociados.IConsultarViGestionAsociados.Asociados
            Get
        ...
        Public Property NombreAsociado() As String Implements Contratos.ViGestionAsociados.IConsultarViGestionAsociados.NombreAsociado
            Get
        ...
        Public Property idAsociadoFiltrar() As String Implements Contratos.ViGestionAsociados.IConsultarViGestionAsociados.idAsociadoFiltrar
            Get
        ...
        Public Property NombreAsociadoFiltrar() As String Implements Contratos.ViGestionAsociados.IConsultarViGestionAsociados.NombreAsociadoFiltrar
            Get
        ...
        Public WriteOnly Property Count As Integer Implements Contratos.ViGestionAsociados.IConsultarViGestionAsociados.Count
            Set(ByVal value As Integer)
                _lblHits.Text = value
            End Set
        End Property
