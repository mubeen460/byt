...
Namespace Ventanas.Motivos
    Partial Public Class AgregarMotivo
        Inherits Page
        Implements IAgregarMotivo

        Private _presentador As PresentadorAgregarMotivo
        Private _cargada As Boolean

#Region "IAgregarMotivo"
        ...
        Public Property Motivo() As Object Implements Contratos.Motivos.IAgregarMotivo.Motivo
            Get
        ...
        Public Sub Mensaje(ByVal mensaje__1 As String) Implements Contratos.Motivos.IAgregarMotivo.Mensaje
...
#End Region
        ...
        Public Sub New()
            InitializeComponent()
            Me._cargada = False
            Me._presentador = New PresentadorAgregarMotivo(Me)
        End Sub
