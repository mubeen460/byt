...
Namespace Contratos.FacFactuDetaAnuladas
    Interface IConsultarDepositoFacFactuDetaAnuladas
        Inherits IPaginaBaseFac
        Property FacFactuDetaAnuladaFiltrar() As Object

        ReadOnly Property FacFactuDetaAnuladaSeleccionado() As Object
