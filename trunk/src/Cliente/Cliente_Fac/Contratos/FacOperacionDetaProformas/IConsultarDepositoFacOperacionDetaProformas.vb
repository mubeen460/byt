...
Namespace Contratos.FacOperacionDetaProformas
    Interface IConsultarDepositoFacOperacionDetaProformas
        Inherits IPaginaBaseFac
        Property FacOperacionDetaProformaFiltrar() As Object

        ReadOnly Property FacOperacionDetaProformaSeleccionado() As Object
