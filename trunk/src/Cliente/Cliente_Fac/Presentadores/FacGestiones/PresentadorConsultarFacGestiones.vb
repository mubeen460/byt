...
Namespace Presentadores.FacGestiones
    Class PresentadorConsultarFacGestiones
        Inherits PresentadorBase
        Private Shared _paginaPrincipal As PaginaPrincipal = PaginaPrincipal.ObtenerInstancia
        Private Shared logger As Logger = LogManager.GetCurrentClassLogger()

        Private _ventana As IConsultarFacGestiones
        ...
        Public Sub New(ByVal ventana As IConsultarFacGestiones)
            Try
                Me._ventana = ventana                
        ...
        Public Sub ActualizarTitulo()
            Me.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.fac_titleConsultarFacGestiones, Recursos.Ids.fac_ConsultarFacGestion)
        End Sub
        ...
        Public Sub Limpiar()
            ...
            Me.Navegar(New ConsultarFacGestiones())
        ...
        Public Sub Consultar()
            Try
                ...
                If (Me._ventana.Asociado IsNot Nothing) AndAlso (DirectCast(Me._ventana.Asociado, Asociado).Id <> Integer.MinValue) Then
                    FacGestionAuxiliar.Asociado = DirectCast(Me._ventana.Asociado, Asociado)
                End If
