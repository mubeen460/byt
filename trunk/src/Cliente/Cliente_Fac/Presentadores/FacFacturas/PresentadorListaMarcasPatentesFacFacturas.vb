...
Namespace Presentadores.FacFacturas
    Class PresentadorListaMarcasPatentesFacFacturas
        Inherits PresentadorBase
        Private Shared _paginaPrincipal As PaginaPrincipal = PaginaPrincipal.ObtenerInstancia
        Private Shared logger As Logger = LogManager.GetCurrentClassLogger()

        Private _ventana As IListaMarcasPatentesFacFactura
        ...
        Public Sub New(ByVal ventana As IListaMarcasPatentesFacFactura)
            Try
                Me._ventana = ventana
        ...
        Public Sub New(ByVal ventana As IListaMarcasPatentesFacFactura, ByVal ventanaPadre As Object)
            Try
        ...
        '    Me.Navegar(New ConsultarFacFacturas())
