...
Namespace Presentadores.FacFacturas
    Class PresentadorConsultarFacFacturas
        Inherits PresentadorBase
        Private Shared _paginaPrincipal As PaginaPrincipal = PaginaPrincipal.ObtenerInstancia
        Private Shared logger As Logger = LogManager.GetCurrentClassLogger()

        Private _ventana As IConsultarFacFacturas
        ...
        Public Sub New(ByVal ventana As IConsultarFacFacturas)
            Try
                Me._ventana = ventana
        ...
        Public Sub CargarPagina()
            ...
            Try
                ...
                Me._ventana.Resultados = Me._FacFacturas
        ...
        Public Sub Consultar()
            Try
                ...
                If Not Me._ventana.FechaCobro.Equals("") Then
                    Dim FechaFacFactura As DateTime = DateTime.Parse(Me._ventana.FechaCobro)
                    FacFacturaAuxiliar.FechaCobro = FechaFacFactura
                End If
