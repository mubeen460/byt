...
Namespace Presentadores.FacFacturas
    Class PresentadorConsultarFacFacturaPase
        ...
        Private _ventana As IConsultarFacFacturaPase
        ...
        Public Sub New(ByVal ventana As IConsultarFacFacturaPase, ByVal FacFacturaOProforma As Object)
            Try
                Me._ventana = ventana
            ...
            If FacFactuDeta IsNot Nothing Then
                ...
                While (i < (FacFactuDeta.Count))
                    If (FacFactuDeta.Item(i).Id = iddetalle) Then
                        ...
                        Dim ag As New Mostrar_Detalle(FacFactuDeta.Item(i), Me, 2)
                        'ag.Owner = Me
                        ag.ShowDialog()
        ...
        Public Sub pasar_profora_a_factura(ByVal proforma As FacFacturaProforma)
            ...
            Try
                ...
                departamentos2 = From d In departamentos2 Where d.Id IsNot Nothing AndAlso d.Id.ToLower().Contains(proforma.CodigoDepartamento.ToLower())
                ...
                Me._ventana.SetXterrero = BuscarTerrero(factura.Terrero)
            ...
            Try
                ...
                Else
                    ...
                    If FacFactura.Status = 1 Then
                        '-para los contadores
                        If Me._ventana.GetXterrero = "1" Or Me._ventana.GetXterrero = "2" Then
                        ...
                        End If
                        If Me._ventana.GetXterrero = "2" Or Me._ventana.GetXterrero = "3" Then
                            Dim valor_contador As Integer
        ...
        Public Sub IrConsultarFacFactura()
            ...
            Dim FacFactura As FacFactura = DirectCast(_ventana.FacFactura, FacFactura)
            FacFactura.Status = -1
            Me.Navegar(New ConsultarFacFactura(Me._ventana.FacFactura))
