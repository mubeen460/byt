...
Namespace Presentadores.FacInternacionales
    Class PresentadorFacInternacionalPago
        Inherits PresentadorBase

        Private _ventana As IFacInternacionalPago
        ...
        Public Sub New(ByVal ventana As IFacInternacionalPago, ByVal proforma As FacFacturaProforma)
            Try
                Me._ventana = ventana
        ...
        Public Sub Limpiar()
            ...
            Me.Navegar(New FacInternacionalPago(facfacturaproforma))
        ...
        Public Sub CargarPagina()
            ...
            Try
                ...
                Me.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.fac_titleFacInternacionalPago, Recursos.Ids.fac_FacInternacionalPago)
