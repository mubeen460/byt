...
Namespace Presentadores.Consultas
    Class PresentadorConsultaCreditosVigentesAsociado
        Inherits PresentadorBase
        Private Shared _paginaPrincipal As PaginaPrincipal = PaginaPrincipal.ObtenerInstancia
        Private Shared logger As Logger = LogManager.GetCurrentClassLogger()

        Private _ventana As IConsultaCreditosVigentesAsociado
        ...
        Public Sub New(ByVal ventana As IConsultaCreditosVigentesAsociado)
            Try
                Me._ventana = ventana
        ...
        Public Sub ActualizarTitulo()
            Me.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.fac_menuItemConsultaCreditosVigentesAsociado, Recursos.Ids.fac_menuItemConsultaCreditosVigentesAsociado)
        End Sub
        ...
        Public Sub Limpiar()
            ...
            Me.Navegar(New ConsultaCreditosVigentesAsociado())
        ...
        Public Sub Consultar()
            ...
            Try
                ...
                If (Me._ventana.Asociado IsNot Nothing) AndAlso (DirectCast(Me._ventana.Asociado, Asociado).Id <> Integer.MinValue) Then
                    ...
                    Dim idasociado As Integer = DirectCast(Me._ventana.Asociado, Asociado).Id
                    Dim nc As String = "NC"
                    ...
                    FacOperacionAuxiliar.ValorQuery = FacOperacionAuxiliar.ValorQuery & " Asociado.Id= " & idasociado
                    ...
                    FacOperacionAuxiliar.ValorQuery = FacOperacionAuxiliar.ValorQuery & " and o.Saldo > 0 and o.Id='" & nc & "'  order by o.FechaOperacion desc, o.CodigoOperacion desc "
                ...
                If FacOperacionAuxiliar.Seleccion = True Then
                ...
                Else
                    MessageBox.Show("No Selecciono Valor de Busqueda", "Error", MessageBoxButton.OK)
                End If
        ...
        Public Sub IrConsultarFacOperacion()
            ...
            If Me._ventana.FacOperacionSeleccionado IsNot Nothing Then
                ...
                If FacOperacionSeleccionada.Id = "NC" Then
                    ...
                    Else
                        Me._ventana.Mensaje("El Crédito seleccionado no existe", 0)
                    End If
                End If
            End If
