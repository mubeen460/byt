...
Namespace Presentadores.Consultas
    Class PresentadorConsultaCreditosAsociado
        Inherits PresentadorBase
        Private Shared _paginaPrincipal As PaginaPrincipal = PaginaPrincipal.ObtenerInstancia
        Private Shared logger As Logger = LogManager.GetCurrentClassLogger()

        Private _ventana As IConsultaCreditosAsociado
        ...
        Public Sub New(ByVal ventana As IConsultaCreditosAsociado)
            Try
                Me._ventana = ventana
        ...
        Public Sub ActualizarTitulo()
            Me.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.fac_menuItemConsultaCreditosAsociado, Recursos.Ids.fac_menuItemConsultaCreditosAsociado)
        End Sub
        ...
        Public Sub Limpiar()
            ...
            Me.Navegar(New ConsultaCreditosAsociado())
