...
Namespace Presentadores.Consultas
    Class PresentadorConsultaOperacionesAsociado
        ...
        Private _ventana As IConsultaOperacionesAsociado
        ...
        Public Sub New(ByVal ventana As IConsultaOperacionesAsociado)
            Try
                Me._ventana = ventana
        ...
        Public Sub ActualizarTitulo()
            Me.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.fac_menuItemConsultaOperacionesAsociado, Recursos.Ids.fac_menuItemConsultaOperacionesAsociado)
        End Sub
        ...
        Public Sub Limpiar()
            ...
            Me.Navegar(New ConsultaOperacionesAsociado())
        ...
        Public Sub Verificar_Status(ByVal Facoperaciones As IList(Of FacOperacion))
            For i As Integer = 0 To Facoperaciones.Count - 1
                If Facoperaciones(i).Saldo > 0 Then
                    If Facoperaciones(i).Id = "NP" Then
                        Facoperaciones(i).ValorQuery = "*******"
                    Else
                        Facoperaciones(i).ValorQuery = "VIGENTE"
                    End If
                Else
                    If Facoperaciones(i).Id = "NC" Then
                        Facoperaciones(i).ValorQuery = "AGOTADA"
                    Else
                        If Facoperaciones(i).Id = "ND" Then
