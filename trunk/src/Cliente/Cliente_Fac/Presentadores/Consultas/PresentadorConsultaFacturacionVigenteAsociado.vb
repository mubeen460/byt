...
Namespace Presentadores.Consultas
    Class PresentadorConsultaFacturacionVigenteAsociado
        Inherits PresentadorBase
        Private Shared _paginaPrincipal As PaginaPrincipal = PaginaPrincipal.ObtenerInstancia
        Private Shared logger As Logger = LogManager.GetCurrentClassLogger()

        Private _ventana As IConsultaFacturacionVigenteAsociado
        ...
        Public Sub New(ByVal ventana As IConsultaFacturacionVigenteAsociado)
            Try
                Me._ventana = ventana
        ...
        Public Sub ActualizarTitulo()
            Me.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.fac_menuItemConsultaFacturacionVigenteAsociado, Recursos.Ids.fac_menuItemConsultaFacturacionVigenteAsociado)
        End Sub
        ...
        Public Sub Limpiar()
            ...
            Me.Navegar(New ConsultaFacturacionVigenteAsociado())
