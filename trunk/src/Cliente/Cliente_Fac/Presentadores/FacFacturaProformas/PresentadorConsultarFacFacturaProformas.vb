...
Namespace Presentadores.FacFacturaProformas
    Class PresentadorConsultarFacFacturaProformas
        Inherits PresentadorBase
        Private Shared _paginaPrincipal As PaginaPrincipal = PaginaPrincipal.ObtenerInstancia
        Private Shared logger As Logger = LogManager.GetCurrentClassLogger()

        Private _ventana As IConsultarFacFacturaProformas
        ...
        Public Sub New(ByVal ventana As IConsultarFacFacturaProformas)
            Try
                Me._ventana = ventana
        ...
        Public Sub IrConsultarFacFacturaProforma()
            ...
            Me.Navegar(New ConsultarFacFacturaProforma(Me._ventana.FacFacturaProformaSeleccionado, Me._ventana))
