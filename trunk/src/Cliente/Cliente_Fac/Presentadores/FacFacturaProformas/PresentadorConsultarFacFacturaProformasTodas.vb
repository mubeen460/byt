...
Namespace Presentadores.FacFacturaProformas
    Class PresentadorConsultarFacFacturaProformasTodas
        Inherits PresentadorBase
        Private Shared _paginaPrincipal As PaginaPrincipal = PaginaPrincipal.ObtenerInstancia
        Private Shared logger As Logger = LogManager.GetCurrentClassLogger()

        Private _ventana As IConsultarFacFacturaProformasTodas
        ...
        Public Sub New(ByVal ventana As IConsultarFacFacturaProformasTodas)
            Try
                Me._ventana = ventana
        ...
        Public Sub sumar(ByVal proforma As IList(Of FacFacturaProforma))
            ...
            Dim cbpm, cbam, cbfm, cbrm, cdpm, cdam, cdfm, cdrm As Double
            cbp = 0
            cba = 0
            cbf = 0
            cbr = 0
            ...
            For i As Integer = 0 To proforma.Count - 1
                If proforma(i).Moneda.Id = "BS" Then                    
                    If proforma(i).Auto = "0" Then
                        cbp = cbp + 1
                        cbpm = cbpm + proforma(i).Mttotal
                    End If
                    If proforma(i).Auto = "1" Then
                        cba = cba + 1
                        cbam = cbam + proforma(i).Mttotal
                    End If
                    If proforma(i).Auto = "2" Then
                        cbf = cbf + 1
                        cbfm = cbfm + proforma(i).Mttotal
                    End If
                    If proforma(i).Auto = "3" Then
                        cbr = cbr + 1
                        cbrm = cbrm + proforma(i).Mttotal
                    End If
                Else
                    'If proforma(i).Moneda.Id = "US" Then
                    If proforma(i).Auto = "0" Then
                        cdp = cdp + 1
                        cdpm = cdpm + proforma(i).Mttotal
                    End If
                    If proforma(i).Auto = "1" Then
                        cda = cda + 1
                        cdam = cdam + proforma(i).Mttotal
                    End If
                    If proforma(i).Auto = "2" Then
                        cdf = cdf + 1
                        cdfm = cdfm + proforma(i).Mttotal
                    End If
                    If proforma(i).Auto = "3" Then
                        cdr = cdr + 1
                        cdrm = cdrm + proforma(i).Mttotal
                    End If
                    'End If
                End If
            Next
            ...
            Me._ventana.CbpM = cbpm
            Me._ventana.CbaM = cbam
            Me._ventana.CbfM = cbfm
            Me._ventana.CbrM = cbrm
            Me._ventana.CdpM = cdpm
            Me._ventana.CdaM = cdam
            Me._ventana.CdfM = cdfm
            Me._ventana.CdrM = cdrm
        End Sub
        ''' <summary>
        ...
        Public Sub Consultar()
            Try
                ...
                If Me._ventana.Auto <> "" Then
                    FacFacturaProformaAuxiliar.Status = 5
                    If Me._ventana.Auto = "Pendiente" Then
                        FacFacturaProformaAuxiliar.Auto = "0"
                    ElseIf Me._ventana.Auto = "Autorizado" Then
                        FacFacturaProformaAuxiliar.Auto = "1"
                    ElseIf Me._ventana.Auto = "Facturado" Then
                        FacFacturaProformaAuxiliar.Auto = "2"
                    ElseIf Me._ventana.Auto = "Rechazado" Then
                        FacFacturaProformaAuxiliar.Auto = "3"
                    End If                    
                End If
                ...
                'FacFacturaProformaAuxiliar.Inicial = UsuarioLogeado.Iniciales
                FacFacturaProformaAuxiliar.Anulada = "NO"
                Dim FacFacturaProformas As IList(Of FacFacturaProforma)
                FacFacturaProformas = Me._FacFacturaProformaServicios.ObtenerFacFacturaProformasFiltro(FacFacturaProformaAuxiliar)
