...
Namespace Presentadores.FacReportes
    Class PresentadorVentasTotalesRevRpt
        Inherits PresentadorBase

        Private _ventana As IVentasTotalesRevRpt
        ...
        Public Sub New(ByVal ventana As IVentasTotalesRevRpt)
            Try
                Me._ventana = ventana
        ...
        Public Sub Limpiar()
            ...
            Me.Navegar(New Diginsoft.Bolet.Cliente.Fac.Ventanas.FacReportes.VentasTotalesRevRpt())
        ...
        Public Sub ActualizarTitulo()
            Me.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.fac_menuItemVentasTotalesRevRpt, Recursos.Ids.fac_menuItemVentasTotalesRevRpt)
        End Sub
        ...
        Private Function GetRutaReporte() As String
            ...
            retorno = Environment.CurrentDirectory & ConfigurationManager.AppSettings("rutaFacreportes") & "VentasTotalesRevRpt.rpt"
