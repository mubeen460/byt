...
Namespace Presentadores.FacReportes
    Class PresentadorFacturaCopiaAnuladaRpt
        Inherits PresentadorBase

        Private _ventana As IFacturaCopiaAnuladaRpt
        Private _FacFactura As FacFactura
        Dim _FacFacturaDetalle As List(Of FacFactuDetaAnulada)
        ...
        Public Sub New(ByVal ventana As IFacturaCopiaAnuladaRpt, ByVal FacFactura As Object)
            Try
                Me._ventana = ventana
        ...
        Public Sub Limpiar()
            ...
            Me.Navegar(New Diginsoft.Bolet.Cliente.Fac.Ventanas.FacReportes.FacturaCopiaAnuladaRpt(_FacFactura))
        ...
        Public Sub CargarPagina()
            ...
            Try
                ...
                Dim facturanueva As New FacFacturaAnulada
