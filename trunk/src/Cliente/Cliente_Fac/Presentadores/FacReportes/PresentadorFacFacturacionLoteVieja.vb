    ...
    Class PresentadorFacFacturacionLoteVieja
        ...
        Public Function BT_FACT00_N(ByVal factura As FacFactura,monto As double) As StructReporteFActuraEnc
            ...
            Try
                ...
                structura.Msubtimpo = SetFormatoDouble2(monto)
                structura.Mdescuento = SetFormatoDouble2((monto * factura.Descuento))
                structura.Piva = SetFormatoDouble2(factura.Impuesto)
                structura.Mtbimp = SetFormatoDouble2(((monto - (monto * factura.Descuento)) * factura.Impuesto) / 100)
                structura.Msubtotal = SetFormatoDouble2(factura.MSubtotal)
                structura.Mttotal = SetFormatoDouble2(monto - (monto * factura.Descuento) + (((monto - (monto * factura.Descuento)) * factura.Impuesto) / 100))
