...
Namespace Presentadores.FacFacturaAnuladas
    Class PresentadorConsultarFacFacturaAnuladas
        Inherits PresentadorBase
        Private Shared _paginaPrincipal As PaginaPrincipal = PaginaPrincipal.ObtenerInstancia
        Private Shared logger As Logger = LogManager.GetCurrentClassLogger()

        Private _ventana As IConsultarFacFacturaAnuladas
        ...
        Public Sub New(ByVal ventana As IConsultarFacFacturaAnuladas)
            Try
                Me._ventana = ventana
        ...
        Public Sub CargarPagina()
            ...
            Try
                ...
                Me._ventana.Resultados = Me._FacFacturaAnuladas
        ...
        Public Sub Consultar()
            Try
                ...
                If Not Me._ventana.FechaCobro.Equals("") Then
                    Dim FechaFacFacturaAnulada As DateTime = DateTime.Parse(Me._ventana.FechaCobro)
                    FacFacturaAnuladaAuxiliar.FechaCobro = FechaFacFacturaAnulada
                End If
