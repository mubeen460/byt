...
Namespace Presentadores.FacFacturaAnuladas
    Class PresentadorConsultarFacFacturaAnulada
        Inherits PresentadorBase

        Private _ventana As IConsultarFacFacturaAnulada
        ...
        ''' <param name="FacFacturaAnulada">FacFacturaAnulada a mostrar</param>
        Public Sub New(ByVal ventana As IConsultarFacFacturaAnulada, ByVal FacFacturaAnulada As Object)
            Try
                Me._ventana = ventana
                Me._ventana.FacFacturaAnulada = FacFacturaAnulada
                'Me._ventana.Region = DirectCast(Me._ventana.FacFacturaAnulada, FacFacturaAnulada).Region
        ...
        Public Sub CargarPagina()
            ...
            Try
                ...
                Me.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.fac_titleConsultarFacFacturaAnulada, Recursos.Ids.fac_ConsultarFacFacturaAnulada)

                Dim FacFacturaAnulada As FacFacturaAnulada = DirectCast(Me._ventana.FacFacturaAnulada, FacFacturaAnulada)

                Dim asociados As IList(Of Servicio) = Me._AsociadoServicios.ConsultarTodos()
                Me._ventana.Asociados = asociados
                Me._ventana.Asociado = Me.BuscarAsociado(asociados, FacFacturaAnulada.Id)

                Dim bancos As IList(Of BancoG) = Me._BancoGServicios.ConsultarTodos()
                Me._ventana.Bancos = Bancos
                'Me._ventana.Banco = Me.BuscarBancoG(bancos, FacFacturaAnulada.Banco)
        ...
        Public Sub Modificar()
            Try
                ...
                Else
                    ...
                    'Modifica los datos del FacFacturaAnulada
                    Dim FacFacturaAnulada As FacFacturaAnulada = DirectCast(Me._ventana.FacFacturaAnulada, FacFacturaAnulada)
                    'FacFacturaAnulada.Region = If(Not Me._ventana.Region.Equals(""), Me._ventana.Region, Nothing)

                    If Me._FacFacturaAnuladaServicios.InsertarOModificar(FacFacturaAnulada, UsuarioLogeado.Hash) Then
                        _paginaPrincipal.MensajeUsuario = Recursos.MensajesConElUsuario.fac_FacFacturaAnuladaModificado
        ...
        Public Sub Eliminar()
            Try
                ...
                If Me._FacFacturaAnuladaServicios.Eliminar(DirectCast(Me._ventana.FacFacturaAnulada, FacFacturaAnulada), UsuarioLogeado.Hash) Then
                    _paginaPrincipal.MensajeUsuario = Recursos.MensajesConElUsuario.fac_FacFacturaAnuladaEliminado
                    Me.Navegar(_paginaPrincipal)
                End If
