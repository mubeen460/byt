...
Namespace Presentadores.FacCobros
    Class PresentadorConsultarFacCobro
        ...
        Private _ventana As IConsultarFacCobro        
        ...
        Public Sub CargarPagina()
            ...
            Try
                ...
                Me.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.fac_titleConsultarFacCobro, Recursos.Ids.fac_ConsultarFacCobro)
                ...
                Dim FacCobro As FacCobro = DirectCast(Me._ventana.FacCobro, FacCobro)


                Dim asociadoaux As New Asociado
                Dim asociado As List(Of Asociado)
                If FacCobro.Asociado IsNot Nothing Then
                    asociadoaux.Id = FacCobro.Asociado.Id
                ...
                Me._ventana.Idioma = Me.BuscarIdioma(idiomas, FacCobro.Idioma)

                Dim monedas As IList(Of Moneda) = Me._monedasServicios.ConsultarTodos()
                Me._ventana.Monedas = monedas
                Me._ventana.Moneda = Me.BuscarMoneda(monedas, FacCobro.Moneda)

                ' para las formas
                Dim formaaux As New FacForma
                formaaux.Cobro = FacCobro
                Me._ventana.ResultadosForma = _FacFormaServicios.ObtenerFacFormasFiltro(formaaux)

                'para los cobros facturas
                Dim cobrofactura As New FacCobroFactura
                cobrofactura.Id = FacCobro
                Me._ventana.ResultadosFacturaCobro = _FacCobroFacturaServicios.ObtenerFacCobroFacturasFiltro(cobrofactura)
                ...
                Else
                    ...
                    If (valido = True) Then
                        ...
                        If exitoso Then
                            ...
                            Mouse.OverrideCursor = Nothing
                            '_paginaPrincipal.MensajeUsuario = Recursos.MensajesConElUsuario.fac_FacCobroModificado
                            'Me.Navegar(_paginaPrincipal)
                            MessageBox.Show(Recursos.MensajesConElUsuario.fac_FacCobroModificado, "Modificado")
                        End If
        ...
        Public Sub Eliminar()
            Try
                ...
                If Me._FacCobroServicios.Eliminar(DirectCast(Me._ventana.FacCobro, FacCobro), UsuarioLogeado.Hash) Then
                    _paginaPrincipal.MensajeUsuario = Recursos.MensajesConElUsuario.fac_FacCobroEliminado
                    Me.Navegar(_paginaPrincipal)
                End If
        ...
        Public Sub Limpiar()
            ...
            Me.Navegar(New ConsultarFacCobro(_faccobro))
