...
Namespace Presentadores.FacOperacionAnuladas
    Class PresentadorConsultarFacOperacionAnulada
        Inherits PresentadorBase

        Private _ventana As IConsultarFacOperacionAnulada
        ...
        ''' <param name="FacOperacionAnulada">FacOperacionAnulada a mostrar</param>
        Public Sub New(ByVal ventana As IConsultarFacOperacionAnulada, ByVal FacOperacionAnulada As Object)
            Try
                Me._ventana = ventana
                Me._ventana.FacOperacionAnulada = FacOperacionAnulada
                'Me._ventana.Region = DirectCast(Me._ventana.FacOperacionAnulada, FacOperacionAnulada).Region
        ...
        Public Sub CargarPagina()
            ...
            Try
                ...
                Me.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.fac_titleConsultarFacOperacionAnulada, Recursos.Ids.fac_ConsultarFacOperacionAnulada)

                Dim FacOperacionAnulada As FacOperacionAnulada = DirectCast(Me._ventana.FacOperacionAnulada, FacOperacionAnulada)

                Dim asociados As IList(Of Servicio) = Me._AsociadoServicios.ConsultarTodos()
                Me._ventana.Asociados = asociados
                Me._ventana.Asociado = Me.BuscarAsociado(asociados, FacOperacionAnulada.Id)

                Dim bancos As IList(Of BancoG) = Me._BancoGServicios.ConsultarTodos()
                Me._ventana.Bancos = Bancos
                'Me._ventana.Banco = Me.BuscarBancoG(bancos, FacOperacionAnulada.Banco)
        ...
        Public Sub Modificar()
            Try
                ...
                Else
                    ...
                    'Modifica los datos del FacOperacionAnulada
                    Dim FacOperacionAnulada As FacOperacionAnulada = DirectCast(Me._ventana.FacOperacionAnulada, FacOperacionAnulada)
                    'FacOperacionAnulada.Region = If(Not Me._ventana.Region.Equals(""), Me._ventana.Region, Nothing)

                    If Me._FacOperacionAnuladaServicios.InsertarOModificar(FacOperacionAnulada, UsuarioLogeado.Hash) Then
                        _paginaPrincipal.MensajeUsuario = Recursos.MensajesConElUsuario.fac_FacOperacionAnuladaModificado
        ...
        Public Sub Eliminar()
            Try
                ...
                If Me._FacOperacionAnuladaServicios.Eliminar(DirectCast(Me._ventana.FacOperacionAnulada, FacOperacionAnulada), UsuarioLogeado.Hash) Then
                    _paginaPrincipal.MensajeUsuario = Recursos.MensajesConElUsuario.fac_FacOperacionAnuladaEliminado
                    Me.Navegar(_paginaPrincipal)
                End If
