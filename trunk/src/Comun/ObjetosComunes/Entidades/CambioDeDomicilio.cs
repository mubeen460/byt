...
{
    [Serializable]
    public class CambioDeDomicilio
    {
        #region Atributos
        ...
        /// <summary>
        /// Propiedad que asigna u obtiene la Cadena de Cambios del CambioDeDomicilio
        /// </summary>
