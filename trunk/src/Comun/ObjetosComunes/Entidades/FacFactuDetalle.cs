...
namespace Trascend.Bolet.ObjetosComunes.Entidades
{
    ...
    public class FacFactuDetalle
    {
        ...
        public FacFactuDetalle()
        {
            this._bsel = 'F';
            this._desglose = 'F';
        }
        /// <summary>
        /// Constructor que inicializa el Id de la FacFactuDetalle
        /// </summary>
        /// <param name="id">Id de FacFactuDetalle</param>
        public FacFactuDetalle(int? id, FacFactura factura)
        {
            this._id = id;
        ...
        /// <summary>
        /// Propiedad que asigna u obtiene el id de la FacFactuDetalle
        /// </summary>
