...
namespace Trascend.Bolet.ObjetosComunes.Entidades
{
    ...
    public class FacFacturaTotalZ
    {
        ...
        public FacFacturaTotalZ()
        {
        }
        /// <summary>
        /// Constructor que inicializa el Id de la FacFacturaTotalZ
        /// </summary>
        /// <param name="id">Id de FacFacturaTotalZ</param>
        public FacFacturaTotalZ(int? id)
        {
            this._id = id;
        }
        #endregion
        ...
        /// <summary>
        /// Propiedad que asigna u obtiene el id de la FacFacturaTotalZ
        /// </summary>
