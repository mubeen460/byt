...
{
    class PresentadorRenunciaParcial : PresentadorBase
    {

        private IRenunciaParcial _ventana;
        ...
        public PresentadorRenunciaParcial(IRenunciaParcial ventana)
        {
            try
            {
        ...
        public void CargarPagina()
        {
            ...
            try
            {
                this.ActualizarTituloVentanaPrincipal(Recursos.Etiquetas.titleEscritoRenunciaParcial,
                    "");
                CargarAgente();
                CargarMarca();
                GenerarString();
        ...
        /// <summary>
        /// Método que se encarga de armar el string y generar el escrito
        /// </summary>
        public void Aceptar()
        {
            try
        ...
        /// <summary>
        /// Método que se encarga de hacer las validaciones antes de generar el escrito
        /// </summary>
