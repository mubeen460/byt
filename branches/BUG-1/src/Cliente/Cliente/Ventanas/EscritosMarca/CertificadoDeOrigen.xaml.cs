...
namespace Trascend.Bolet.Cliente.Ventanas.EscritosMarca
{
    ...
    /// </summary>
    public partial class CertificadoDeOrigen : Page, ICertificadoDeOrigen
    {
        private PresentadorCertificadoDeOrigen _presentador;
        private bool _cargada;

        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;

        #region ICertificadoDeOrigen
        ...
        public CertificadoDeOrigen()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorCertificadoDeOrigen(this);
        }
