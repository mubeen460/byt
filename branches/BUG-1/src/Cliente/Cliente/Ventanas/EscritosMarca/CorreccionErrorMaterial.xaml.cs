...
{
    /// <summary>
    /// Interaction logic for CorreccionErrorMaterial.xaml
    /// </summary>
    public partial class CorreccionErrorMaterial : Page, ICorreccionErrorMaterial
    {
        private PresentadorCorreccionErrorMaterial _presentador;
        private bool _cargada;

        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;

        #region ICorreccionErrorMaterial
        ...
        public object TiposErrores
        {
            get { return this._cbxTipoError.DataContext; }
            set { this._cbxTipoError.DataContext = value; }
        }

        public object TipoError
        {
            get { return this._cbxTipoError.SelectedItem; }
            set { this._cbxTipoError.SelectedItem = value; }
        }

        public string Error
        {
            get { return this._txtError.Text; }
            set { this._txtError.Text = value; }
        }
        ...
        public CorreccionErrorMaterial()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorCorreccionErrorMaterial(this);
        }
