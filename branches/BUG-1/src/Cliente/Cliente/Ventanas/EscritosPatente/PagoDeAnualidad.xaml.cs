...
namespace Trascend.Bolet.Cliente.Ventanas.EscritosPatente
{
    ...
    /// </summary>
    public partial class PagoDeAnualidad : Page, IPagoDeAnualidad
    {
        private PresentadorPagoDeAnualidad _presentador;
        private bool _cargada;

        private GridViewColumnHeader _CurSortCol = null;
        private SortAdorner _CurAdorner = null;

        #region IPagoDeAnualidad
        ...
        public PagoDeAnualidad()
        {
            InitializeComponent();
            this._cargada = false;
            this._presentador = new PresentadorPagoDeAnualidad(this);
        }
